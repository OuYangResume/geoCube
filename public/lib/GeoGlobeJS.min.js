...
function(a){for(var a=a.split("."),b=window,c=0;c<a.length;c++)b[a[c]]||(b[a[c]]={}),b=b[a[c]]};GeoGlobe.VERSION_NUMBER="GeoGlobeJSAPI 2018 -- $Version: 0.44.2 build-2018-12-03 18:18:00 $"})();GeoGlobe.Class=function(){var a=arguments.length,b=arguments[0],c=arguments[a-1],d=typeof c.initialize=="function"?c.initialize:function(){b.prototype.initialize.apply(this,arguments)};a>1?[d,b].concat(Array.prototype.slice.call(arguments).slice(1,a-1),c):d.prototype=c;return d};
...
GeoGlobe.Util.distVincenty=function(a,b){for(var c=GeoGlobe.Util.VincentyConstants,d=c.a,e=c.b,c=c.f,f=GeoGlobe.Util.rad(b.lng-a.lng),g=Math.atan((1-c)*Math.tan(GeoGlobe.Util.rad(a.lat))),h=Math.atan((1-c)*Math.tan(GeoGlobe.Util.rad(b.lat))),j=Math.sin(g),g=Math.cos(g),l=Math.sin(h),h=Math.cos(h),n=f,o=2*Math.PI,r=20;Math.abs(n-o)>1.0E-12&&--r>0;){var t=Math.sin(n),m=Math.cos(n),p=Math.sqrt(h*t*h*t+(g*l-j*h*m)*(g*l-j*h*m));if(p==0)return 0;var m=j*l+g*h*m,s=Math.atan2(p,m),q=Math.asin(g*h*t/p),u=
Math.cos(q)*Math.cos(q),t=m-2*j*l/u,v=c/16*u*(4+c*(4-3*u)),o=n,n=f+(1-v)*c*Math.sin(q)*(s+v*p*(t+v*m*(-1+2*t*t)))}if(r==0)return NaN;d=u*(d*d-e*e)/(e*e);c=d/1024*(256+d*(-128+d*(74-47*d)));return(e*(1+d/16384*(4096+d*(-768+d*(320-175*d))))*(s-c*p*(t+c/4*(m*(-1+2*t*t)-c/6*t*(-3+4*p*p)*(-3+4*t*t))))).toFixed(3)/1E3};
GeoGlobe.Util.destinationVincenty=function(a,b,c){for(var d=GeoGlobe.Util,e=d.VincentyConstants,f=e.a,g=e.b,e=e.f,h=a.lng,j=a.lat,a=d.rad(b),b=Math.sin(a),a=Math.cos(a),l=(1-e)*Math.tan(d.rad(j)),j=1/Math.sqrt(1+l*l),n=l*j,o=Math.atan2(l,a),l=j*b,r=1-l*l,f=r*(f*f-g*g)/(g*g),t=1+f/16384*(4096+f*(-768+f*(320-175*f))),m=f/1024*(256+f*(-128+f*(74-47*f))),f=c/(g*t),p=2*Math.PI;Math.abs(f-p)>1.0E-12;)var s=Math.cos(2*o+f),q=Math.sin(f),u=Math.cos(f),v=m*q*(s+m/4*(u*(-1+2*s*s)-m/6*s*(-3+4*q*q)*(-3+4*s*s))),
p=f,f=c/(g*t)+v;c=n*q-j*u*a;c=Math.atan2(n*u+j*q*a,(1-e)*Math.sqrt(l*l+c*c));g=e/16*r*(4+e*(4-3*r));return new GeoGlobe.LngLat(h+d.deg(Math.atan2(q*b,j*u-n*q*a)-(1-g)*e*l*(f+g*q*(s+g*u*(-1+2*s*s)))),d.deg(c))};
...
(function(){for(var a=document.getElementsByTagName("script"),b=0,c=a.length;b<c;++b)if(a[b].src.indexOf("firebug.js")!=-1&&console){GeoGlobe.Util.extend(GeoGlobe.Console,console);break}})();GeoGlobe.ProxyHost="";if(!GeoGlobe.Request)GeoGlobe.Request={};
GeoGlobe.Util.extend(GeoGlobe.Request,{DEFAULT_CONFIG:{method:"GET",url:window.location.href,async:!0,user:void 0,password:void 0,params:null,proxy:GeoGlobe.ProxyHost,headers:{},data:null,callback:function(){},success:null,failure:null,scope:null},URL_SPLIT_REGEX:/([^:]*:)\/\/([^:]*:?[^@]*@)?([^:\/\?]*):?([^\/\?]*)/,makeSameOrigin:function(a,b){var c=a.indexOf("http")!==0,d=!c&&a.match(this.URL_SPLIT_REGEX);if(d){var e=window.location,c=d[1]==e.protocol&&d[3]==e.hostname,d=d[4],e=e.port;if(d!=80&&
d!=""||e!="80"&&e!="")c=c&&d==e}c||b&&(a=typeof b=="function"?b(a):a.indexOf("cts?")>=0?b+a:b+encodeURIComponent(a));return a},issue:function(a){var b=GeoGlobe.Util.extend(this.DEFAULT_CONFIG,{proxy:GeoGlobe.ProxyHost}),a=a||{};a.headers=a.headers||{};a=GeoGlobe.Util.applyDefaults(a,b);a.headers=GeoGlobe.Util.applyDefaults(a.headers,b.headers);var b=!1,c;for(c in a.headers)a.headers.hasOwnProperty(c)&&c.toLowerCase()==="x-requested-with"&&(b=!0);b===!1&&(a.headers["X-Requested-With"]="XMLHttpRequest");
var d=new GeoGlobe.Request.XMLHttpRequest;a.url=encodeURI(a.url);var e=GeoGlobe.Util.urlAppend(a.url,GeoGlobe.Util.getParameterString(a.params||{})),e=GeoGlobe.Request.makeSameOrigin(e,a.proxy);d.open(a.method,e,a.async,a.user,a.password);for(var f in a.headers)d.setRequestHeader(f,a.headers[f]);var g=this;d.onreadystatechange=function(){d.readyState==GeoGlobe.Request.XMLHttpRequest.DONE&&null!==!1&&g.runCallbacks({request:d,config:a,requestUrl:e})};a.async===!1?d.send(a.data):window.setTimeout(function(){d.readyState!==
0&&d.send(a.data)},0);return d},runCallbacks:function(a){var b=a.request,a=a.config,c=a.scope?GeoGlobe.Function.bind(a.callback,a.scope):a.callback,d;a.success&&(d=a.scope?GeoGlobe.Function.bind(a.success,a.scope):a.success);var e;a.failure&&(e=a.scope?GeoGlobe.Function.bind(a.failure,a.scope):a.failure);if(GeoGlobe.Util.createUrlObject(a.url).protocol=="file:"&&b.responseText)b.status=200;c(b);(!b.status||b.status>=200&&b.status<300)&&d&&d(b);b.status&&(b.status<200||b.status>=300)&&e&&e(b)},GET:function(a){a=
GeoGlobe.Util.extend(a,{method:"GET"});return GeoGlobe.Request.issue(a)},POST:function(a){a=GeoGlobe.Util.extend(a,{method:"POST"});a.headers=a.headers?a.headers:{};"CONTENT-TYPE"in GeoGlobe.Util.upperCaseObject(a.headers)||(a.headers["Content-Type"]="application/xml");return GeoGlobe.Request.issue(a)},PUT:function(a){a=GeoGlobe.Util.extend(a,{method:"PUT"});a.headers=a.headers?a.headers:{};"CONTENT-TYPE"in GeoGlobe.Util.upperCaseObject(a.headers)||(a.headers["Content-Type"]="application/xml");return GeoGlobe.Request.issue(a)},
DELETE:function(a){a=GeoGlobe.Util.extend(a,{method:"DELETE"});return GeoGlobe.Request.issue(a)},HEAD:function(a){a=GeoGlobe.Util.extend(a,{method:"HEAD"});return GeoGlobe.Request.issue(a)},OPTIONS:function(a){a=GeoGlobe.Util.extend(a,{method:"OPTIONS"});return GeoGlobe.Request.issue(a)}});GeoGlobe.nullHandler=function(a){GeoGlobe.Console.userError(GeoGlobe.i18n("unhandledRequest",{statusText:a.statusText}))};
GeoGlobe.loadURL=function(a,b,c,d,e){typeof b=="string"&&(b=GeoGlobe.Util.getParameters(b));return GeoGlobe.Request.GET({url:a,params:b,success:d?d:GeoGlobe.nullHandler,failure:e?e:GeoGlobe.nullHandler,scope:c})};GeoGlobe.Request.setProxyHost=function(a){GeoGlobe.ProxyHost=a};GeoGlobe.Request.getProxyHost=function(){return GeoGlobe.ProxyHost};GeoGlobe.appendToProxy=function(a){var a=a.split("?"),b=GeoGlobe.ProxyHost+encodeURI(encodeURI(a[0]));a.length===2&&(b+="?"+a[1]);return b};
GeoGlobe.loadScript=function(a){GeoGlobe.Request.GET({url:a,async:!1,headers:{Accept:"text/javascript, application/javascript, application/ecmascript, application/x-ecmascript, */*; q=0.01"},success:function(a){GeoGlobe.Util.globalEval(a.responseText)},failure:function(){alert("\u52a0\u8f7d:"+a+" \u5931\u8d25\u3002")}})};
...
new window.ActiveXObject("Microsoft.XMLDOM"),e.async=!1,e.validateOnParse=!1,e.loadXML(f);c=e&&(h&&e.parseError!=0||!e.documentElement||e.documentElement&&e.documentElement.tagName=="parsererror")?null:e;a.responseXML=c}catch(g){}try{a.status=a._object.status}catch(j){}try{a.statusText=a._object.statusText}catch(q){}}function e(a){a._object.onreadystatechange=new window.Function}var f=window.XMLHttpRequest,g=!!window.controllers,h=window.document.all&&!window.opera,j=h&&window.navigator.userAgent.match(/MSIE 7.0/);
b.prototype=a.prototype;if(g&&f.wrapped)b.wrapped=f.wrapped;b.UNSENT=0;b.OPENED=1;b.HEADERS_RECEIVED=2;b.LOADING=3;b.DONE=4;b.prototype.readyState=b.UNSENT;b.prototype.responseText="";b.prototype.responseXML=null;b.prototype.status=0;b.prototype.statusText="";b.prototype.priority="NORMAL";b.prototype.onreadystatechange=null;b.onreadystatechange=null;b.onopen=null;b.onsend=null;b.onabort=null;b.prototype.open=function(a,f,j,r,t){delete this._headers;arguments.length<3&&(j=!0);this._async=j;var m=this,
p=this.readyState,s;h&&j&&(s=function(){p!=b.DONE&&(e(m),m.abort())},window.attachEvent("onunload",s));b.onopen&&b.onopen.apply(this,arguments);arguments.length>4?this._object.open(a,f,j,r,t):arguments.length>3?this._object.open(a,f,j,r):this._object.open(a,f,j);try{this._object.responseType="msxml-document"}catch(q){}this.readyState=b.OPENED;c(this);this._object.onreadystatechange=function(){if(!g||j)m.readyState=m._object.readyState,d(m),m._aborted?m.readyState=b.UNSENT:(m.readyState==b.DONE&&(delete m._data,
e(m),h&&j&&window.detachEvent("onunload",s)),p!=m.readyState&&c(m),p=m.readyState)}};b.prototype.send=function(a){b.onsend&&b.onsend.apply(this,arguments);arguments.length||(a=null);a&&a.nodeType&&(a=window.XMLSerializer?(new window.XMLSerializer).serializeToString(a):a.xml,this._headers["Content-Type"]||this._object.setRequestHeader("Content-Type","application/xml"));this._data=a;this._object.send(this._data);if(g&&!this._async){this.readyState=b.OPENED;for(d(this);this.readyState<b.DONE;)if(this.readyState++,
c(this),this._aborted)break}};b.prototype.abort=function(){b.onabort&&b.onabort.apply(this,arguments);if(this.readyState>b.UNSENT)this._aborted=!0;this._object.abort();e(this);this.readyState=b.UNSENT;delete this._data};b.prototype.getAllResponseHeaders=function(){return this._object.getAllResponseHeaders()};b.prototype.getResponseHeader=function(a){return this._object.getResponseHeader(a)};b.prototype.setRequestHeader=function(a,b){if(!this._headers)this._headers={};this._headers[a]=b;return this._object.setRequestHeader(a,
...
b[3],b[4]);delete a.__func};if(!GeoGlobe.Request)GeoGlobe.Request={};GeoGlobe.Request.XMLHttpRequest=b})();
...
mapboxgl.FreeCRSMap.prototype.getResolutions=function(){for(var a=[],b=0;b<=20;b++)a.push(this.getResolutionForLevel(b));return a};mapboxgl.FreeCRSMap.prototype.getResolutionForLevel=function(a,b){var c=Math.abs(this._tileExtent[2]-this._tileExtent[0]);return c/(b?b:256)/Math.pow(2,a)};mapboxgl.FreeCRSMap.prototype.setIsConstrain=function(a){this.isConstrain=a;this.transform._constraining=!this.isConstrain};
mapboxgl.FreeCRSMap.prototype.addLayer=function(a,b){if(a.CLASS_NAME==="GeoGlobe.Layer.VTS"||a.layerType==="VTS"){var c=a.layers;this.addSource(a.source_id,a.source);if(c.length>0)for(var d=0;d<c.length;d++)this.addLayer(c[d]);return this}if(a.layerOption&&a.layerOption.metadata.type==="wms"&&a.layerOption.metadata.isTile===!1)return a.addTo(this),this.style.addLayer(a.layerOption,b),this._update(!0),this;if(a.layerOption&&a.layerOption.metadata.type==="hotarea")return a.addTo(this),this;if(typeof a.source===
"object"&&this._mapCRS&&a.source&&a.source.type=="geojson"&&a.source.data&&!a.source.data.customprj)a.source.data.customprj=this._geojson_customprj;this.style.addLayer(a,b);this._update(!0);return this};mapboxgl.FreeCRSMap.prototype.removeLayerAndSource=function(a){if(this.getLayer(a))this.removeLayer(a),this.removeSource(a);else throw Error("Layer not found");};mapboxgl.FreeCRSMap.prototype.loadSprite=function(a,b){this.style._loadSprite(a,b)};
mapboxgl.FreeCRSMap.prototype.removeAllImages=function(){var a=this.style.imageManager,b;for(b in a.images)a.removeImage(b)};mapboxgl.FreeCRSMap.prototype.removeAllLayers=function(){var a=this.style._layers,b;for(b in a)this.removeLayer(b)};mapboxgl.FreeCRSMap.prototype.removeAllSources=function(){var a=this.style.sourceCaches,b;for(b in a)this.removeSource(b)};
...
b.TILECOL="{x}";GeoGlobe.Util.applyDefaults(b,{service:"WMTS",request:"GetTile"});b=this.urlAppend(a.url,this.getParameterString(b||{}));b=GeoGlobe.appendToProxy(b);return{id:"wmts_"+a.layer+"_"+GeoGlobe.Util.randomStr(8),type:"raster",source:{type:"raster",tiles:[b],zoomOffset:a.zoomOffset,tileSize:256}}},getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];if(d!=null&&typeof d!="function"){if(typeof d=="object"&&d.constructor==Array){for(var e=[],f,g=0,h=d.length;g<h;g++)f=d[g],e.push(encodeURIComponent(f===
null||f===void 0?"":f));d=e.join(",")}b.push(encodeURIComponent(c)+"="+d)}}return b.join("&")},urlAppend:function(a,b){var c=a;if(b){var d=(a+" ").split(/[?&]/);c+=d.pop()===" "?b:d.length?"&"+b:"?"+b}return c},clone:function(a){a==null&&(a=new GeoGlobe.Layer.WMTS(this.id,this.tileSize,this.filter,this.opacity,this.visible,this.name,this.url));return a},getMatrix:function(){var a;if(!this.matrixIds||this.matrixIds.length===0)a={identifier:this.getIdentifier()};else if("scaleDenominator"in this.matrixIds[0])for(var b=
GeoGlobe.METERS_PER_INCH*GeoGlobe.INCHES_PER_UNIT[this.units]*this.getServerResolution()/2.8E-4,c=Number.POSITIVE_INFINITY,d,e=0,f=this.matrixIds.length;e<f;++e)d=Math.abs(1-this.matrixIds[e].scaleDenominator/b),d<c&&(c=d,a=this.matrixIds[e]);else a=this.matrixIds[this.getIdentifier()];return a},CLASS_NAME:"GeoGlobe.Layer.WMTS"});
...
GeoGlobe.TDTLayer=GeoGlobe.Class4OL({initialize:function(a){return this._getLayer(a)},_getLayer:function(a){var b="tdt_"+a+"_"+GeoGlobe.Util.randomStr(8),a=GeoGlobe.ProxyHost+this._getUrlTemplateByName(a);return{id:b,type:"raster",source:{type:"raster",tiles:[a],tileSize:256}}},_getUrlTemplateByName:function(a){return"http://t0.tianditu.com/"+a+"/wmts?"+this._getParameterString(this.tdtParams[a])},tdtParams:{vec_w:{SERVICE:"WMTS",REQUEST:"GetTile",LAYER:"vec",TILEMATRIXSET:"w",FORMAT:"tiles",VERSION:"1.0.0",
STYLE:"default",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"},cva_w:{SERVICE:"WMTS",REQUEST:"GetTile",LAYER:"cva",TILEMATRIXSET:"w",FORMAT:"tiles",VERSION:"1.0.0",STYLE:"default",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"},vec_c:{SERVICE:"WMTS",REQUEST:"GetTile",LAYER:"vec",TILEMATRIXSET:"c",FORMAT:"tiles",VERSION:"1.0.0",STYLE:"default",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"},cva_c:{SERVICE:"WMTS",REQUEST:"GetTile",LAYER:"cva",TILEMATRIXSET:"c",FORMAT:"tiles",VERSION:"1.0.0",STYLE:"default",
TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"},img_w:{SERVICE:"WMTS",REQUEST:"GetTile",LAYER:"img",TILEMATRIXSET:"w",FORMAT:"tiles",VERSION:"1.0.0",STYLE:"default",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"},cia_w:{SERVICE:"WMTS",REQUEST:"GetTile",LAYER:"cia",TILEMATRIXSET:"w",FORMAT:"tiles",VERSION:"1.0.0",STYLE:"default",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"},img_c:{SERVICE:"WMTS",REQUEST:"GetTile",LAYER:"img",TILEMATRIXSET:"c",FORMAT:"tiles",VERSION:"1.0.0",STYLE:"default",TILEMATRIX:"{z}",
TILEROW:"{y}",TILECOL:"{x}"},cia_c:{SERVICE:"WMTS",REQUEST:"GetTile",LAYER:"cia",TILEMATRIXSET:"c",FORMAT:"tiles",VERSION:"1.0.0",STYLE:"default",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"}},_getParameterString:function(a){var b=[],c;for(c in a){var d=a[c];d!=null&&typeof d!="function"&&b.push(c.toUpperCase()+"="+d)}return b.join("&")},CLASS_NAME:"GeoGlobe.TDTLayer"});
...
e,f,g,h,j,l,n,o=0,r=d.length;a:for(;o<r;++o){c=d[o];e=c.x1;f=c.x2;g=c.y1;h=c.y2;var t=0,m=a.length;for(;t<m;++t){j=a[t];if(j.x1>f)break;if(!(j.x2<e)&&(l=j.y1,n=j.y2,!(Math.min(l,n)>Math.max(g,h))&&!(Math.max(l,n)<Math.min(g,h))&&GeoGlobe.Geometry.segmentsIntersect(c,j))){b=!0;break a}}}}else b=a.intersects(this);return b},getSortedSegments:function(){for(var a=this.components.length-1,b=Array(a),c,d,e=0;e<a;++e)c=this.components[e],d=this.components[e+1],b[e]=c.x<d.x?{x1:c.x,y1:c.y,x2:d.x,y2:d.y}:
{x1:d.x,y1:d.y,x2:c.x,y2:c.y};return b.sort(function(a,b){return a.x1-b.x1})},splitWithSegment:function(a,b){for(var c=!(b&&b.edge===!1),d=b&&b.tolerance,e=[],f=this.getVertices(),g=[],h=[],j=!1,l,n,o,r={point:!0,tolerance:d},t=null,m=0,p=f.length-2;m<=p;++m)if(d=f[m],g.push(d.clone()),l=f[m+1],n={x1:d.x,y1:d.y,x2:l.x,y2:l.y},n=GeoGlobe.Geometry.segmentsIntersect(a,n,r),n instanceof GeoGlobe.Geometry.Point&&((o=n.x===a.x1&&n.y===a.y1||n.x===a.x2&&n.y===a.y2||n.equals(d)||n.equals(l)?!0:!1)||c))n.equals(h[h.length-
1])||h.push(n.clone()),!(m===0&&n.equals(d))&&!n.equals(l)&&(j=!0,n.equals(d)||g.push(n),e.push(new GeoGlobe.Geometry.LineString(g)),g=[n.clone()]);j&&(g.push(l.clone()),e.push(new GeoGlobe.Geometry.LineString(g)));if(h.length>0)var s=a.x1<a.x2?1:-1,q=a.y1<a.y2?1:-1,t={lines:e,points:h.sort(function(a,b){return s*a.x-s*b.x||q*a.y-q*b.y})};return t},split:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h;if(a instanceof GeoGlobe.Geometry.LineString){var j=this.getVertices(),l,n,o,r,t,m=[];g=[];for(var p=
0,s=j.length-2;p<=s;++p){l=j[p];n=j[p+1];o={x1:l.x,y1:l.y,x2:n.x,y2:n.y};h=h||[a];d&&m.push(l.clone());for(var q=0;q<h.length;++q)if(r=h[q].splitWithSegment(o,b))if(t=r.lines,t.length>0&&(t.unshift(q,1),Array.prototype.splice.apply(h,t),q+=t.length-2),d)for(var u=0,v=r.points.length;u<v;++u)t=r.points[u],t.equals(l)||(m.push(t),g.push(new GeoGlobe.Geometry.LineString(m)),m=t.equals(n)?[]:[t.clone()])}d&&g.length>0&&m.length>0&&(m.push(n.clone()),g.push(new GeoGlobe.Geometry.LineString(m)))}else c=
...
h=a.x,j=a.y,l,n=0,o=g.length;n<o;++n)if(l=g[n],d=GeoGlobe.Geometry.distanceToSegment(a,l),d.distance<f){if(f=d.distance,e=d,f===0)break}else if(l.x2>h&&(j>l.y1&&j<l.y2||j<l.y1&&j>l.y2))break;e=c?{distance:e.distance,x0:e.x,y0:e.y,x1:h,y1:j}:e.distance}else if(a instanceof GeoGlobe.Geometry.LineString){var g=this.getSortedSegments(),h=a.getSortedSegments(),r,t,m=h.length,p={point:!0},n=0,o=g.length;a:for(;n<o;++n){j=g[n];l=j.x1;t=j.y1;for(var s=0;s<m;++s)if(d=h[s],r=GeoGlobe.Geometry.segmentsIntersect(j,
d,p)){f=0;e={distance:0,x0:r.x,y0:r.y,x1:r.x,y1:r.y};break a}else if(d=GeoGlobe.Geometry.distanceToSegment({x:l,y:t},d),d.distance<f)f=d.distance,e={distance:f,x0:l,y0:t,x1:d.x,y1:d.y}}if(!c)e=e.distance;f!==0&&j&&(d=a.distanceTo(new GeoGlobe.Geometry.Point(j.x2,j.y2),b),n=c?d.distance:d,n<f&&(e=c?{distance:f,x0:d.x1,y0:d.y1,x1:d.x0,y1:d.y0}:n))}else e=a.distanceTo(this,b),c&&(e={distance:e.distance,x0:e.x1,y0:e.y1,x1:e.x0,y1:e.y0});return e},simplify:function(a){if(this&&this!==null){var b=this.getVertices();
if(b.length<3)return this;var c=function(a,b,d,j){for(var l=0,n=0,o=b,r;o<d;o++)r=Math.abs(0.5*(a[b].x*a[d].y+a[d].x*a[o].y+a[o].x*a[b].y-a[d].x*a[b].y-a[o].x*a[d].y-a[b].x*a[o].y))/Math.sqrt(Math.pow(a[b].x-a[d].x,2)+Math.pow(a[b].y-a[d].y,2))*2,r>l&&(l=r,n=o);l>j&&n!=b&&(e.push(n),c(a,b,n,j),c(a,n,d,j))},d=b.length-1,e=[];e.push(0);for(e.push(d);b[0].equals(b[d]);)d--,e.push(d);c(b,0,d,a);a=[];e.sort(function(a,b){return a-b});for(d=0;d<e.length;d++)a.push(b[e[d]]);return new GeoGlobe.Geometry.LineString(a)}else return this},
...
GeoGlobe.Geometry.MultiLineString=GeoGlobe.Class4OL(GeoGlobe.Geometry.Collection,{componentTypes:["GeoGlobe.Geometry.LineString"],split:function(a,b){for(var c=null,d=b&&b.mutual,e,f,g,h,j=[],l=[a],n=0,o=this.components.length;n<o;++n){f=this.components[n];g=!1;for(var r=0;r<l.length;++r)if(e=f.split(l[r],b)){if(d){g=e[0];for(var t=0,m=g.length;t<m;++t)t===0&&j.length?j[j.length-1].addComponent(g[t]):j.push(new GeoGlobe.Geometry.MultiLineString([g[t]]));g=!0;e=e[1]}if(e.length){e.unshift(r,1);Array.prototype.splice.apply(l,
e);break}}g||(j.length?j[j.length-1].addComponent(f.clone()):j=[new GeoGlobe.Geometry.MultiLineString(f.clone())])}j&&j.length>1?g=!0:j=[];l&&l.length>1?h=!0:l=[];if(g||h)c=d?[j,l]:l;return c},splitWith:function(a,b){var c=null,d=b&&b.mutual,e,f,g,h,j,l;if(a instanceof GeoGlobe.Geometry.LineString){l=[];j=[a];for(var n=0,o=this.components.length;n<o;++n){g=!1;f=this.components[n];for(var r=0;r<j.length;++r)if(e=j[r].split(f,b)){d&&(g=e[0],g.length&&(g.unshift(r,1),Array.prototype.splice.apply(j,g),
r+=g.length-2),e=e[1],e.length===0&&(e=[f.clone()]));g=0;for(var t=e.length;g<t;++g)g===0&&l.length?l[l.length-1].addComponent(e[g]):l.push(new GeoGlobe.Geometry.MultiLineString([e[g]]));g=!0}g||(l.length?l[l.length-1].addComponent(f.clone()):l=[new GeoGlobe.Geometry.MultiLineString([f.clone()])])}}else c=a.split(this);j&&j.length>1?h=!0:j=[];l&&l.length>1?g=!0:l=[];if(h||g)c=d?[j,l]:l;return c},CLASS_NAME:"GeoGlobe.Geometry.MultiLineString"});
...
a.features?a.features.length:0,c=Array(b),e=0;e<b;++e)c[e]=a.features[e].fid;m.insertIds=c;d.apply(this,[a])}function d(a){this.callUserCallback(a,b);t=t&&a.success();f++;if(f>=r&&b.callback)m.code=t?GeoGlobe.Protocol.Response.SUCCESS:GeoGlobe.Protocol.Response.FAILURE,b.callback.apply(b.scope,[m])}var b=GeoGlobe.Util.applyDefaults(b,this.options),e=[],f=0,g={};g[GeoGlobe.State.INSERT]=[];g[GeoGlobe.State.UPDATE]=[];g[GeoGlobe.State.DELETE]=[];for(var h,j,l=[],n=0,o=a.length;n<o;++n)if(h=a[n],j=g[h.state])j.push(h),
l.push(h);var r=(g[GeoGlobe.State.INSERT].length>0?1:0)+g[GeoGlobe.State.UPDATE].length+g[GeoGlobe.State.DELETE].length,t=!0,m=new GeoGlobe.Protocol.Response({reqFeatures:l});h=g[GeoGlobe.State.INSERT];h.length>0&&e.push(this.create(h,GeoGlobe.Util.applyDefaults({callback:c,scope:this},b.create)));h=g[GeoGlobe.State.UPDATE];for(n=h.length-1;n>=0;--n)e.push(this.update(h[n],GeoGlobe.Util.applyDefaults({callback:d,scope:this},b.update)));h=g[GeoGlobe.State.DELETE];for(n=h.length-1;n>=0;--n)e.push(this["delete"](h[n],
...
(g[o.identifier]=o["default"])}for(var r=c.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),t=c.units||(r==="EPSG:4326"?"degrees":"m"),m=[],p,s,c=[],n=e.tileMatrixSetLinks,g=function(a){m.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[t]);if(!p||p>a)p=a;if(!s||s<a)s=a},o=0,j=n.length;o<j;o++)if(f=n[o],f.tileMatrixSet===h.identifier){if(f.tileMatrixSetLimits){for(var j={},o=0,q=h.matrixIds.length;o<q;o++)j[h.matrixIds[o].identifier]=h.matrixIds[o];o=
0;for(q=f.tileMatrixSetLimits.length;o<q;o++)n=j[f.tileMatrixSetLimits[o].tileMatrix],c.push(n),g(n.scaleDenominator)}else{o=0;for(q=h.matrixIds.length;o<q;o++)g(h.matrixIds[o].scaleDenominator)}break}m.sort(function(a,b){return b-a});var u="",v={layers:[],source:{},source_id:"",url:"",url_tmpl:"",layerType:"VTS"},b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,TILEMATRIXSET:h.identifier,FORMAT:"protobuf",TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});
...
"$1:$3")===c.projection){j=d.tileMatrixSets[e.tileMatrixSetLinks[f].tileMatrixSet];break}}else e.tileMatrixSetLinks.length>=1&&(j=d.tileMatrixSets[e.tileMatrixSetLinks[0].tileMatrixSet]);if(!j)throw Error("matrixSet not found");for(var n,f=0,g=e.styles.length;f<g;++f)if(n=e.styles[f],n.isDefault)break;(f=c.requestEncoding)||(f="KVP");f=[];g=c.params||{};delete c.params;for(var o=0,l=e.dimensions.length;o<l;o++){var r=e.dimensions[o];f.push(r.identifier);g.hasOwnProperty(r.identifier)||(g[r.identifier]=
r["default"])}for(var f=c.projection||j.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),t=c.units||(f==="EPSG:4326"?"degrees":"m"),m=[],p,s,c=[],r=e.tileMatrixSetLinks,o=function(a){m.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[t]);if(!p||p>a)p=a;if(!s||s<a)s=a},q=0,l=r.length;q<l;q++)if(g=r[q],g.tileMatrixSet===j.identifier){if(g.tileMatrixSetLimits){for(var l={},q=0,u=j.matrixIds.length;q<u;q++)l[j.matrixIds[q].identifier]=j.matrixIds[q];q=0;for(u=g.tileMatrixSetLimits.length;q<
u;q++)r=l[g.tileMatrixSetLimits[q].tileMatrix],c.push(r),o(r.scaleDenominator)}else{q=0;for(u=j.matrixIds.length;q<u;q++)o(j.matrixIds[q].scaleDenominator)}break}m.sort(function(a,b){return b-a});c="";b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,STYLE:n.identifier,TILEMATRIXSET:j.identifier,FORMAT:h,TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});c=a.endsWith("?")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;a=GeoGlobe.Util.randomStr(10);if(e.bounds)var v=
...
(c="KVP");var n=[],e=b.params||{};delete b.params;f=0;for(j=d.dimensions.length;f<j;f++){var o=d.dimensions[f];n.push(o.identifier);e.hasOwnProperty(o.identifier)||(e[o.identifier]=o["default"])}for(var n=b.projection||h.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),r=b.units||(n==="EPSG:4326"?"degrees":"m"),t=[],m,p,n=[],o=d.tileMatrixSetLinks,f=function(a){t.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[r]);if(!m||m>a)m=a;if(!p||p<a)p=a},s=0,j=o.length;s<j;s++)if(e=
o[s],e.tileMatrixSet===h.identifier){if(e.tileMatrixSetLimits){for(var j={},s=0,q=h.matrixIds.length;s<q;s++)j[h.matrixIds[s].identifier]=h.matrixIds[s];s=0;for(q=e.tileMatrixSetLimits.length;s<q;s++)o=j[e.tileMatrixSetLimits[s].tileMatrix],n.push(o),f(o.scaleDenominator)}else{s=0;for(q=h.matrixIds.length;s<q;s++)f(h.matrixIds[s].scaleDenominator)}break}if(c==="REST"&&d.resourceUrls){n=[];e=0;for(f=d.resourceUrls.length;e<f;++e)c=d.resourceUrls[e],c.format===g&&c.resourceType==="tile"&&n.push(c.template)}else{j=
a.operationsMetadata.GetTile.dcp.http.get;n=[];e=0;for(f=j.length;e<f;e++)o=j[e].constraints,(!o||o&&o.GetEncoding.allowedValues[c])&&n.push(j[e].url)}t.sort(function(a,b){return b-a});c="";g="SERVICE=WMTS&REQUEST=GetTile&VERSION="+a.version+"&LAYER="+d.identifier+"&STYLE="+l.identifier+"&TILEMATRIXSET="+h.identifier+"&TILEMATRIX={z}&TILEROW={y}&TILECOL={x}&FORMAT="+g;c=n[0].endsWith("?")?n[0]+g:n[0]+"?"+g;g=GeoGlobe.Util.applyDefaults(b,{id:d.identifier,url:[c]});g=new GeoGlobe.Layer.VTS(g);g.matrixSet=
...
o["default"])}for(var d=c.projection||j.supportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/,"$1:$3"),r=c.units||(d==="EPSG:4326"?"degrees":"m"),t=[],m,p,c=[],n=e.tileMatrixSetLinks,f=function(a){t.push(a*2.8E-4/GeoGlobe.METERS_PER_INCH/GeoGlobe.INCHES_PER_UNIT[r]);if(!m||m>a)m=a;if(!p||p<a)p=a},o=0,g=n.length;o<g;o++)if(d=n[o],d.tileMatrixSet===j.identifier){if(d.tileMatrixSetLimits){for(var g={},o=0,s=j.matrixIds.length;o<s;o++)g[j.matrixIds[o].identifier]=j.matrixIds[o];o=0;for(s=d.tileMatrixSetLimits.length;o<
s;o++)n=g[d.tileMatrixSetLimits[o].tileMatrix],c.push(n),f(n.scaleDenominator)}else{o=0;for(s=j.matrixIds.length;o<s;o++)f(j.matrixIds[o].scaleDenominator)}break}t.sort(function(a,b){return b-a});c="";b=this.getParameterString({SERVICE:"WMTS",REQUEST:"GetTile",VERSION:b.version,LAYER:e.identifier,STYLE:l.identifier,TILEMATRIXSET:j.identifier,FORMAT:h,TILEMATRIX:"{z}",TILEROW:"{y}",TILECOL:"{x}"});c=a.endsWith("?")?GeoGlobe.ProxyHost+a+b:GeoGlobe.ProxyHost+a+"?"+b;a=GeoGlobe.Util.randomStr(10);return{id:"layer_"+
...
b(l);j[n]=h(l,n)}}return j}else if(c.nodeType==p.ELEMENT_NODE){j={};j.__cnt=0;o=c.childNodes;for(m=0;m<o.length;m++)if(l=o.item(m),n=b(l),l.nodeType!=p.COMMENT_NODE){var t=f+"."+n;if(l.nodeType==p.ELEMENT_NODE&&a.xmlElementsFilter.length>0?d(a.xmlElementsFilter,j,n,t):1)j.__cnt++,j[n]==null?(j[n]=h(l,t),e(j,n,t)):(j[n]!=null&&!(j[n]instanceof Array)&&(j[n]=[j[n]],e(j,n,t)),j[n][j[n].length]=h(l,t))}for(o=0;o<c.attributes.length;o++)m=c.attributes.item(o),j.__cnt++,j[a.attributePrefix+m.name]=m.value;
...
b[c]instanceof Function?!0:!1}function o(a){var b=0;if(a instanceof Object)for(var c in a)n(a,c)||b++;return b}function r(b){var c=[];if(b instanceof Object)for(var d in b)d.toString().indexOf("__")==-1&&d.toString().indexOf(a.attributePrefix)==0&&c.push(d);return c}function t(b){var d="";if(b instanceof Object){var e="";b.__cdata!=null&&(e+="<![CDATA["+b.__cdata+"]]\>");b.__text!=null&&(e+=a.escapeMode?c(b.__text):b.__text);d+=e}else b!=null&&(d+=a.escapeMode?c(b):b);return d}function m(b,c){var e=
"";if(o(b)>0)for(var f in b){var g;if(!(g=n(b,f)))if(g=c!="")g=c===""?f:c+"."+f,g=!(a.jsonPropertiesFilter.length==0||g==""||d(a.jsonPropertiesFilter,b,f,g));if(!g){var h=b[f];g=r(h);if(h==null||h==void 0)e+=j(h,f,g,!0);else if(h instanceof Object)if(h instanceof Array){var p=f,B=c,A="";if(h.length==0)A+=j(h,p,g,!0);else for(g=0;g<h.length;g++)A+=j(h[g],p,r(h[g]),!1),A+=m(h[g],B===""?p:B+"."+p),A+=l(h[g],p);e+=A}else h instanceof Date?(e+=j(h,f,g,!1),e+=h.toISOString(),e+=l(h,f)):o(h)>0||h.__text!=
null||h.__cdata!=null?(e+=j(h,f,g,!1),e+=m(h,c===""?f:c+"."+f),e+=l(h,f)):e+=j(h,f,g,!0);else e+=j(h,f,g,!1),e+=t(h),e+=l(h,f)}}e+=t(b);return e}a=a||{};if(a.escapeMode===void 0)a.escapeMode=!0;a.attributePrefix=a.attributePrefix||"_";a.arrayAccessForm=a.arrayAccessForm||"none";a.emptyNodeForm=a.emptyNodeForm||"text";if(a.enableToStringFunc===void 0)a.enableToStringFunc=!0;a.arrayAccessFormPaths=a.arrayAccessFormPaths||[];if(a.skipEmptyTextNodesForObj===void 0)a.skipEmptyTextNodesForObj=!0;if(a.stripWhitespaces===
...
else h.push(b.Contents.Layer);for(var l=0;l<h.length;l++){d={};d.version=b.attributes.version;d.format=h[l].Format[4].text;d.LayerIdentifier=h[l].Identifier.text;d.StyleIdentifier=h[l].Style.Identifier.text;d.MatrixSet=h[l].TileMatrixSetLink[0].TileMatrixSet.text;if(h[l].BoundingBox)d.Bounding=h[l].BoundingBox;for(var n="",j=0;j<b.Contents.TileMatrixSet.length;j++)if(b.Contents.TileMatrixSet[j].Identifier.text==d.MatrixSet)var o=b.Contents.TileMatrixSet[j];d.mapCRS=o.SupportedCRS.text;var r=o.TileMatrix[0];
d.initZoom=r.Identifier.text;if(r.length>0){for(var j=0,t=r.length;j<t;j++){if(j==t)break;n+=r[j].ScaleDenominator.text+","}d.Scales=n.substr(0,n.length-1);d.zoomOffset=r[0].Identifier.text}else if(r)n+=r.ScaleDenominator.text+",",d.Scales=n.substr(0,n.length-1),d.zoomOffset=r.Identifier.text;c[l]=d}a(c,b)},b)},xmlToJson:function(a){var b={};if(a.nodeType==1){if(a.attributes.length>0){b.attributes={};for(var c=0;c<a.attributes.length;c++){var d=a.attributes.item(c);b.attributes[d.nodeName]=d.nodeValue}}}else if(a.nodeType==
...
GeoGlobe.Visuals=GeoGlobe.Class4OL(GeoGlobe.ElementContainer,{initialize:function(){GeoGlobe.ElementContainer.prototype.initialize.apply(this,arguments)},addTo:function(){GeoGlobe.ElementContainer.prototype.addTo.apply(this,arguments)}});GeoGlobe.Visuals=GeoGlobe.Class4OL(GeoGlobe.Visuals,mapboxgl.Evented);
GeoGlobe.Visuals.Three=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],_threebox:null,_raycaster:null,_raycAsix:null,initialize:function(){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);this.layers=[];!window.THREE||!window.Threebox?console.error("\u4f7f\u7528three\u53ef\u89c6\u5316\u56fe\u5c42\u524d\uff0c\u9700\u5f15\u5165threejs\u5e93\uff01"):(this._raycaster=new THREE.Raycaster,this._raycAsix=new THREE.Vector2)},addTo:function(){GeoGlobe.Visuals.prototype.addTo.apply(this,
arguments);this.container.className="geoglobe-three-container";this._threebox=new Threebox(this.map,this.container);this._threebox.setupDefaultLights();this._bindEvent()},render:function(){if(this._order)for(var a=0;a<this._order.length;a++)for(var b=0;b<this.layers.length;b++)this.layers[b].id==this._order[a]&&this.layers[b].render();else for(b=0;b<this.layers.length;b++)this.layers[b].render();this._render()},_render:function(){this._threebox.render()},addLayer:function(a){a.id?this.getLayer(a.id)||
this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a===this.layers[c].id?this._removeInnerLayer(this.layers[c]):b.push(this.layers[c]);this.layers=b},moveLayer:function(a,b){if(this.getLayer(a)){this._order=this.layers.map(function(a){return a.id});this._order.splice(this._order.indexOf(a),1);var c=b?this._order.indexOf(b):this._order.length;b&&c===-1?this.fire("error",{error:Error('Layer with id "'+
b+'" does not exist on this map.')}):this._order.splice(c,0,a)}else this.fire("error",{error:Error("The layer '"+a+"' does not exist in the map's style and cannot be moved.")})},_removeInnerLayer:function(a){if(a._meshes&&a._meshes instanceof Array&&a._meshes.length>0)for(var b=0;b<a._meshes.length;b++){for(var c=0;c<this._threebox.world.children.length;c++)if(this._threebox.world.children[c].children.length!==0&&this._threebox.world.children[c].children[0].uuid===a._meshes[b].uuid){this._threebox.world.remove(a._meshes[b].parent);
...
this.container.offsetTop)/this.container.offsetHeight)*2+1;this._raycaster.setFromCamera(this._raycAsix,this._threebox.camera);return this._raycaster.intersectObjects(this._threebox.scene.children,!0)},_getSymbolObject:function(a){return a.userData.attributes?a:this._getSymbolObject(a.parent)}});
GeoGlobe.Visuals.Three.PointLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,data:[],getColor:function(a){return a.properties.color?a.properties.color:"rgb(255, 0, 0)"},getTexture:function(a){return a.properties.texture?a.properties.texture:""},getPoint:function(a){return a.geometry.type==="Point"?a.geometry.coordinates:null},getSize:function(a){return a.properties.size?a.properties.size:1},_three:null,_meshes:[],_textureCache:[],initialize:function(a){this.id=a.id?a.id:this.id;this.visible=
a.visible?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.data=a.data?a.data:this.data;this.getColor=a.getColor?a.getColor:this.getColor;this.getTexture=a.getTexture?a.getTexture:this.getTexture;this.getPoint=a.getPoint?a.getPoint:this.getPoint;this.getSize=a.getSize?a.getSize:this.getSize},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=
this;a._three._removeInnerLayer(a);a._meshes=[];for(var b=0;b<a.data.length;b++){var c=a.data[b],d=null;if(d=a.getTexture(c)){var e=a._getTextureCacheByURL(d);e?e=e.clone():(e=(new THREE.TextureLoader).load(d,function(){a._three._render()}),a._addTextureInToCache({key:d,value:e}));d=new THREE.MeshPhongMaterial({map:e})}else d=new THREE.MeshPhongMaterial({color:new THREE.Color(a.getColor(c))});e=a.getSize(c);e=new THREE.CircleBufferGeometry(Threebox.ThreeboxConstants.PROJECTION_WORLD_SIZE*e/2,20);
d=new THREE.Mesh(e,d);e=a._three._threebox.projectToWorld(a.data[b].geometry.coordinates);d.position.set(e.x,e.y,e.z);d.visible=a.visible;d.name=(a.id?a.id:"threelayer")+"-"+b;d.userData.attributes={OriginalData:c,Layer:a};a._three._threebox.addGeoreferencedMesh(d);a._meshes.push(d);a._three._render()}},_getTextureCacheByURL:function(a){if(a)for(var b=0;b<this._textureCache.length;b++)if(this._textureCache[b].key===a&&this._textureCache[b].value.image)return this._textureCache[b].value;return null},
...
GeoGlobe.Visuals.Three.LineLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,data:[],getColor:function(a){return a.properties.color?a.properties.color:"rgb(255, 0, 0)"},getTexture:function(a){return a.properties.texture?a.properties.texture:""},getLineString:function(a){return a.geometry.type==="LineString"?a.geometry.coordinates:null},getWidth:function(a){return a.properties.width?a.properties.width:1},_three:null,_meshes:[],_textureCache:[],initialize:function(a){this.id=a.id?a.id:
this.id;this.visible=a.visible?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.data=a.data?a.data:this.data;this.getColor=a.getColor?a.getColor:this.getColor;this.getTexture=a.getTexture?a.getTexture:this.getTexture;this.getLineString=a.getLineString?a.getLineString:this.getLineString;this.getWidth=a.getWidth?a.getWidth:this.getWidth},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},
render:function(){this._three._removeInnerLayer(this);this._meshes=[];for(var a=0;a<this.data.length;a++){for(var b=this.data[a],c=new THREE.LineMaterial({color:new THREE.Color(this.getColor(b)),linewidth:5.0E-4*this.getWidth(b)}),d=[],e=this.data[a].geometry.coordinates,f=0;f<e.length;f++){var g=this._three._threebox.projectToWorld(e[f]);d.push(g.x,g.y,g.z)}e=new THREE.LineGeometry;e.setPositions(d);c=new THREE.Line2(e,c);c.computeLineDistances();c.visible=this.visible;c.name=(this.id?this.id:"threelayer")+
"-"+a;c.userData.attributes={OriginalData:b,Layer:this};this._three._threebox.addGeoreferencedMesh(c);this._meshes.push(c);this._three._render()}}});
GeoGlobe.Visuals.Three.PolygonLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,data:[],getColor:function(a){return a.properties.color?a.properties.color:"rgb(255, 0, 0)"},getTexture:function(a){return a.properties.texture?a.properties.texture:""},getPolygon:function(a){return a.geometry.type==="Polygon"?a.geometry.coordinates:null},_three:null,_meshes:[],_textureCache:[],initialize:function(a){this.id=a.id?a.id:this.id;this.visible=a.visible?a.visible:this.visible;this.opacity=a.opacity?
a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.data=a.data?a.data:this.data;this.getColor=a.getColor?a.getColor:this.getColor;this.getTexture=a.getTexture?a.getTexture:this.getTexture;this.getPolygon=a.getPolygon?a.getPolygon:this.getPolygon},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=this;a._three._removeInnerLayer(a);a._meshes=[];for(var b=0;b<a.data.length;b++){var c=a.data[b],
d=null;if(d=a.getTexture(c)){var e=a._getTextureCacheByURL(d);e?e=e.clone():(e=(new THREE.TextureLoader).load(d,function(){a._three._render()}),a._addTextureInToCache({key:d,value:e}));d=new THREE.MeshPhongMaterial({map:e})}else d=new THREE.MeshPhongMaterial({color:new THREE.Color(a.getColor(c))});for(var e=new THREE.Shape,f=a.data[b].geometry.coordinates,g=0;g<f.length;g++){var h=a._three._threebox.projectToWorld(f[g][0]);e.moveTo(h.x,h.y);for(h=1;h<f[g].length;h++){var j=a._three._threebox.projectToWorld(f[g][h]);
...
GeoGlobe.Visuals.Three.SymbolLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,data:[],scale:1,modelURL:"",autoplay:!1,getColor:function(a){return a.properties.color?a.properties.color:"rgb(255, 0, 0)"},getPosition:function(a){if(a.geometry.type==="Point"){var b=a.geometry.coordinates;a.properties.height?b.push(a.properties.height):b.push(0);return b}else return null},getGeometry:function(a){return a},getLoader:function(){return new THREE.JSONLoader},_three:null,_meshes:[],_clock:null,
_mixer:null,_modelCache:null,initialize:function(a){this.id=a.id?a.id:this.id;this.visible=a.visible?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.data=a.data?a.data:this.data;this.scale=a.scale?a.scale:this.scale;this.modelURL=a.modelURL?a.modelURL:this.modelURL;this.autoplay=a.autoplay?a.autoplay:this.autoplay;this.getColor=a.getColor?a.getColor:this.getColor;this.getPosition=a.getPosition?a.getPosition:this.getPosition;
this.getGeometry=a.getGeometry?a.getGeometry:this.getGeometry;this.getLoader=a.getLoader?a.getLoader:this.getLoader;this._clock=new THREE.Clock},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=this;a._modelCache=null;a.getLoader().load(a.modelURL,function(b){a._modelCache=b;a._draw()},function(a){console.log(a.loaded/a.total*100+"% loaded")},function(a){console.error(a)})},redraw:function(){this._modelCache?this._draw():
this.render()},_draw:function(){this._three._removeInnerLayer(this);this._meshes=[];for(var a=this._modelCache,b=0;b<this.data.length;b++){if(a.scene)if(this.autoplay){symbol=a.scene;symbol=this.getGeometry(symbol,this.data[b]);var c=a.animations;if(c&&c.length){for(var d=new THREE.AnimationMixer(symbol),e=0;e<c.length;e++)d.clipAction(c[e]).play();this._mixer=d}}else symbol=a.scene.clone(),symbol=this.getGeometry(symbol,this.data[b]);else a instanceof THREE.Group?(symbol=a.clone(),symbol=this.getGeometry(symbol,
this.data[b])):(c=this.getGeometry(a.clone(),this.data[b]),d=new THREE.MeshLambertMaterial({color:new THREE.Color(this.getColor(this.data[b])),side:THREE.DoubleSide}),symbol=(new THREE.Mesh(c,d)).clone());symbol.visible=this.visible;symbol.name=(this.id?this.id:"threelayer")+"-"+b;symbol.userData.attributes={OriginalData:this.data[b],Layer:this};c=this.scale?this.scale:1;d=this.getPosition(this.data[b]);Array.isArray(d)&&(d.length<3&&d.push(0),this._three._threebox.addAtCoordinate(symbol,d,{scaleToLatitude:!0,
preScale:c}));this._meshes.push(symbol)}this._three._render();this._animate()},_animate:function(){var a=this;a.autoplay&&(a._mixer.update(a._clock.getDelta()),a._three._render(),requestAnimationFrame(function(){a._animate()}))}});
GeoGlobe.Visuals.Three.BuildingLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,drawMode:{high:{minZoom:14,maxZoom:15},middle:{minZoom:16,maxZoom:17},low:{minZoom:18,maxZoom:20}},data:[],getColor:function(a){return a.properties.color?a.properties.color:"rgb(255, 0, 0)"},getFaceTexture:function(a){return a.properties.face_texture?a.properties.face_texture:""},getFaceTextureRepeat:function(a){return a.properties.face_texture_repeat?a.properties.face_texture_repeat:"10,10"},getSideTexture:function(a){return a.properties.side_texture?
...
a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.drawMode=a.drawMode?a.drawMode:this.drawMode;this.data=a.data?a.data:this.data;this.scale=a.scale?a.scale:this.scale;this.getColor=a.getColor?a.getColor:this.getColor;this.getFaceTexture=a.getFaceTexture?a.getFaceTexture:this.getFaceTexture;this.getFaceTextureRepeat=a.getFaceTextureRepeat?a.getFaceTextureRepeat:this.getFaceTextureRepeat;this.getSideTexture=a.getSideTexture?a.getSideTexture:
this.getSideTexture;this.getSideTextureRepeat=a.getSideTextureRepeat?a.getSideTextureRepeat:this.getSideTextureRepeat;this.getPolygon=a.getPolygon?a.getPolygon:this.getPolygon;this.getElevation=a.getElevation?a.getElevation:this.getElevation;this.getBaseElevation=a.getBaseElevation?a.getBaseElevation:this.getBaseElevation;(!this.drawMode||!this.drawMode.high||!this.drawMode.middle||!this.drawMode.low||this.drawMode.high.maxZoom==void 0||this.drawMode.high.minZoom==void 0||this.drawMode.high.maxZoom<
this.drawMode.high.minZoom)&&console.error("option\u4e2d\u7684drawMode\u683c\u5f0f\u4e0d\u6b63\u786e\uff01")},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){this._three._removeInnerLayer(this);this._meshes=[];switch(this._getDrawMode()){case "high":this._highDraw();break;case "middle":this._middleDraw();break;case "low":this._lowDraw();break;default:this._highDraw()}this._three._render()},_getDrawMode:function(){var a=
this._three.map.getZoom();if(this.drawMode.high.minZoom<a&&this.drawMode.high.maxZoom>=a)return"high";if(this.drawMode.middle.minZoom<a&&this.drawMode.middle.maxZoom>=a)return"middle";if(this.drawMode.low.minZoom<a&&this.drawMode.low.maxZoom>=a)return"low";return null},_highDraw:function(){for(var a=new THREE.Geometry,b=this.data.length>0?this.getColor(this.data[0]):"rgb(255, 0, 0)",b=new THREE.MeshPhongMaterial({color:new THREE.Color(b)}),c=0;c<this.data.length;c++){var d=this._createGeometry(this.data[c]);
a.merge(d)}a=new THREE.Mesh(a,b);a.visible=this.visible;a.name=(this.id?this.id:"threelayer")+"-merge";a.userData.attributes={OriginalData:this.data,Layer:this};this._three._threebox.addGeoreferencedMesh(a);this._meshes.push(a)},_middleDraw:function(){for(var a=0;a<this.data.length;a++){var b=this.data[a],c=this.getFaceTexture(b),d=this.getSideTexture(b),e=new THREE.MeshPhongMaterial({color:new THREE.Color(this.getColor(b))});if(c){c=this._createTexture(c);c.wrapS=c.wrapT=THREE.RepeatWrapping;var f=
this.getFaceTextureRepeat(b).split(",");c.repeat.set(f[0],f[1]);c=new THREE.MeshPhongMaterial({map:c})}else c=e.clone();d?(d=this._createTexture(d),d.wrapS=d.wrapT=THREE.RepeatWrapping,f=this.getSideTextureRepeat(b).split(","),d.repeat.set(f[0],f[1]),d=new THREE.MeshPhongMaterial({map:d})):d=e.clone();e=this._createGeometry(b);e=this._createUvs(e);c=new THREE.Mesh(e,[c,d]);c.visible=this.visible;c.name=(this.id?this.id:"threelayer")+"-"+a;c.userData.attributes={OriginalData:b,Layer:this};this._three._threebox.addGeoreferencedMesh(c);
this._meshes.push(c)}},_lowDraw:function(){for(var a=0;a<this.data.length;a++){var b=this.data[a],c=this.getFaceTexture(b),d=this.getSideTexture(b),e=new THREE.MeshPhongMaterial({color:new THREE.Color(this.getColor(b))});if(c){c=this._createTexture(c);c.wrapS=c.wrapT=THREE.RepeatWrapping;var f=this.getFaceTextureRepeat(b).split(",");c.repeat.set(f[0],f[1]);c=new THREE.MeshPhongMaterial({map:c})}else c=e.clone();d?(d=this._createTexture(d),d.wrapS=d.wrapT=THREE.RepeatWrapping,f=this.getSideTextureRepeat(b).split(","),
d.repeat.set(f[0],f[1]),d=new THREE.MeshPhongMaterial({map:d})):d=e.clone();e=this._createGeometry(b);e=this._createUvs(e);c=new THREE.Mesh(e,[c,d]);c.visible=this.visible;c.name=(this.id?this.id:"threelayer")+"-"+a;c.userData.attributes={OriginalData:b,Layer:this};this._three._threebox.addGeoreferencedMeshToWorld2(c);this._meshes.push(c)}},_createGeometry:function(a){var b=a.geometry.coordinates[0],c=new THREE.Shape,d=this._three._threebox.projectToWorld(b[0]);c.moveTo(d.x,d.y);for(d=1;d<b.length;d++){var e=
this._three._threebox.projectToWorld(b[d]);c.lineTo(e.x,e.y)}b={amount:this._three._threebox.distaneToWorld(this.getElevation(a)),bevelEnabled:!1,material:0,extrudeMaterial:1};c=new THREE.ExtrudeGeometry(c,b);if((a=this.getBaseElevation(a))&&a>0)a=this._three._threebox.distaneToWorld(a),c.translate(0,0,a);return c},_createUvs:function(a){a.faceVertexUvs=[[]];for(var b=[new THREE.Vector2(1,0),new THREE.Vector2(0,0),new THREE.Vector2(0,1),new THREE.Vector2(1,1)],c=a.faces.length,d=0;d<c;d+=2)if(a.faces[d].normal.z==
0)a.faceVertexUvs[0][d]=[b[1],b[0],b[2]],a.faceVertexUvs[0][d+1]=[b[0],b[3],b[2]];else{var e=a.vertices[a.faces[d].a],f=a.vertices[a.faces[d].b],g=a.vertices[a.faces[d].c];a.faceVertexUvs[0][d]=[new THREE.Vector2(e.x,e.y),new THREE.Vector2(f.x,f.y),new THREE.Vector2(g.x,g.y)];e=a.vertices[a.faces[d+1].a];f=a.vertices[a.faces[d+1].b];g=a.vertices[a.faces[d+1].c];a.faceVertexUvs[0][d+1]=[new THREE.Vector2(e.x,e.y),new THREE.Vector2(f.x,f.y),new THREE.Vector2(g.x,g.y)]}return a},_createTexture:function(a){var b=
this,c=b._getTextureCacheByURL(a);c?c=c.clone():(c=(new THREE.TextureLoader).load(a,function(){b._three._render()}),b._addTextureInToCache({key:a,value:c}));return c},_getTextureCacheByURL:function(a){if(a)for(;0<this._textureCache.length;)return this._textureCache[0].key===a&&this._textureCache[0].value.image?this._textureCache[0].value:null;else return null},_addTextureInToCache:function(a){for(var b=!1,c=0;c<this._textureCache.length;c++)if(this._textureCache[c].key===a.key){b=!0;break}b||this._textureCache.push(a)}});
GeoGlobe.Visuals.Three.VideoLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,autoplay:!0,data:[],getVideoTexture:function(a){return a.properties.video_texture?a.properties.video_texture:""},getLine:function(a){return a.geometry.type==="LineString"?a.geometry.coordinates:null},getElevation:function(a){return a.properties.height?a.properties.height:0},getBaseElevation:function(a){return a.properties.base_height?a.properties.base_height:0},_three:null,_meshes:[],_frameId:null,initialize:function(a){this.id=
a.id?a.id:this.id;this.visible=a.visible?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.autoplay=a.autoplay?a.autoplay:this.autoplay;this.data=a.data?a.data:this.data;this.getVideoTexture=a.getVideoTexture?a.getVideoTexture:this.getVideoTexture;this.getLine=a.getLine?a.getLine:this.getLine;this.getElevation=a.getElevation?a.getElevation:this.getElevation;this.getBaseElevation=a.getBaseElevation?a.getBaseElevation:this.getBaseElevation},
addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){this._three._removeInnerLayer(this);this._meshes=[];for(var a=[new THREE.Vector2(1,0),new THREE.Vector2(0,0),new THREE.Vector2(0,1),new THREE.Vector2(1,1)],b=0;b<this.data.length;b++){var c=this.data[b],d=this.getVideoTexture(c);if(d){var e=document.createElement("video");e.setAttribute("class","geoglobe-three-video");e.setAttribute("src",d);e.setAttribute("autoplay","autoplay");
e.setAttribute("loop","loop");e.style.display="none";document.body.appendChild(e);d=new THREE.VideoTexture(e);d.minFilter=THREE.LinearFilter;d.magFilter=THREE.LinearFilter;d.format=THREE.RGBFormat;var d=new THREE.MeshPhongMaterial({map:d,side:THREE.DoubleSide}),f=this.getBaseElevation(c),e=this._three._threebox.distaneToWorld(f),g=this.getElevation(c),f=this._three._threebox.distaneToWorld(f+g),h=this.getLine(c),g=this._three._threebox.projectToWorld(h[0]),h=this._three._threebox.projectToWorld(h[1]),
...
GeoGlobe.Visuals.Three.TextLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,scale:1,data:[],fontURL:"",size:100,thickness:50,curveSegments:12,getPosition:function(a){if(a.geometry.type==="Point"){var b=a.geometry.coordinates;a.properties.height?b.push(a.properties.height):b.push(0);return b}else return null},getText:function(a){return a.properties.text?a.properties.text:"\u672a\u77e5\u6587\u672c"},getColor:function(a){return a.properties.color?a.properties.color:"rgb(255, 0, 0)"},
getGeometry:function(a){return a},_three:null,_meshes:[],initialize:function(a){this.id=a.id?a.id:this.id;this.visible=a.visible?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.scale=a.scale?a.scale:this.scale;this.size=a.size?a.size:this.size;this.thickness=a.thickness?a.thickness:this.thickness;this.curveSegments=a.curveSegments?a.curveSegments:this.curveSegments;this.data=a.data?a.data:this.data;this.fontURL=a.fontURL?
a.fontURL:this.fontURL;this.getPosition=a.getPosition?a.getPosition:this.getPosition;this.getText=a.getText?a.getText:this.getText;this.getColor=a.getColor?a.getColor:this.getColor;this.getGeometry=a.getGeometry?a.getGeometry:this.getGeometry},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=this;a.fontURL?(this._three._removeInnerLayer(this),this._meshes=[],(new THREE.FontLoader).load(a.fontURL,function(b){for(var c=
0;c<a.data.length;c++){var d=a.data[c],e=a.getText(d),e=new THREE.TextGeometry(e,{font:b,size:a.size,height:a.thickness,curveSegments:a.curveSegments});e.computeBoundingBox();e.computeVertexNormals();e=a.getGeometry(e,d);materials=[new THREE.MeshPhongMaterial({color:new THREE.Color(a.getColor(d)),flatShading:!0}),new THREE.MeshPhongMaterial({color:new THREE.Color(a.getColor(d))})];textMesh=new THREE.Mesh(e,materials);var e=a.getPosition(d),f=a.scale?a.scale:1;textMesh.visible=a.visible;textMesh.name=
(a.id?a.id:"threelayer")+"-"+c;textMesh.userData.attributes={OriginalData:d,Layer:a};a._three._threebox.addAtCoordinate(textMesh,e,{scaleToLatitude:!0,preScale:f});a._meshes.push(textMesh)}a._three._render()})):console.error("\u5b57\u4f53\u8d44\u6e90\u662f\u5fc5\u987b\u7684\u5c5e\u6027\uff01")}});
GeoGlobe.Visuals.Three.CurveLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,data:[],getColor:function(a){return a.properties.color?a.properties.color:"rgb(255, 0, 0)"},getTexture:function(a){return a.properties.texture?a.properties.texture:""},getLineString:function(a){return a.geometry.type==="LineString"?a.geometry.coordinates:null},getWidth:function(a){return a.properties.width?a.properties.width:1},getCurveness:function(a){return a.properties.curveness?a.properties.curveness:
0.2},_three:null,_meshes:[],_textureCache:[],initialize:function(a){this.id=a.id?a.id:this.id;this.visible=a.visible?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable?a.pickable:this.pickable;this.data=a.data?a.data:this.data;this.getColor=a.getColor?a.getColor:this.getColor;this.getTexture=a.getTexture?a.getTexture:this.getTexture;this.getLineString=a.getLineString?a.getLineString:this.getLineString;this.getWidth=a.getWidth?a.getWidth:this.getWidth;this.getCurveness=
a.getCurveness?a.getCurveness:this.getCurveness},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},render:function(){var a=this;this._three._removeInnerLayer(this);this._meshes=[];for(var b=[],c=[],d=[],e=[],f=0;f<this.data.length;f++){var g=this.data[f],h=this.getWidth(g),j=new THREE.Color(this.getColor(g)),l=new THREE.LineMaterial({linewidth:5.0E-4*h,color:j,opacity:this.opacity,transparent:!0}),n=[],o=[],r=[],t=this.data[f].geometry.coordinates;
if(t.length>1)var m=this._three._threebox.projectToWorld(t[0]),p=this._three._threebox.projectToWorld(t[t.length-1]),p=Math.sqrt(Math.pow(p.x-m.x,2)+Math.pow(p.y-m.y,2)+Math.pow(p.z-m.z,2));for(var s=0;s<t.length-1;s++){var n=this._three._threebox.projectToWorld(t[s]),q=this._three._threebox.projectToWorld(t[s+1]),u={x:(n.x+q.x)/2,y:(n.y+q.y)/2,z:Math.sqrt(Math.pow(q.x-n.x,2)+Math.pow(q.y-n.y,2))/2*Math.tan(Math.PI/2*this.getCurveness(g))},u=new THREE.QuadraticBezierCurve3(new THREE.Vector3(n.x,n.y,
n.z),new THREE.Vector3(u.x,u.y,u.z),new THREE.Vector3(q.x,q.y,q.z));if(t.length>1)u.rate1=Math.sqrt(Math.pow(n.x-m.x,2)+Math.pow(n.y-m.y,2)+Math.pow(n.z-m.z,2))/p,u.rate2=Math.sqrt(Math.pow(q.x-n.x,2)+Math.pow(q.y-n.y,2)+Math.pow(q.z-n.z,2))/p;r.push(u);n=u.getPoints(50);for(q=0;q<n.length;q++)o.push(n[q].x,n[q].y,n[q].z)}t=new THREE.LineGeometry;t.setPositions(o);l=new THREE.Line2(t,l);l.computeLineDistances();l.visible=this.visible;l.name=(this.id?this.id:"threelayer")+"-"+f;l.userData.attributes=
{OriginalData:g,Layer:this};this._three._threebox.addGeoreferencedMesh(l);this._meshes.push(l);b.push(o[0]);b.push(o[1]);b.push(o[2]);c.push(j.r,j.g,j.b);d.push(10+h*h);e.push(r)}var v=new THREE.BufferGeometry,f=new THREE.ShaderMaterial({uniforms:{texture:{value:(new THREE.TextureLoader).load("../../images/lensflare.png")}},vertexShader:"attribute float size;varying vec3 vColor;void main() {vColor = color;vec4 mvPosition = modelViewMatrix * vec4( position, 1.0 );gl_PointSize = size;gl_Position = projectionMatrix * mvPosition;}",
fragmentShader:"varying vec3 vColor;uniform sampler2D texture;void main() {gl_FragColor = vec4( vColor, 1.0 );gl_FragColor = gl_FragColor * texture2D( texture, gl_PointCoord );}",blending:THREE.AdditiveBlending,depthTest:!1,transparent:!0,vertexColors:!0});v.addAttribute("position",(new THREE.Float32BufferAttribute(b,3)).setDynamic(!0));v.addAttribute("color",new THREE.Float32BufferAttribute(c,3));v.addAttribute("size",new THREE.Float32BufferAttribute(d,1));b=new THREE.Points(v,f);b.visible=this.visible;
b.name="particles";b.userData.attributes={OriginalData:g,Layer:this};this._three._threebox.addGeoreferencedMesh(b);this._meshes.push(b);this._three._render();var w=0,x;(function B(){requestAnimationFrame(B);w+=0.005;w>1&&(w=0);for(var b=v.attributes.position.array,c=0;c<e.length;c++){if(e[c].length===1)x=e[c][0].getPoint(w);else for(var d=0;d<e[c].length;d++)if(w>=e[c][d].rate1&&w<=e[c][d].rate1+e[c][d].rate2){x=e[c][d].getPoint((w-e[c][d].rate1)/e[c][d].rate2);break}b[c*3]=x.x;b[c*3+1]=x.y;b[c*3+
2]=x.z}v.attributes.position.needsUpdate=!0;a._three._render()})()}});
GeoGlobe.Visuals.Three.SingleBuildingLayer=GeoGlobe.Class4OL({id:"1",visible:!0,isCirclesVisible:!0,isFloorLinesVisible:!0,pickable:!0,opacity:1,data:{},getColor:function(a){return a.properties.color?a.properties.color:"rgb(255, 0, 0)"},getPolygon:function(a){return a.geometry.type==="Polygon"?a.geometry.coordinates:null},getElevation:function(a){if(a.properties.levels){var b=0;JSON.parse(a.properties.levels).forEach(function(a){b+=a});return b}else return 0},_three:null,_meshes:[],_textureCache:[],
_INTERSECTED_FLOOR:null,_INTERSECTED_FLOOR_2:null,_INTERSECTED_WALL:null,initialize:function(a){if(window.turf){this.id=a.id?a.id:this.id;if(a.visible!==void 0)this.visible=a.visible;if(a.isCirclesVisible!==void 0)this.isCirclesVisible=a.isCirclesVisible;if(a.isFloorLinesVisible!==void 0)this.isFloorLinesVisible=a.isFloorLinesVisible;this.opacity=a.opacity?a.opacity:this.opacity;if(a.pickable!==void 0)this.pickable=a.pickable;this.data=a.data?a.data:this.data;this.getColor=a.getColor?a.getColor:this.getColor;
this.getPolygon=a.getPolygon?a.getPolygon:this.getPolygon;this.getElevation=a.getElevation?a.getElevation:this.getElevation;this.getBaseElevation=a.getBaseElevation?a.getBaseElevation:this.getBaseElevation}else console.error("\u672a\u5f15\u5165turf.js\u5e93\uff01")},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},_createMaterial:function(){},_createLineGeometry:function(a){var b=new THREE.Geometry;a.forEach(function(a){b.vertices.push(a)});
return b},_createGeoExtrudeGeometry:function(a,b){var c=new THREE.Shape(a),c=new THREE.GeoExtrudeGeometry(c,b),d=new THREE.Geometry;d.faceVertexUvs=c.faceVertexUvs.concat();d.faces=c.faces.concat();d.vertices=c.vertices.concat();return d},_createSideGeometry:function(a,b){var c=new THREE.Shape(a),c=new THREE.GeoExtrudeGeometry(c,b),d=0;c.faces.forEach(function(a){a.normal.z!=0&&d++});c.faces.splice(0,d);var e=new THREE.Geometry;e.faceVertexUvs=c.faceVertexUvs.concat();e.faces=c.faces.concat();e.vertices=
c.vertices.concat();return e},_createPillarMesh:function(a,b,c){var d=this,e=new THREE.Geometry;a.forEach(function(a){var g=[];a.geometry.coordinates[0].forEach(function(a){g.push(d._three._threebox.projectToWorld(a))});var a=new THREE.Shape(g),a=new THREE.GeoExtrudeGeometry(a,b),h=new THREE.Geometry;h.faceVertexUvs=a.faceVertexUvs.concat();h.faces=a.faces.concat();h.vertices=a.vertices.concat();a=new THREE.Mesh(h,c);e.merge(a.geometry,a.matrix)});return new THREE.Mesh(e,c)},highlightFloor_Wall:function(a){var b=
null,c=null;if(a.length>0){for(var d=0;d<a.length;d++){if(a[d].object.userData.tag=="__wall__")c=a[d].object;if(a[d].object.userData.tag=="__floor__"){b=a[d].object;break}}if(b&&c&&this._INTERSECTED_FLOOR!=b&&this._INTERSECTED_WALL!=c){if(this._INTERSECTED_FLOOR&&this._INTERSECTED_WALL)this._INTERSECTED_FLOOR.material.color.setHex(6454209),this._INTERSECTED_FLOOR.material.opacity=0,this._INTERSECTED_WALL.material.color.setHex(this._INTERSECTED_WALL.currentHex),this._INTERSECTED_WALL.material.opacity=
this._INTERSECTED_WALL.currentOpacity;this._INTERSECTED_FLOOR=b;this._INTERSECTED_FLOOR.currentHex=this._INTERSECTED_FLOOR.material.color.getHex();this._INTERSECTED_FLOOR.currentOpacity=this._INTERSECTED_FLOOR.material.opacity;this._INTERSECTED_FLOOR.material.color.setHex(16777215);this._INTERSECTED_FLOOR.material.opacity=0.6;this._INTERSECTED_WALL=c;this._INTERSECTED_WALL.currentHex=this._INTERSECTED_WALL.material.color.getHex();this._INTERSECTED_WALL.currentOpacity=this._INTERSECTED_WALL.material.opacity;
this._INTERSECTED_WALL.material.color.setHex(16776960);this._INTERSECTED_WALL.material.opacity=0.3;this._three._render()}}else this._INTERSECTED_WALL=this._INTERSECTED_FLOOR=null;return b},highlightFloor:function(a){var b=null;if(a.length>0){for(var c=0;c<a.length;c++)if(a[c].object.userData.tag=="__floor__"){b=a[c].object;break}if(b&&this._INTERSECTED_FLOOR_2!=b){if(this._INTERSECTED_FLOOR_2)this._INTERSECTED_FLOOR_2.material.color.setHex(this._INTERSECTED_FLOOR_2.currentHex),this._INTERSECTED_FLOOR_2.material.opacity=
this._INTERSECTED_FLOOR_2.currentOpacity;if(this._INTERSECTED_FLOOR)this._INTERSECTED_FLOOR.material.color.setHex(16777215),this._INTERSECTED_FLOOR.material.opacity=0.6;this._INTERSECTED_FLOOR_2=b;this._INTERSECTED_FLOOR_2.currentHex=this._INTERSECTED_FLOOR_2.material.color.getHex();this._INTERSECTED_FLOOR_2.currentOpacity=this._INTERSECTED_FLOOR_2.material.opacity;this._INTERSECTED_FLOOR_2.material.color.setHex(8882055);this._INTERSECTED_FLOOR_2.material.opacity=0.2;this._three._render()}}else this._INTERSECTED_FLOOR_2=
null;return b},getSelectedFloor:function(a){var b=null;if(a.length>0)for(var c=0;c<a.length;c++)if(a[c].object.userData.tag=="__floor__"){b=a[c].object;break}return b},render:function(){function a(c,d){d>1E3/60&&(B<1?(x.position.copy(C.getPointAt(B)),B+=0.01):B=0,b._three._render(),d=0);window.requestAnimationFrame(function(b){return a(b,d+b-c)})}var b=this;b._three._removeInnerLayer(b);b._meshes=[];var c=new THREE.Group;c.name="main part";c.userData.attributes={OriginalData:b.data,Layer:b};var d=
new THREE.Group;d.name="extra part";d.userData.attributes={OriginalData:b.data,Layer:b};if(b.data.geometry){var e=turf.centroid(b.data).geometry.coordinates;if(b.isCirclesVisible){var f=new THREE.MeshBasicMaterial({color:7372944,transparent:!0,opacity:0.3});[0.01,0.015,0.02,0.025,0.03,0.035,0.04,0.045,0.05,0.055].forEach(function(a){var a=turf.circle(e,a,{steps:50,units:"kilometers",properties:{}}),d=new THREE.Geometry;a.geometry.coordinates[0].forEach(function(a){d.vertices.push(b._three._threebox.projectToWorld([a[0],
a[1],-1]))});a=new THREE.Line(d,f);c.add(a)})}var g=b.data.geometry.coordinates[0],h=0,j=JSON.parse(b.data.properties.levels);j.forEach(function(a){h+=a});for(var l=b._three._threebox.distaneToWorld(h),n={steps:10,units:"kilometers",properties:{}},o=[],r=[],t=[],m=[],p=[],s=[],q=0;q<g.length;q++){var u=[],v=b._three._threebox.projectToWorld(g[q]);r.push(v.clone());var w=v.clone();w.z=l;t.push(w.clone());u.push(v.clone());u.push(w.clone());m.push(u);p.push(v.clone());s.push(v.clone());u=turf.circle(g[q],
2.0E-4,n);o.push(u)}g=new THREE.MeshPhongMaterial({color:16777215,transparent:!0,opacity:1});new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.5});r=b._createLineGeometry(r);n=b._createLineGeometry(t);t=r.clone();r=new THREE.Line(r,g);r.name="linebase";n=new THREE.Line(n,g);n.name="lineUp";c.add(r);c.add(n);l={pillar:{amount:l,bevelEnabled:!1},floor:{amount:1.0E-12,bevelEnabled:!1}};o=b._createPillarMesh(o,l.pillar,g);o.name="pillar";c.add(o);o=new THREE.MeshPhongMaterial({color:6454209,
transparent:!0,opacity:0.5});p=b._createGeoExtrudeGeometry(p,l.floor);for(r=l=0;r<j.length;r++)g=b._three._threebox.distaneToWorld(l),m=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.1,specular:6454209,shininess:100}),n=new THREE.MeshPhongMaterial({color:6454209,transparent:!0,opacity:0.05,specular:16776960,shininess:100,side:THREE.DoubleSide}),q=p.clone(),q.translate(0,0,g),m=new THREE.Mesh(q,m),m.userData.attributes={OriginalData:b.data,Layer:b,level:r+1,tag:"__floor__"},m.userData.tag=
"__floor__",m.name="this is "+(r+1)+" floor",c.add(m),b.isFloorLinesVisible&&(m=t.clone(),m.translate(0,0,g),m=new THREE.Line(m,o),c.add(m)),m={amount:b._three._threebox.distaneToWorld(j[r]),bevelEnabled:!1},m=b._createSideGeometry(s,m),m.translate(0,0,g),g=new THREE.Mesh(m,n),g.userData.attributes={OriginalData:b.data,Layer:b,level:r+1,tag:"__wall__"},g.userData.tag="__wall__",g.name="this is "+(r+1)+" wall",c.add(g),l+=j[r];var j=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:1}),
s=new THREE.SphereBufferGeometry(0.001,32,16),x=new THREE.Mesh(s,j);x.position.copy(b._three._threebox.projectToWorld([e[0],e[1],0]));x.name="sphereTarget";x.scale.copy((new THREE.Vector3(1,1,1)).multiplyScalar(b._three._threebox.projectedUnitsPerMeterInScale(e[1])));d.add(x);j=new THREE.PointLight(16776960,200,0);j.matrixWorldNeedsUpdate=!0;x.add(j);b._three._threebox.addGeoreferencedMeshToWorld2(c);b._meshes.push(c);b._three._threebox.addGeoreferencedMesh(d);b._meshes.push(d);var d=b._three._threebox.projectToWorld([e[0],
e[1],h]),j=b._three._threebox.projectToWorld([e[0],e[1],0]),C=new THREE.LineCurve3(j,d),B=0;window.requestAnimationFrame(function(b){return a(b,0)})}}});
GeoGlobe.Visuals.Three.RainLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,options:{},getTexture:function(a){return a.texture?a.texture:""},getSize:function(a){return a.size?a.size:10},_three:null,_meshes:[],_textureCache:[],initialize:function(a){this.id=a.id?a.id:this.id;this.visible=a.visible!==void 0?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable!==void 0?a.pickable:this.pickable;this.getTexture=a.getTexture?a.getTexture:this.getTexture;
this.getSize=a.getSize?a.getSize:this.getSize;this.options=a?a:this.options},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},setVisible:function(a){this.visible=this.rain.visible=a},getVisible:function(){return this.visible},createRainSprites:function(a){var b=this,c=new THREE.Geometry;for(i=0;i<2E4;i++){var d=new THREE.Vector3;d.x=Math.random()*8E3-4E3;d.y=Math.random()*8E3-4E3;d.z=Math.random()*4E3;d.velocityZ=6;d.velocityX=(Math.random()-
0.5)/3;c.vertices.push(d)}c.verticesNeedUpdate=!0;var d=b.getSize(a),e=null;(a=b.getTexture(a))?((e=b._getTextureCacheByURL(a))?e=e.clone():(e=(new THREE.TextureLoader).load(a,function(){b._three._render()}),b._addTextureInToCache({key:a,value:e})),e=new THREE.PointsMaterial({size:d,map:e,blending:THREE.AdditiveBlending,depthTest:!1,transparent:!0,sizeAttenuation:!0})):console.error("\u672a\u8bbe\u7f6e\u7eb9\u7406\u56fe\u7247\u8d44\u6e90\u8def\u5f84\uff01");return new THREE.Points(c,e)},render:function(){var a=
this;a._three._removeInnerLayer(a);a._meshes=[];var b=a.options;a.rain=a.createRainSprites(b);a.rain.visible=a.visible;a.rain.name=a.id?a.id:"threelayer";a.rain.userData.attributes={OriginalData:b,Layer:a};b=a._three.map.getCenter();a._three._threebox.addAtCoordinate(a.rain,[b.lng,b.lat,0],{scaleToLatitude:!0,preScale:1});a._meshes.push(a.rain);a._three._render();(function d(){requestAnimationFrame(d);a.rain.geometry.vertices.forEach(function(a){a.z-=a.velocityZ;a.x-=a.velocityX*0.5;if(a.z<0)a.z=
4E3});a.rain.geometry.verticesNeedUpdate=!0;a._three._render()})();a._three.map.on("zoom",function(){if(a.getVisible())a.rain.visible=a._three.map.getZoom()<15?!1:!0});a._three.map.on("dragend",function(){if(a.rain.visible){var b=a._three.map.getCenter();a.rain.parent.position.copy(a._three._threebox.projectToWorld([b.lng,b.lat,0]))}})},_getTextureCacheByURL:function(a){if(a)for(var b=0;b<this._textureCache.length;b++)if(this._textureCache[b].key===a&&this._textureCache[b].value.image)return this._textureCache[b].value;
return null},_addTextureInToCache:function(a){for(var b=!1,c=0;c<this._textureCache.length;c++)if(this._textureCache[c].key===a.key){b=!0;break}b||this._textureCache.push(a)}});
GeoGlobe.Visuals.Three.SnowLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,options:{},getTexture:function(a){return a.texture?a.texture:""},getSize:function(a){return a.size?a.size:10},_three:null,_meshes:[],_textureCache:[],initialize:function(a){this.id=a.id?a.id:this.id;this.visible=a.visible!==void 0?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable!==void 0?a.pickable:this.pickable;this.getTexture=a.getTexture?a.getTexture:this.getTexture;
this.getSize=a.getSize?a.getSize:this.getSize;this.options=a?a:this.options},addTo:function(a){this._three=a;this._three.addLayer(this)},remove:function(){this._three.removeLayer(this.id)},setVisible:function(a){this.visible=this.snow.visible=a},getVisible:function(){return this.visible},createSnowSprites:function(a){var b=this,c=new THREE.Geometry;for(i=0;i<2E4;i++){var d=new THREE.Vector3;d.x=Math.random()*8E3-4E3;d.y=Math.random()*8E3-4E3;d.z=Math.random()*4E3;d.velocityZ=2;d.velocityX=(Math.random()-
0.5)/3;c.vertices.push(d)}c.verticesNeedUpdate=!0;var d=b.getSize(a),e=null;(a=b.getTexture(a))?((e=b._getTextureCacheByURL(a))?e=e.clone():(e=(new THREE.TextureLoader).load(a,function(){b._three._render()}),b._addTextureInToCache({key:a,value:e})),e=new THREE.PointsMaterial({size:d,map:e,blending:THREE.AdditiveBlending,depthTest:!1,transparent:!0,sizeAttenuation:!0})):console.error("\u672a\u8bbe\u7f6e\u7eb9\u7406\u56fe\u7247\u8d44\u6e90\u8def\u5f84\uff01");return new THREE.Points(c,e)},render:function(){var a=
this;a._three._removeInnerLayer(a);a._meshes=[];var b=a.options;a.snow=a.createSnowSprites(b);a.snow.visible=a.visible;a.snow.name=a.id?a.id:"threelayer";a.snow.userData.attributes={OriginalData:b,Layer:a};b=a._three.map.getCenter();a._three._threebox.addAtCoordinate(a.snow,[b.lng,b.lat,0],{scaleToLatitude:!0,preScale:1});a._meshes.push(a.snow);a._three._render();(function d(){requestAnimationFrame(d);a.snow.geometry.vertices.forEach(function(a){a.z-=a.velocityZ;a.x-=a.velocityX*0.5;if(a.z<0)a.z=
4E3});a.snow.geometry.verticesNeedUpdate=!0;a._three._render()})();a._three.map.on("zoom",function(){if(a.getVisible())a.snow.visible=a._three.map.getZoom()<15?!1:!0});a._three.map.on("dragend",function(){if(a.snow.visible){var b=a._three.map.getCenter();a.snow.parent.position.copy(a._three._threebox.projectToWorld([b.lng,b.lat,0]))}})},_getTextureCacheByURL:function(a){if(a)for(var b=0;b<this._textureCache.length;b++)if(this._textureCache[b].key===a&&this._textureCache[b].value.image)return this._textureCache[b].value;
return null},_addTextureInToCache:function(a){for(var b=!1,c=0;c<this._textureCache.length;c++)if(this._textureCache[c].key===a.key){b=!0;break}b||this._textureCache.push(a)}});
GeoGlobe.Visuals.Three.BrightkiteLayer=GeoGlobe.Class4OL({id:"1",visible:!0,pickable:!0,opacity:1,name:"\u5b9e\u65f6\u6570\u636e\u670d\u52a1",version:"1.0.0",format:"json",levelPrecision:[8,8,8],requestArgs:{},rendererOptions:{},options:{},service:"RTDS",tileSize:256,_three:null,_meshes:[],_textureCache:[],initialize:function(a){this.options=a?a:this.options;this.textureCoord=[new THREE.Vector2(1,0),new THREE.Vector2(0,0),new THREE.Vector2(0,1),new THREE.Vector2(1,1)];this.id=a.id?a.id:this.id;this.visible=
a.visible!==void 0?a.visible:this.visible;this.opacity=a.opacity?a.opacity:this.opacity;this.pickable=a.pickable!==void 0?a.pickable:this.pickable;this.name=a.name?a.name:this.name;this.service=a.service?a.service:this.service;this.tileSize=a.tileSize?a.tileSize:this.tileSize;this.version=a.version?a.version:this.version;this.format=a.format?a.format:this.format;this.levelPrecision=a.levelPrecision?a.levelPrecision:this.levelPrecision;this.requestArgs=a.requestArgs?a.requestArgs:this.requestArgs;
this.rendererOptions=a.rendererOptions?a.rendererOptions:this.rendererOptions;this.getService=a.getService?a.getService:this.getService;this.projMatrix=new Float64Array(16);this.alignedProjMatrix=new Float64Array(16);this.pixelMatrix=new Float64Array(16);this.pixelMatrixInverse=new Float64Array(16);this._initMat4();this._initCalculator();this.mat4=new this.mat4;this.calculator=new this.calculator;"OffscreenCanvas"in window&&this._initWorker()},_initWorker:function(){var a=this,b,c=new Blob(["\n// debugger\n'use strict';\n\nfunction transformMat4(out, a, m){\n    var x = a[0], y = a[1], z = a[2], w = a[3];\n    out[0] = m[0] * x + m[4] * y + m[8] * z + m[12] * w;\n    out[1] = m[1] * x + m[5] * y + m[9] * z + m[13] * w;\n    out[2] = m[2] * x + m[6] * y + m[10] * z + m[14] * w;\n    out[3] = m[3] * x + m[7] * y + m[11] * z + m[15] * w;\n    return out;\n}\n\nfunction zoomTo(column, row, zoom, tileZoom){\n    var scale = Math.pow(2, tileZoom - zoom);\n    column *= scale;\n    row *= scale;\n    zoom = tileZoom;\n    \n    return {\n       column: column,\n       row: row,\n       zoom: zoom,\n    };\n}\n\nfunction locationCoordinate(lnglat, transform){\n    var column = (180 + lnglat[0]) * transform.worldSize / 360 / transform.tileSize;\n    var row = (180 - (180 / Math.PI * Math.log(Math.tan(Math.PI / 4 + lnglat[1] * Math.PI / 360)))) * transform.worldSize / 360 / transform.tileSize;\n    var zoom = transform.zoom;\n    \n    return zoomTo(column, row, zoom, transform.tileZoom);\n}\n\nfunction coordinatePoint(coord, transform){\n    var zoomedCoord = zoomTo(coord.column, coord.row, coord.zoom, transform.zoom);\n    var p = [zoomedCoord.column * transform.tileSize, zoomedCoord.row * transform.tileSize, 0, 1];\n    transformMat4(p, p, transform.pixelMatrix);\n    return {\n        x: p[0] / p[3],\n        y: p[1] / p[3]\n    };\n}\n\nfunction locationPoint(lnglat, transform){\n    return coordinatePoint(locationCoordinate(lnglat, transform), transform);\n}\n\nfunction project(lnglat, transform){\n    return locationPoint(lnglat, transform);\n}\n\n/**\n * \u6839\u636e\u5355\u4e2a\u74e6\u7247URL\u8bf7\u6c42\u77e2\u91cf\u6570\u636e\uff0c\u5e76\u53d1\u8d77\u56de\u8c03\n * @param {Object} requestArgs \u5355\u4e2a\u74e6\u7247\u7684\u5b9e\u65f6\u6570\u636e\u7684\u8bf7\u6c42\u53c2\u6570\n * @param {Function} callback \u8bf7\u6c42\u5b8c\u6210\u540e\u56de\u8c03\u51fd\u6570\n */\nfunction getCanvas(requestArgs, callback) {\n\tvar formData = new FormData();\n    formData.append('SERVICE', 'RTDS');\n    formData.append('VERSION', '"+
...
2,3)],d=new THREE.Geometry;d.vertices=e;d.faces=f;d.computeFaceNormals();d.faceVertexUvs=[[]];d.faceVertexUvs[0][0]=[c[2],c[1],c[0]];d.faceVertexUvs[0][1]=[c[2],c[0],c[3]];b=new THREE.MeshBasicMaterial({map:b,side:THREE.DoubleSide,blending:THREE.AdditiveBlending,depthTest:!1,transparent:!0});return new THREE.Mesh(d,b)},getTileBBox:function(a,b,c){c=Math.pow(2,c);b=c-b-1;return[-2.00375083427892E7+4.00750166855784E7*a/c,-2.00375083427892E7+4.00750166855784E7*b/c,-2.00375083427892E7+4.00750166855784E7*
...
0;a[14]=0;a[15]=1;return a},identity:function(a){a[0]=1;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=1;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=1;a[11]=0;a[12]=0;a[13]=0;a[14]=0;a[15]=1;return a},translate:function(a,b,c){var d=c[0],e=c[1],c=c[2],f,g,h,j,l,n,o,r,t,m,p,s;b===a?(a[12]=b[0]*d+b[4]*e+b[8]*c+b[12],a[13]=b[1]*d+b[5]*e+b[9]*c+b[13],a[14]=b[2]*d+b[6]*e+b[10]*c+b[14],a[15]=b[3]*d+b[7]*e+b[11]*c+b[15]):(f=b[0],g=b[1],h=b[2],j=b[3],l=b[4],n=b[5],o=b[6],r=b[7],t=b[8],m=b[9],p=b[10],s=b[11],a[0]=f,a[1]=g,a[2]=h,
a[3]=j,a[4]=l,a[5]=n,a[6]=o,a[7]=r,a[8]=t,a[9]=m,a[10]=p,a[11]=s,a[12]=f*d+l*e+t*c+b[12],a[13]=g*d+n*e+m*c+b[13],a[14]=h*d+o*e+p*c+b[14],a[15]=j*d+r*e+s*c+b[15]);return a},scale:function(a,b,c){var d=c[0],e=c[1],c=c[2];a[0]=b[0]*d;a[1]=b[1]*d;a[2]=b[2]*d;a[3]=b[3]*d;a[4]=b[4]*e;a[5]=b[5]*e;a[6]=b[6]*e;a[7]=b[7]*e;a[8]=b[8]*c;a[9]=b[9]*c;a[10]=b[10]*c;a[11]=b[11]*c;a[12]=b[12];a[13]=b[13];a[14]=b[14];a[15]=b[15];return a},multiply:function(a,b,c){var d=b[0],e=b[1],f=b[2],g=b[3],h=b[4],j=b[5],l=b[6],
n=b[7],o=b[8],r=b[9],t=b[10],m=b[11],p=b[12],s=b[13],q=b[14],b=b[15],u=c[0],v=c[1],w=c[2],x=c[3];a[0]=u*d+v*h+w*o+x*p;a[1]=u*e+v*j+w*r+x*s;a[2]=u*f+v*l+w*t+x*q;a[3]=u*g+v*n+w*m+x*b;u=c[4];v=c[5];w=c[6];x=c[7];a[4]=u*d+v*h+w*o+x*p;a[5]=u*e+v*j+w*r+x*s;a[6]=u*f+v*l+w*t+x*q;a[7]=u*g+v*n+w*m+x*b;u=c[8];v=c[9];w=c[10];x=c[11];a[8]=u*d+v*h+w*o+x*p;a[9]=u*e+v*j+w*r+x*s;a[10]=u*f+v*l+w*t+x*q;a[11]=u*g+v*n+w*m+x*b;u=c[12];v=c[13];w=c[14];x=c[15];a[12]=u*d+v*h+w*o+x*p;a[13]=u*e+v*j+w*r+x*s;a[14]=u*f+v*l+w*
...
c+o*d;a[8]=j*c-e*d;a[9]=l*c-f*d;a[10]=n*c-g*d;a[11]=o*c-h*d;return a},rotateZ:function(a,b,c){var d=Math.sin(c),c=Math.cos(c),e=b[0],f=b[1],g=b[2],h=b[3],j=b[4],l=b[5],n=b[6],o=b[7];b!==a&&(a[8]=b[8],a[9]=b[9],a[10]=b[10],a[11]=b[11],a[12]=b[12],a[13]=b[13],a[14]=b[14],a[15]=b[15]);a[0]=e*c+j*d;a[1]=f*c+l*d;a[2]=g*c+n*d;a[3]=h*c+o*d;a[4]=j*c-e*d;a[5]=l*c-f*d;a[6]=n*c-g*d;a[7]=o*c-h*d;return a},invert:function(a,b){var c=b[0],d=b[1],e=b[2],f=b[3],g=b[4],h=b[5],j=b[6],l=b[7],n=b[8],o=b[9],r=b[10],t=
b[11],m=b[12],p=b[13],s=b[14],q=b[15],u=c*h-d*g,v=c*j-e*g,w=c*l-f*g,x=d*j-e*h,C=d*l-f*h,B=e*l-f*j,A=n*p-o*m,y=n*s-r*m,z=n*q-t*m,E=o*s-r*p,F=o*q-t*p,G=r*q-t*s,D=u*G-v*F+w*E+x*z-C*y+B*A;if(!D)return null;D=1/D;a[0]=(h*G-j*F+l*E)*D;a[1]=(e*F-d*G-f*E)*D;a[2]=(p*B-s*C+q*x)*D;a[3]=(r*C-o*B-t*x)*D;a[4]=(j*z-g*G-l*y)*D;a[5]=(c*G-e*z+f*y)*D;a[6]=(s*w-m*B-q*v)*D;a[7]=(n*B-r*w+t*v)*D;a[8]=(g*F-h*z+l*A)*D;a[9]=(d*z-c*F-f*A)*D;a[10]=(m*C-p*w+q*u)*D;a[11]=(o*w-n*C-t*u)*D;a[12]=(h*y-g*E-j*A)*D;a[13]=(c*E-d*y+e*
A)*D;a[14]=(p*v-m*x-s*u)*D;a[15]=(n*x-o*v+r*u)*D;return a},ortho:function(a,b,c,d,e,f,g){var h=1/(b-c),j=1/(d-e),l=1/(f-g);a[0]=-2*h;a[1]=0;a[2]=0;a[3]=0;a[4]=0;a[5]=-2*j;a[6]=0;a[7]=0;a[8]=0;a[9]=0;a[10]=2*l;a[11]=0;a[12]=(b+c)*h;a[13]=(e+d)*j;a[14]=(g+f)*l;a[15]=1;return a}}}});
GeoGlobe.Visuals.EchartsGL=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],visualMap:null,mapbox3D:{boxHeight:10,boxWidth:100,altitudeScale:1},_echartsgl:null,initialize:function(a){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);this.layers=[];window.echarts?(this.visualMap=a.visualMap?a.visualMap:this.visualMap,this.mapbox3D=a.mapbox3D?a.mapbox3D:this.mapbox3D,console.warn("EchartsGL 1.1 \u6682\u672a\u652f\u6301\u9f20\u6807\u62fe\u53d6\u4e8b\u4ef6\uff01")):console.error("\u4f7f\u7528EchartsGL\u53ef\u89c6\u5316\u56fe\u5c42\u524d\uff0c\u9700\u5f15\u5165echarts\u548cechartsgl\u5e93\uff01")},
...
this._init()}this.option={};this.visualMap&&(this.option.visualMap=this.visualMap);this.option.mapbox3D=this.mapbox3D;this.option.series=[];this.option.units=this.map.units;this.option.topTileExtent=this.map._tileExtent;if(this._order)for(var c=0;c<this._order.length;c++)for(var d=0;d<this.layers.length;d++)this.layers[d].id==this._order[c]&&this.option.series.push(this.layers[d].getRenderOption());else for(d=0;d<this.layers.length;d++)this.option.series.push(this.layers[d].getRenderOption());this._echartsgl.setOption(this.option)},
clear:function(){this._echartsgl.clear()},addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==this.layers[c].id&&b.push(this.layers[c]);this.layers=b},moveLayer:function(a,b){if(this.getLayer(a)){this._order=this.layers.map(function(a){return a.id});this._order.splice(this._order.indexOf(a),1);var c=b?this._order.indexOf(b):this._order.length;
b&&c===-1?this.fire("error",{error:Error('Layer with id "'+b+'" does not exist on this map.')}):this._order.splice(c,0,a)}else this.fire("error",{error:Error("The layer '"+a+"' does not exist in the map's style and cannot be moved.")})},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]},_bindEvent:function(){var a=this;this.map.on("click",function(b){a._onClick(b)});this.map.on("mousemove",function(b){a._onMouseMove(b)});this.map.on("resize",
function(){a._echartsgl.resize()})},_unbindEvent:function(){for(var a=0;a<this.map._listeners.click.length;a++)this.map._listeners.click[a].name&&this.map._listeners.click[a].name==="ECHARTSGL_CLICK_EVENT"&&this.map._listeners.click.splice(a,1);for(a=0;a<this.map._listeners.mousemove.length;a++)this.map._listeners.mousemove[a].name&&this.map._listeners.mousemove[a].name==="ECHARTSGL_MOUSEMOVE_EVENT"&&this.map._listeners.mousemove.splice(a,1);for(a=0;a<this.map._listeners.resize.length;a++)this.map._listeners.resize[a].name&&
this.map._listeners.resize[a].name==="ECHARTSGL_RESIZE_EVENT"&&this.map._listeners.resize.splice(a,1)},_onMouseMove:function(a){this.fire("overlayerhover",{param:{info:null,pickedInfos:[],event:a}})},_onClick:function(a){this.fire("overlayerclick",{param:{info:null,pickedInfos:[],event:a}})}});
...
GeoGlobe.Visuals.Custom=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],_order:[],initialize:function(){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);this.layers=[];this._order=[]},addTo:function(){GeoGlobe.Visuals.prototype.addTo.apply(this,arguments);this.container.className="geoglobe-custom-container";this._bindEvent()},render:function(){for(var a=0;a<this.layers.length;a++)this.layers[a].render()},addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):
console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},moveLayer:function(a,b){if(this.getLayer(a)){this._order=this.layers.map(function(a){return a.id});this._order.splice(this._order.indexOf(a),1);var c=b?this._order.indexOf(b):this._order.length;if(b&&c===-1)this.fire("error",{error:Error('Layer with id "'+b+'" does not exist on this map.')});else{this._order.splice(c,0,a);for(c=0;c<this._order.length;c++)for(var d=0;d<this.layers.length;d++)if(this._order[c]===this.layers[d].id)this.layers[d].div.style.zIndex=
c}}else this.fire("error",{error:Error("The layer '"+a+"' does not exist in the map's style and cannot be moved.")})},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a===this.layers[c].id?this.layers[c].destroy&&this.layers[c].destroy():b.push(this.layers[c]);this.layers=b},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]},getBounds:function(a){var b=this.map.unproject([-a,-a]),c=this.map.unproject([this.map.transform.width+
a,-a]),d=this.map.unproject([-a,this.map.transform.height+a]),a=this.map.unproject([this.map.transform.width+a,this.map.transform.height+a]);return[[Math.min(b.lng,c.lng,d.lng,a.lng),Math.min(b.lat,c.lat,d.lat,a.lat)],[Math.max(b.lng,c.lng,d.lng,a.lng),Math.max(b.lat,c.lat,d.lat,a.lat)]]},_bindEvent:function(){var a=this;this.map.on("dragstart",function(){if(this.getPitch()===0)a.lastCenter=this.getCenter()});this.map.on("zoomstart",function(){a.layers.forEach(function(a){a.onZoomStart&&a.onZoomStart()})});
this.map.on("move",function(){a.lastCenter&&(a.lastCenterPixel=this.project(a.lastCenter));a.layers.forEach(function(a){a.onMove&&a.onMove()})});this.map.on("zoomend",function(){a.layers.forEach(function(a){a.onZoomEnd&&a.onZoomEnd()})});this.map.on("moveend",function(){a.lastCenter=void 0;a.layers.forEach(function(a){a.onMoveEnd&&a.onMoveEnd()})});this.map.on("click",function(b){a._onClick(b)});this.map.on("mousemove",function(b){a._onMouseMove(b)});this.map.on("resize",function(){a._onResize()})},
_unbindEvent:function(){for(var a=0;a<this.map._listeners.dragstart.length;a++)this.map._listeners.dragstart[a].name&&this.map._listeners.dragstart[a].name==="CUSTOM_DRAGSTART_EVENT"&&this.map._listeners.dragstart.splice(a,1);for(a=0;a<this.map._listeners.zoomstart.length;a++)this.map._listeners.zoomstart[a].name&&this.map._listeners.zoomstart[a].name==="CUSTOM_ZOOMSTART_EVENT"&&this.map._listeners.zoomstart.splice(a,1);for(a=0;a<this.map._listeners.move.length;a++)this.map._listeners.move[a].name&&
this.map._listeners.move[a].name==="CUSTOM_MOVE_EVENT"&&this.map._listeners.move.splice(a,1);for(a=0;a<this.map._listeners.zoomend.length;a++)this.map._listeners.zoomend[a].name&&this.map._listeners.zoomend[a].name==="CUSTOM_ZOOMEND_EVENT"&&this.map._listeners.zoomend.splice(a,1);for(a=0;a<this.map._listeners.moveend.length;a++)this.map._listeners.moveend[a].name&&this.map._listeners.moveend[a].name==="CUSTOM_MOVEEND_EVENT"&&this.map._listeners.moveend.splice(a,1);for(a=0;a<this.map._listeners.click.length;a++)this.map._listeners.click[a].name&&
this.map._listeners.click[a].name==="CUSTOM_CLICK_EVENT"&&this.map._listeners.click.splice(a,1);for(a=0;a<this.map._listeners.mousemove.length;a++)this.map._listeners.mousemove[a].name&&this.map._listeners.mousemove[a].name==="CUSTOM_MOUSEMOVE_EVENT"&&this.map._listeners.mousemove.splice(a,1);for(a=0;a<this.map._listeners.resize.length;a++)this.map._listeners.resize[a].name&&this.map._listeners.resize[a].name==="CUSTOM_RESIZE_EVENT"&&this.map._listeners.resize.splice(a,1)},_onClick:function(a){for(var b=
0;b<this.layers.length;b++)this.layers[b].onClick&&this.layers[b].onClick(a)},_onMouseMove:function(a){for(var b=0;b<this.layers.length;b++)this.layers[b].onMouseMove&&this.layers[b].onMouseMove(a)},_onResize:function(){for(var a=0;a<this.layers.length;a++)this.layers[a].onResize&&this.layers[a].onResize()}});
GeoGlobe.Visuals.Custom.Bubble=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPoint:null,markPoints:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._initContainer();this._initCanvas()},_initContainer:function(){this.div=document.createElement("div");this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute")},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},
{markPoint:{hoverable:!0,clickable:!0,symbol:"bubble",symbolMinSize:20,symbolMaxSize:40,symbolNumber:Number.MAX_VALUE,symbolValueRangeScale:1,symbolSrc:"",effect:{show:!0,scaleSize:2,period:10},itemStyle:{color:"rgba(255,0,0,0.7)",shadowColor:"#000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0},label:{show:!0,color:"#fff",align:"center",baseline:"middle",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},tooltip:{show:!0,backgroundColor:"#fff",borderColor:"#333",borderRadius:0,
borderWidth:0,padding:10,textStyle:{color:"#000",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkPoint:function(){var a=this,b=this._rendererOptions.markPoint,c=b.effect,d=b.itemStyle,e=b.label;this.MarkPoint=function(c,e,h,j,l,n,o){this.index=c;this.name=e;this.value=h;this.lon=j;this.lat=l;this.time=n;this.attributes=o;this.init();this.weight=(this.value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(this.weight))this.weight=1;if(this.weight>
1)this.weight=1;if(this.weight<0)this.weight=0;this.size=b.symbolMinSize+(b.symbolMaxSize-b.symbolMinSize)*this.weight;this.radius=this.size/2;this.color=GeoGlobe.Util.getType(d.color)==="object"?"rgba("+a.gradientImageData[~~(this.weight*255+0.5)*4]+","+a.gradientImageData[~~(this.weight*255+0.5)*4+1]+","+a.gradientImageData[~~(this.weight*255+0.5)*4+2]+","+a.gradientImageData[3]/255+")":d.color;this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);this.tmpColor=this.color;this.alpha=this.color.indexOf("a(")!==
-1?+this.color.split(",")[3].split(")")[0]:1;if(b.valueFilter)for(c=0;c<b.valueFilter.length;c++)if(this.value===b.valueFilter[c])this.tmpColor=this.rgbColor=a._rendererOptions.markPoint.filterColor[c],this.size=a._rendererOptions.markPoint.filterSize[c],this.increment=a._rendererOptions.markPoint.filterIncrement[c];if(b.threshold)for(c=0;c<b.threshold.length;c++)if(b.threshold[c+1]&&b.threshold[c]<this.value&&this.value<b.threshold[c+1])this.tmpColor=this.rgbColor=a._rendererOptions.markPoint.thresholdColor[c],
this.size=a._rendererOptions.markPoint.thresholdSize[c],this.increment=a._rendererOptions.markPoint.thresholdIncrement[c];switch(b.symbol){case "fire":this.fires=[];for(c=0;c<150;c++)this.fires.push(new a.Fire(this.size));break;case "water":this.waveLength=0.1;this.waveSize=this.size*0.8;this.attenuations=[3,2];this.noises=[0.6*(this.waveSize/2-4),0.3*(this.waveSize/2-4)];this.Fs=[10,10];break;case "heatmap":this.scale=this.size/b.symbolMaxSize;break;case "sprite":this.scale=this.size/b.symbolMaxSize;
this.factor=1;break;case "simple":this.factor=1}};this.MarkPoint.prototype.init=function(){switch(b.symbol){case "simple":case "bubble":case "ellipse":this.energy=c.show?Math.random()*c.scaleSize:c.scaleSize;this.increment=Math.max(0.1*c.scaleSize/c.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001);break;case "circle":this.energy=[0,1/3,2/3];this.increment=Math.max(0.1*c.scaleSize/c.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001);break;case "ring":this.energy=[0,0.25*c.scaleSize,
0.5*c.scaleSize,0.75*c.scaleSize];this.increment=Math.max(0.1*c.scaleSize/c.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001);break;case "water":this.energy=0;this.increment=0.1+Math.random()*(Math.random()>0.5?1:-1)*0.02;break;case "sprite":this.energy=c.show?Math.random()*c.scaleSize:c.scaleSize,this.increment=Math.max(0.1*c.scaleSize/c.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001)}};this.MarkPoint.prototype.updateXY=function(){var c=a._parent.map.project([this.lon,this.lat]);
this.x=c.x;this.y=c.y;if(b.symbol==="fire")for(c=0;c<this.fires.length;c++)this.fires[c].x=this.x,this.fires[c].y=this.y;this.visible=!0};this.MarkPoint.prototype.update=function(){var d;switch(b.symbol){case "simple":if(this.energy<=1)this.factor=1;else if(this.energy>=c.scaleSize)this.factor=-1;this.energy+=this.factor*this.increment;break;case "bubble":case "ellipse":this.energy+=this.increment;if(this.energy>c.scaleSize)this.energy=0;break;case "circle":for(d=0;d<3;d++)this.energy[d]+=this.increment,
this.energy[d]>1&&(this.energy[d]=0);break;case "ring":for(d=0;d<4;d++)this.energy[d]+=this.increment,this.energy[d]>c.scaleSize&&(this.energy[d]=0);break;case "fire":var e;for(d=0;d<this.fires.length;d++)e=this.fires[d],e.x+=e.speedX,e.y+=e.speedY,e.opacity-=e.increment,e.radius++,e.opacity<0&&(this.fires[d]=new a.Fire(this.size,this.x,this.y));break;case "water":this.energy=(this.energy+this.increment)%(Math.PI*64);break;case "sprite":if(this.energy<=0.15)this.factor=1;else if(this.energy>=c.scaleSize)this.factor=
-1;this.energy+=this.factor*this.increment}};this.MarkPoint.prototype.isPointInPath=function(c,d,h){c.beginPath();switch(b.symbol){case "simple":case "bubble":case "circle":case "ring":case "round":case "water":case "ellipse":case "heatmap":case "sprite":c.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);break;case "pin":c.moveTo(this.x-0.5,this.y);c.quadraticCurveTo(this.x,this.y-this.radius/2,this.x-this.radius*Math.sin(Math.PI/3),this.y-this.radius-this.radius*Math.sin(Math.PI/6));c.arc(this.x,this.y-
this.radius*2,this.radius,0,Math.PI*5/6,!0);c.arc(this.x,this.y-this.radius*2,this.radius,0,Math.PI/6,!1);c.quadraticCurveTo(this.x,this.y-this.radius/2,this.x+0.5,this.y);break;case "rmb":c.font=e.fontStyle+" "+e.fontWeight+" "+this.size+"px "+e.fontFamily;if(GeoGlobe.String.isNumeric(this.value)){var j=0,l=this.size;if(b.formatter)for(var n=GeoGlobe.Util.getFormattedString({a:this.name,b:"\u7edf\u8ba1\u6570",c:this.value},b.formatter).split("<br/>"),o=n.length,r=0;r<o;r++){var t=c.measureText(n[r]).width;
t>j&&(j=t);c.fillText(n[r],this.x,this.y-((o-1)/2-r)*(this.radius*2+5))}else j=c.measureText("\uffe5"+this.value).width;c.rect(this.x-j/2,this.y-l/2,j,l)}break;case "fire":c.rect(this.x-this.size/2,this.y-this.size/2,this.size,this.size)}if(c.isPointInPath(d,h))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw1=function(f){a.hoveredMarkPoint===this?(this.radius=this.size/2*1.1,this.color=GeoGlobe.Util.getShadeColor(this.tmpColor,20)):(this.radius=this.size/2,this.color=this.tmpColor);this.rgbColor=
GeoGlobe.Util.getRgbColor(this.color);f.shadowColor=d.shadowColor;f.shadowBlur=d.shadowBlur;f.shadowOffsetX=d.shadowOffsetX;f.shadowOffsetY=d.shadowOffsetY;switch(b.symbol){case "bubble":if(a.hoveredMarkPoint===this)f.beginPath(),f.arc(this.x,this.y,this.radius*c.scaleSize/2,0,Math.PI*2,!0),f.lineWidth=~~(this.radius/5+0.5)<2?2:~~(this.radius/5+0.5),f.strokeStyle=this.color,f.stroke();break;case "circle":case "round":f.beginPath();f.arc(this.x,this.y,this.radius,0,Math.PI*2,!0);f.fillStyle=this.color;
f.fill();break;case "pin":f.beginPath();f.moveTo(this.x+this.radius/3,this.y);f.quadraticCurveTo(this.x+this.radius/3,this.y+this.radius/10,this.x,this.y+this.radius/10);f.quadraticCurveTo(this.x-this.radius/3,this.y+this.radius/10,this.x-this.radius/3,this.y);f.quadraticCurveTo(this.x-this.radius/3,this.y-this.radius/10,this.x,this.y-this.radius/10);f.quadraticCurveTo(this.x+this.radius/3,this.y-this.radius/10,this.x+this.radius/3,this.y);f.fillStyle="rgba(0,0,0,0.3)";f.fill();f.beginPath();f.moveTo(this.x+
this.radius*2/3,this.y);f.quadraticCurveTo(this.x+this.radius*2/3,this.y+this.radius/6,this.x,this.y+this.radius/6);f.quadraticCurveTo(this.x-this.radius*2/3,this.y+this.radius/6,this.x-this.radius*2/3,this.y);f.quadraticCurveTo(this.x-this.radius*2/3,this.y-this.radius/6,this.x,this.y-this.radius/6);f.quadraticCurveTo(this.x+this.radius*2/3,this.y-this.radius/6,this.x+this.radius*2/3,this.y);f.fillStyle="rgba(0,0,0,0.2)";f.fill();f.beginPath();f.moveTo(this.x-0.5,this.y);f.quadraticCurveTo(this.x,
this.y-this.radius/2,this.x-this.radius*Math.sin(Math.PI/3),this.y-this.radius-this.radius*Math.sin(Math.PI/6));f.arc(this.x,this.y-this.radius*2,this.radius,0,Math.PI*5/6,!0);f.arc(this.x,this.y-this.radius*2,this.radius,0,Math.PI/6,!1);f.quadraticCurveTo(this.x,this.y-this.radius/2,this.x+0.5,this.y);f.fillStyle=this.color;f.fill();break;case "rmb":f.font=e.fontStyle+" "+e.fontWeight+" "+this.radius*2+"px "+e.fontFamily;f.textAlign="center";f.textBaseline="middle";f.fillStyle=this.color;if(GeoGlobe.String.isNumeric(this.value))if(b.formatter)for(var g=
GeoGlobe.Util.getFormattedString({a:this.name,b:"\u7edf\u8ba1\u6570",c:this.value},b.formatter).split("<br/>"),h=g.length,j=0;j<h;j++)f.fillText(g[j],this.x,this.y-((h-1)/2-j)*(this.radius*2+5));else f.fillText("\uffe5"+this.value,this.x,this.y);break;case "water":g=f.createRadialGradient(this.x,this.y,0,this.x,this.y,this.radius);g.addColorStop(0.8,"rgba(255,255,255,0)");g.addColorStop(1,"rgba(255,255,255,1)");f.beginPath();f.arc(this.x,this.y,this.radius,0,Math.PI*2,!1);f.fillStyle=g;f.fill();break;
case "heatmap":f.save();f.translate(this.x,this.y);f.scale(this.scale,this.scale);f.drawImage(a.markPointCacheCanvas,-a.markPointCacheCanvasSize/2,-a.markPointCacheCanvasSize/2);f.restore();break;case "icon":f.save(),f.translate(this.x,this.y),f.rotate(Math.PI/180*(this.attributes.azimuth-a._parent.map.getBearing())),f.drawImage(a.markPointCacheImage,-this.size/2,-this.size/2,this.size,this.size),f.restore()}switch(b.symbol){case "bubble":case "circle":case "round":case "water":case "ellipse":if(e.show)f.font=
e.fontStyle+" "+e.fontWeight+" "+e.fontSize+"px "+e.fontFamily,f.textAlign=e.align,f.textBaseline=e.baseline,f.fillStyle=e.color,f.fillText(this.value,this.x,this.y);break;case "pin":if(e.show)f.beginPath(),f.arc(this.x,this.y-this.radius*2,this.radius/3,0,Math.PI*2,!0),f.shadowBlur=0,f.shadowOffsetX=0,f.shadowOffsetY=0,f.fillStyle=e.color,f.fill()}};this.MarkPoint.prototype.draw2=function(d){var g;switch(b.symbol){case "simple":d.beginPath();d.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*
2,!0);d.fillStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+this.alpha+")";d.fill();break;case "bubble":d.beginPath();d.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*2,!0);d.strokeStyle=this.color;d.stroke();break;case "circle":for(g=0;g<3;)d.beginPath(),d.arc(this.x,this.y,this.radius+this.radius*(c.scaleSize-1)*this.energy[g],0,Math.PI*2,!0),d.strokeStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+(1-this.energy[g])*this.alpha+")",d.stroke(),g++;break;case "ring":for(g=0;g<4;)d.beginPath(),
d.arc(this.x,this.y,this.radius*this.energy[g],0,Math.PI*2,!0),d.fillStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+Math.max(1-this.energy[g]/c.scaleSize,0)*this.alpha+")",d.fill(),g++;if(e.show)d.font=e.fontStyle+" "+e.fontWeight+" "+e.fontSize+"px "+e.fontFamily,d.textAlign=e.align,d.textBaseline=e.baseline,d.fillStyle=e.color?e.color:this.color,d.fillText(this.value,this.x,this.y);break;case "fire":var h,j;for(g=0;g<this.fires.length;g++)h=this.fires[g],j=d.createRadialGradient(h.x,h.y,
0,h.x,h.y,h.radius),j.addColorStop(0,"rgba"+this.rgbColor.slice(3).split(")")[0]+","+h.opacity+")"),j.addColorStop(0.5,"rgba"+this.rgbColor.slice(3).split(")")[0]+","+h.opacity+")"),j.addColorStop(1,"rgba"+this.rgbColor.slice(3).split(")")[0]+", 0)"),d.beginPath(),d.arc(h.x,h.y,h.radius,0,Math.PI*2,!1),d.fillStyle=j,d.globalAlpha=this.alpha,d.fill();break;case "water":h=this.x-this.radius*0.8;j=this.y;var l,n;d.beginPath();d.moveTo(h,j);for(g=-this.waveLength;g<=this.waveLength;g+=0.01)g=parseFloat(parseFloat(g).toFixed(2)),
l=h+this.waveSize*((g+this.waveLength)/(this.waveLength*2)),n=j+this.noises[0]*Math.pow(Math.sin(g*10*this.attenuations[0]),1)*Math.sin(this.Fs[0]*g-this.energy),d.lineTo(l,n);d.arc(this.x,this.y,this.radius*0.8,0,Math.PI,!1);d.fillStyle=GeoGlobe.Util.getShadeColor(this.color,-10);d.globalAlpha=this.alpha;d.fill();d.beginPath();d.moveTo(h,j);for(g=-this.waveLength;g<=this.waveLength;g+=0.01)g=parseFloat(parseFloat(g).toFixed(2)),l=h+this.waveSize*((g+this.waveLength)/(this.waveLength*2)),n=j+this.noises[1]*
Math.pow(Math.sin(g*10*this.attenuations[1]),1)*Math.sin(this.Fs[1]*g-this.energy),d.lineTo(l,n);d.arc(this.x,this.y,this.radius*0.8,0,Math.PI,!1);d.fillStyle=this.color;d.globalAlpha=1;d.fill();break;case "ellipse":j=d.createRadialGradient(this.x,this.y,this.radius*this.energy,this.x,this.y,0);j.addColorStop(0.7,"rgba"+this.rgbColor.slice(3).split(")")[0]+", 0.5)");j.addColorStop(0.3,"rgba"+this.rgbColor.slice(3).split(")")[0]+", 1)");j.addColorStop(0.2,"rgba"+this.rgbColor.slice(3).split(")")[0]+
", 1)");j.addColorStop(0,"rgba"+this.rgbColor.slice(3).split(")")[0]+", 0)");d.beginPath();d.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*2,!1);d.fillStyle=j;d.globalAlpha=(1-this.energy/c.scaleSize)*this.alpha;d.fill();break;case "sprite":d.save(),d.translate(this.x,this.y),d.scale(this.scale*this.energy,this.scale*this.energy),d.drawImage(a.markPointCacheCanvas,-a.markPointCacheCanvasSize/2,-a.markPointCacheCanvasSize/2),d.restore()}c.show&&this.update()}},_initMarkPointExtra:function(){var a=
this;if(GeoGlobe.Util.getType(this._rendererOptions.markPoint.itemStyle.color)==="object")this.gradientImageData=GeoGlobe.Util.getGradientImageData(this._rendererOptions.markPoint.itemStyle.color);switch(this._rendererOptions.markPoint.symbol){case "fire":if(!this.Fire)this.Fire=function(a,b,c){this.x=b;this.y=c;this.speedX=-1+Math.random()*2;this.speedY=-5+Math.random()*5;this.radius=0.5+Math.random();this.increment=(1+Math.random())/a;this.opacity=1};break;case "heatmap":this.markPointCacheCanvasSize=
this._rendererOptions.markPoint.symbolMaxSize;this.markPointCacheCanvas=document.createElement("canvas");this.markPointCacheCanvas.width=this.markPointCacheCanvasSize;this.markPointCacheCanvas.height=this.markPointCacheCanvasSize;this.markPointCacheCanvasContext=this.markPointCacheCanvas.getContext("2d");var b=this._rendererOptions.markPoint.symbolMaxSize/2,c=this.markPointCacheCanvasContext.createRadialGradient(b,b,0,b,b,b);c.addColorStop(0.25,"rgba(0,0,0,0.25)");c.addColorStop(1,"rgba(0,0,0,0)");
this.markPointCacheCanvasContext.beginPath();this.markPointCacheCanvasContext.arc(b,b,b,0,2*Math.PI,!1);this.markPointCacheCanvasContext.fillStyle=c;this.markPointCacheCanvasContext.fill();if(!this.makeItHot)this.makeItHot=function(a,b,c,g,h){for(var g=a.getImageData(b,c,g,h),h=g.data,j=this.gradientImageData,l=h.length/4,n,o,r;l--;)n=l*4+3,o=h[n],r=o*4,o&&(h[n-3]=j[r],h[n-2]=j[r+1],h[n-1]=j[r+2]);a.putImageData(g,b,c)};break;case "icon":this.markPointCacheImage=new Image;this.markPointCacheImage.src=
this._rendererOptions.markPoint.symbolSrc;this.markPointCacheImage.onload=function(){a.drawCanvas1()};break;case "sprite":this.markPointCacheCanvasSize=this._rendererOptions.markPoint.symbolMaxSize,this.markPointCacheCanvas=document.createElement("canvas"),this.markPointCacheCanvas.width=this.markPointCacheCanvasSize,this.markPointCacheCanvas.height=this.markPointCacheCanvasSize,this.markPointCacheCanvasContext=this.markPointCacheCanvas.getContext("2d"),b=GeoGlobe.Util.getRgbColor(this._rendererOptions.markPoint.itemStyle.color),
c=this.markPointCacheCanvasContext.createRadialGradient(this.markPointCacheCanvasSize/2,this.markPointCacheCanvasSize/2,0,this.markPointCacheCanvasSize/2,this.markPointCacheCanvasSize/2,this.markPointCacheCanvasSize/2),c.addColorStop(0.15,this._rendererOptions.markPoint.itemStyle.color),c.addColorStop(0.5,"rgba"+b.slice(3).split(")")[0]+",0.15)"),c.addColorStop(1,"rgba"+b.slice(3).split(")")[0]+",0)"),this.markPointCacheCanvasContext.fillStyle=c,this.markPointCacheCanvasContext.fillRect(0,0,this.markPointCacheCanvasSize,
this.markPointCacheCanvasSize)}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.canvasContext.push(this.canvas[1].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));
this.cacheCanvasContext.push(this.cacheCanvas[1].getContext("2d"));this.canvas[0].style.position="absolute";this.canvas[1].style.position="absolute";this.div.appendChild(this.canvas[0]);this.div.appendChild(this.canvas[1]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markPoint.hoverable||this._rendererOptions.markPoint.clickable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this.div.appendChild(document.createElement("div")),this.tooltipDiv.style.position=
...
document.createElement("canvas").getContext?this._rendererOptions.tooltip.backgroundColor:GeoGlobe.Util.getRgbColor(this._rendererOptions.tooltip.backgroundColor),this.tooltipDiv.style["border-width"]=this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",this.tooltipDiv.style["white-space"]="pre-wrap",
this.tooltipDiv.style["box-shadow"]="rgba(0, 0, 0, 0.2) 0px 10px 10px",this.tooltipDiv.style.transition="left 0.4s cubic-bezier(0.23, 1, 0.32, 1), top 0.4s cubic-bezier(0.23, 1, 0.32, 1)"},render:function(){this._init_RendererOptions();this._initTooltip();this._initMarkPoint();this._initMarkPointExtra();this.setData(this.data);this.draw()},draw:function(){this.updateXY();this.drawCanvas1();this.animation=!0;this.frame&&cancelAnimationFrame(this.frame);if(this._rendererOptions.markPoint.symbol==="simple"||
this._rendererOptions.markPoint.symbol==="bubble"||this._rendererOptions.markPoint.symbol==="circle"||this._rendererOptions.markPoint.symbol==="ring"||this._rendererOptions.markPoint.symbol==="fire"||this._rendererOptions.markPoint.symbol==="water"||this._rendererOptions.markPoint.symbol==="ellipse"||this._rendererOptions.markPoint.symbol==="sprite"){var a=this;(function c(){if(a._rendererOptions.markPoint.effect.show)a.frame=requestAnimationFrame(c);(!a.moving||a.dragdrawing&&a.animation)&&a.drawCanvas2();
a.animation=!0})()}},onMove:function(){this.moving=!0;this.dragdrawing?(this.animation=!1,this.updateXY(),this.drawCanvas1(),this.drawCanvas2()):this._parent.lastCenter?this.moveCanvas():this.clearCanvas()},onMoveEnd:function(){this.moving=!1;this.redraw()},onClick:function(a){this._rendererOptions.markPoint.clickable&&this.hoveredMarkPoint&&this._parent.fire("overlayerclick",{layer:this,feature:this.hoveredMarkPoint,event:a})},onMouseMove:function(a){this._rendererOptions.markPoint.hoverable&&this.visibility&&
this.markPoints.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a}))},onResize:function(){this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height;this.redraw()},
redraw:function(){this.clearCanvas();this.resetCanvas();this.updateXY();this.drawCanvas1();this.drawCanvas2()},updateXY:function(){for(var a=this.markPoints.length<this._rendererOptions.markPoint.symbolNumber?this.markPoints.length:this._rendererOptions.markPoint.symbolNumber;a--;)this.markPoints[a].updateXY()},drawCanvas1:function(){this.cacheCanvas[0].width=this.width;if(this._rendererOptions.markPoint.symbol==="round")this.cacheCanvasContext[0].globalCompositeOperation="lighter";for(var a=this.markPoints.length<
this._rendererOptions.markPoint.symbolNumber?this.markPoints.length:this._rendererOptions.markPoint.symbolNumber;a--;)this.markPoints[a].visible&&this.markPoints[a].draw1(this.cacheCanvasContext[0]);this._rendererOptions.markPoint.symbol==="heatmap"&&this.makeItHot(this.cacheCanvasContext[0],0,0,this.width,this.height);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawCanvas2:function(){this._rendererOptions.markPoint.symbol==="bubble"?document.createElement("canvas").getContext?
(this.cacheCanvasContext[1].globalCompositeOperation="destination-out",this.cacheCanvasContext[1].fillStyle="rgba(0, 0, 0, 0.1)",this.cacheCanvasContext[1].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[1].globalCompositeOperation="source-over"):this.cacheCanvas[1].width=this.width:this._rendererOptions.markPoint.symbol==="ring"||this._rendererOptions.markPoint.symbol==="fire"||this._rendererOptions.markPoint.symbol==="sprite"?(this.cacheCanvas[1].width=this.width,this.cacheCanvasContext[1].globalCompositeOperation=
"lighter"):this.cacheCanvas[1].width=this.width;this.cacheCanvasContext[1].save();for(var a=this.markPoints.length<this._rendererOptions.markPoint.symbolNumber?this.markPoints.length:this._rendererOptions.markPoint.symbolNumber;a--;)this.markPoints[a].visible&&this.markPoints[a].draw2(this.cacheCanvasContext[1]);this.canvas[1].width=this.width;this.canvasContext[1].drawImage(this.cacheCanvas[1],0,0)},resetCanvas:function(){this.canvas[0].style.left=this.canvas[1].style.left=this.canvas[0].style.top=
this.canvas[1].style.top=""},clearCanvas:function(){this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width},moveCanvas:function(){this.canvas[0].style.left=this.canvas[1].style.left=this._parent.lastCenterPixel.x-this.width/2+"px";this.canvas[0].style.top=this.canvas[1].style.top=this._parent.lastCenterPixel.y-this.height/2+"px"},destroy:function(){cancelAnimationFrame(this.frame);this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=
[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.hoveredMarkPoint=null;for(var c=0,d=this.markPoints.length<this._rendererOptions.markPoint.symbolNumber?this.markPoints.length:this._rendererOptions.markPoint.symbolNumber;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.drawCanvas1();!this._rendererOptions.markPoint.effect.show&&this.drawCanvas2();
this.hoveredMarkPoint?(this.canvas[1].style.cursor="pointer",this.showTooltip(this.hoveredMarkPoint.name,a,b)):(this.canvas[1].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=
a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=this.canvas[1].style.display=a?"block":"none"},setData:function(a){this.data=
GeoGlobe.Util.deepExtend([],a);this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<this.data.length;b++){this.data[b].properties.name=this._rendererOptions.markPoint.nameField?a[b].properties[this._rendererOptions.markPoint.nameField]:this.data[b].properties.name;this.data[b].properties.value=this._rendererOptions.markPoint.valueField?a[b].properties[this._rendererOptions.markPoint.valueField]:this.data[b].properties.value;if(this.data[b].properties.value<this.minValue)this.minValue=
this.data[b].properties.value;if(this.data[b].properties.value>this.maxValue)this.maxValue=this.data[b].properties.value}this.maxValue/=this._rendererOptions.markPoint.symbolValueRangeScale;a=[];for(b=0;b<this.data.length;b++)a.push(new this.MarkPoint(b,this.data[b].properties.name,this.data[b].properties.value,this.data[b].geometry.coordinates[0],this.data[b].geometry.coordinates[1],this.data[b].properties.time,this.data[b].properties));this.hoveredMarkPoint=null;this.markPoints=a}});
GeoGlobe.Visuals.Custom.Migration=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPoint:null,MarkLine:null,markPoints:[],markLines:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._initContainer();this._initCanvas()},_initContainer:function(){this.div=document.createElement("div");this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute")},_init_RendererOptions:function(){this._rendererOptions=
GeoGlobe.Util.deepExtend({},{markLine:{hoverable:!0,curveness:0.6,effect:{color:"#fff",scaleSize:3,period:30},itemStyle:{color:null,width:1}},markPoint:{hoverable:!0,symbol:"emptyCircle",symbolMinSize:20,symbolMaxSize:40,effect:{scaleSize:2,period:30},itemStyle:{color:"rgba(255,0,0,0.5)",shadowColor:"#000000",shadowBlur:0,shadowOffsetX:0,shadowOffsetY:0},label:{show:!0,color:"#fff",align:"center",baseline:"middle",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},tooltip:{show:!0,
backgroundColor:"#fff",borderColor:"#333",borderRadius:0,borderWidth:0,padding:10,textStyle:{color:"#000",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}}},this.rendererOptions)},_initMarkPoint:function(){var a=this,b=this._rendererOptions.markPoint.symbol,c=this._rendererOptions.markPoint.symbolMinSize,d=this._rendererOptions.markPoint.symbolMaxSize,e=this._rendererOptions.markPoint.effect,f=this._rendererOptions.markPoint.itemStyle;if(typeof f.color==="object")var g=GeoGlobe.Util.getGradientImageData(f.color);
var h=this._rendererOptions.markPoint.label;this.MarkPoint=function(b,e,h,o,r){this.index=b;this.name=e;this.value=h;this.lon=o;this.lat=r;this.init();this.weight=(this.value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(this.weight))this.weight=1;if(this.weight>1)this.weight=1;if(this.weight<0)this.weight=0;this.size=c+(d-c)*this.weight;this.radius=this.size/2;this.color=typeof f.color==="object"?"rgba("+g[parseInt(this.weight*255,10)*4]+","+g[parseInt(this.weight*255,10)*4+1]+","+g[parseInt(this.weight*
255,10)*4+2]+","+g[3]/255+")":f.color;this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);this.tmpColor=this.color};this.MarkPoint.prototype.init=function(){switch(b){case "circle":this.energy=[0,1/3,2/3];break;case "ring":this.energy=[0,0.25*e.scaleSize,0.5*e.scaleSize,0.75*e.scaleSize];break;case "emptyCircle":this.energy=0}this.increment=Math.max(0.1*e.scaleSize/e.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001)};this.MarkPoint.prototype.updateXY=function(){var b=a._parent.map.project([this.lon,
this.lat]);this.x=b.x;this.y=b.y};this.MarkPoint.prototype.update=function(){var a;switch(b){case "circle":for(a=0;a<3;a++)this.energy[a]<1?this.energy[a]+=this.increment:this.energy[a]=0;break;case "ring":for(a=0;a<4;a++)this.energy[a]<e.scaleSize?this.energy[a]+=this.increment:this.energy[a]=0;break;case "emptyCircle":this.energy<e.scaleSize?this.energy+=this.increment:this.energy=0}};this.MarkPoint.prototype.isPointInPath=function(b,c,d){b.beginPath();b.arc(this.x,this.y,this.size/2,0,Math.PI*
2,!0);if(b.isPointInPath(c,d))a.hoveredMarkPoint=this};this.MarkPoint.prototype.draw1=function(c){a.hoveredMarkPoint===this?(this.radius=this.size/2*1.1,this.color=GeoGlobe.Util.getShadeColor(this.tmpColor,20)):(this.radius=this.size/2,this.color=this.tmpColor);this.rgbColor=GeoGlobe.Util.getRgbColor(this.color);c.shadowColor=f.shadowColor;c.shadowBlur=f.shadowBlur;c.shadowOffsetX=f.shadowOffsetX;c.shadowOffsetY=f.shadowOffsetY;switch(b){case "circle":c.beginPath();c.arc(this.x,this.y,this.radius,
0,Math.PI*2,!0);c.fillStyle=this.color;c.fill();break;case "emptyCircle":if(a.hoveredMarkPoint===this)c.beginPath(),c.arc(this.x,this.y,this.radius*e.scaleSize/2,0,Math.PI*2,!0),c.lineWidth=Math.round(this.radius/5)<2?2:Math.round(this.radius/5),c.strokeStyle=this.color,c.stroke()}};this.MarkPoint.prototype.draw2=function(a){this.update();var c;switch(b){case "circle":for(c=0;c<3;)a.beginPath(),a.arc(this.x,this.y,this.radius+this.radius*(e.scaleSize-1)*this.energy[c],0,Math.PI*2,!0),a.strokeStyle=
"rgba"+this.rgbColor.slice(3).split(")")[0]+","+(1-this.energy[c])+")",a.stroke(),c++;break;case "ring":for(c=0;c<4;)a.beginPath(),a.arc(this.x,this.y,this.radius*this.energy[c],0,Math.PI*2,!0),a.fillStyle="rgba"+this.rgbColor.slice(3).split(")")[0]+","+Math.max(1-this.energy[c]/e.scaleSize,0)+")",a.fill(),c++;break;case "emptyCircle":a.beginPath(),a.arc(this.x,this.y,this.radius*this.energy,0,Math.PI*2,!0),a.strokeStyle=this.color,a.stroke()}if(h.show)a.font=h.fontStyle+" "+h.fontWeight+" "+h.fontSize+
"px "+h.fontFamily,a.textAlign=h.align,a.textBaseline=h.baseline,a.fillStyle=h.color?h.color:this.color,a.fillText(this.value,this.x,this.y)}},_initMarkLine:function(){var a=this,b=this._rendererOptions.markLine.effect,c=this._rendererOptions.markLine.itemStyle;this.MarkLine=function(d,e,f){var g=this;this.index=d;this.start=e;this.end=f;this.color=c.color?c.color:a.direction==="out"?f.color:e.color;this.width=c.width;this.effect={radius:c.width*b.scaleSize/2,color:b.color,increment:0.1/b.period,
init:function(){this.energy=0},update:function(){this.energy<1?(this.energy+=this.increment,a._rendererOptions.markLine.curveness!==0?(this.x=Math.pow(1-this.energy,2)*g.p1.x+2*this.energy*(1-this.energy)*g.cp.x+Math.pow(this.energy,2)*g.p2.x,this.y=Math.pow(1-this.energy,2)*g.p1.y+2*this.energy*(1-this.energy)*g.cp.y+Math.pow(this.energy,2)*g.p2.y):(this.x=g.p1.x+this.energy*(g.p2.x-g.p1.x),this.y=g.p1.y+this.energy*(g.p2.y-g.p1.y))):this.init()},draw:function(a){this.update();a.beginPath();a.arc(this.x,
this.y,this.radius,0,Math.PI*2,!0);a.fillStyle=this.color;a.fill();a.closePath()}}};this.MarkLine.prototype.updateXY=function(){this.p1=a._parent.map.project([this.start.lon,this.start.lat]);this.p2=a._parent.map.project([this.end.lon,this.end.lat]);a._rendererOptions.markLine.curveness!==0&&this.getControlPoint()};this.MarkLine.prototype.getControlPoint=function(){var b=a._rendererOptions.markLine.curveness/2,c=Math.sqrt(Math.pow(this.p1.x-this.p2.x,2)+Math.pow(this.p1.y-this.p2.y,2)),f=c/2/Math.cos(b);
this.p1.x===this.p2.x?this.cp=this.p1.y>this.p2.y?{x:this.p1.x-Math.round(f*Math.sin(b)),y:this.p1.y-Math.round(f*Math.cos(b))}:this.p1.y===this.p2.y?{x:this.p1.x,y:this.p1.y}:{x:this.p1.x+Math.round(f*Math.sin(b)),y:this.p1.y+Math.round(f*Math.cos(b))}:this.p1.x<this.p2.x?this.p1.y>this.p2.y?(c=Math.asin((this.p2.x-this.p1.x)/c),this.cp=c<b?{x:this.p1.x-Math.round(f*Math.sin(b-c)),y:this.p1.y-Math.round(f*Math.cos(b-c))}:c===b?{x:this.p1.x,y:this.p1.y-f}:{x:this.p1.x+Math.round(f*Math.sin(c-b)),
y:this.p1.y-Math.round(f*Math.cos(c-b))}):this.p1.y===this.p2.y?this.cp={x:this.p1.x+Math.round(f*Math.cos(b)),y:this.p1.y-Math.round(f*Math.sin(b))}:(c=Math.PI-Math.asin((this.p2.x-this.p1.x)/c),this.cp=c<Math.PI/2+b?{x:this.p1.x+Math.round(f*Math.cos(b-(c-Math.PI/2))),y:this.p1.y-Math.round(f*Math.sin(b-(c-Math.PI/2)))}:c===Math.PI/2+b?{x:this.p1.x+f,y:this.p1.y}:{x:this.p1.x+Math.round(f*Math.cos(c-Math.PI/2-b)),y:this.p1.y+Math.round(f*Math.sin(c-Math.PI/2-b))}):this.p1.y<this.p2.y?(c=Math.PI+
Math.asin((this.p1.x-this.p2.x)/c),this.cp=c<Math.PI+b?{x:this.p1.x+Math.round(f*Math.sin(b-(c-Math.PI))),y:this.p1.y+Math.round(f*Math.cos(b-(c-Math.PI)))}:c===Math.PI+b?{x:this.p1.x,y:this.p1.y+f}:{x:this.p1.x-Math.round(f*Math.sin(c-Math.PI-b)),y:this.p1.y+Math.round(f*Math.cos(c-Math.PI-b))}):this.p1.y===this.p2.y?this.cp={x:this.p1.x-Math.round(f*Math.cos(b)),y:this.p1.y+Math.round(f*Math.sin(b))}:(c=Math.PI*3/2+Math.acos((this.p1.x-this.p2.x)/c),this.cp=c<Math.PI*3/2+b?{x:this.p1.x-Math.round(f*
Math.cos(b-(c-Math.PI*3/2))),y:this.p1.y+Math.round(f*Math.sin(b-(c-Math.PI*3/2)))}:c===Math.PI*3/2+b?{x:this.p1.x-f,y:this.p1.y}:{x:this.p1.x-Math.round(f*Math.cos(c-Math.PI*3/2-b)),y:this.p1.y-Math.round(f*Math.sin(c-Math.PI*3/2-b))})};this.MarkLine.prototype.isPointInStroke=function(b,c,f){b.beginPath();b.moveTo(this.p1.x,this.p1.y);a._rendererOptions.markLine.curveness!==0?b.quadraticCurveTo(this.cp.x,this.cp.y,this.p2.x,this.p2.y):b.lineTo(this.p2.x,this.p2.y);if(b.isPointInStroke(c,f))a.hoveredMarkLine=
this};this.MarkLine.prototype.draw=function(b){a.hoveredMarkLine===this?(this.color=GeoGlobe.Util.getShadeColor(c.color?c.color:a.direction==="out"?this.end.color:this.start.color,20),this.width=c.width*1.1):(this.color=c.color?c.color:a.direction==="out"?this.end.color:this.start.color,this.width=c.width);b.beginPath();b.moveTo(this.p1.x,this.p1.y);a._rendererOptions.markLine.curveness!==0?b.quadraticCurveTo(this.cp.x,this.cp.y,this.p2.x,this.p2.y):b.lineTo(this.p2.x,this.p2.y);b.lineWidth=this.width;
...
this._initMarkPoint();this._initMarkLine();this._initTooltip();this.setData(this.data);this.draw()},draw:function(){this.updateXY();this.drawCanvas1();this.animation=!0;this.frame&&cancelAnimationFrame(this.frame);var a=this;(function c(){a.frame=requestAnimationFrame(c);a.animation&&a.drawCanvas2();a.animation&&a.drawCanvas3();a.animation=!0})()},onMove:function(){this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width;this.animation=!1;this.updateXY();this.drawCanvas1();this.drawCanvas2();
this.drawCanvas3()},onMoveEnd:function(){this.redraw()},onMouseMove:function(a){if((this._rendererOptions.markLine.hoverable||this._rendererOptions.markPoint.hoverable)&&this.visibility&&this.markPoints.length>0&&!this._parent.map.moving)this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a})},onResize:function(){this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=
this.cacheCanvas[2].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.canvas[2].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.cacheCanvas[2].height=this.height=this._parent.map.transform.height;this.redraw()},redraw:function(){this.clearCanvas();this.updateXY();this.drawCanvas1();this.drawCanvas2();this.drawCanvas3()},updateXY:function(){for(var a=this.markPoints.length;a--;)this.markPoints[a].updateXY(),this.markLines[a].updateXY()},
drawCanvas1:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markLines.length;a--;)this.markLines[a].draw(this.cacheCanvasContext[0]);for(a=this.markPoints.length;a--;)this.markPoints[a].draw1(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawCanvas2:function(){document.createElement("canvas").getContext?(this.cacheCanvasContext[1].globalCompositeOperation="destination-out",this.cacheCanvasContext[1].fillStyle="rgba(0, 0, 0, 0.05)",
this.cacheCanvasContext[1].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[1].globalCompositeOperation="source-over"):this.cacheCanvas[1].width=this.width;this.cacheCanvasContext[1].save();for(var a=this.markLines.length;a--;)this.markLines[a].effect.draw(this.cacheCanvasContext[1]);this.cacheCanvasContext[1].restore();this.canvas[1].width=this.width;this.canvasContext[1].drawImage(this.cacheCanvas[1],0,0)},drawCanvas3:function(){this._rendererOptions.markPoint.symbol==="emptyCircle"?
document.createElement("canvas").getContext?(this.cacheCanvasContext[2].globalCompositeOperation="destination-out",this.cacheCanvasContext[2].fillStyle="rgba(0, 0, 0, 0.05)",this.cacheCanvasContext[2].fillRect(0,0,this.width,this.height),this.cacheCanvasContext[2].globalCompositeOperation="source-over"):this.cacheCanvas[2].width=this.width:this._rendererOptions.markPoint.symbol==="ring"?(this.cacheCanvas[2].width=this.width,this.cacheCanvasContext[2].globalCompositeOperation="lighter"):this.cacheCanvas[2].width=
this.width;this.cacheCanvasContext[2].save();for(var a=this.markPoints.length;a--;)this.markPoints[a].draw2(this.cacheCanvasContext[2]);this.cacheCanvasContext[2].restore();this.canvas[2].width=this.width;this.canvasContext[2].drawImage(this.cacheCanvas[2],0,0)},clearCanvas:function(){this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width},destroy:function(){cancelAnimationFrame(this.frame);this._parent.container.removeChild(this.div);
this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.hoveredMarkLine=null;this.lastHoveredMarkPoint=this.hoveredMarkPoint?GeoGlobe.Util.clone(this.hoveredMarkPoint):null;this.hoveredMarkPoint=null;var c,d;c=0;for(d=this.markLines.length;c<d;c++)!this.hoveredMarkLine&&this.markLines[c].isPointInStroke(this.cacheCanvasContext[0],a,b);c=0;for(d=this.markPoints.length;c<
d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.drawCanvas1();this.hoveredMarkLine||this.hoveredMarkPoint?(this.showTooltip(this.hoveredMarkLine?this.hoveredMarkLine.start.name+" > "+this.hoveredMarkLine.end.name:this.hoveredMarkPoint.name,a,b),this.canvas[2].style.cursor="pointer"):(this.hideTooltip(),this.canvas[2].style.cursor="default")},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=
c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.canvas[1].width=this.canvas[2].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.cacheCanvas[2].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=
this.canvas[2].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.cacheCanvas[2].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=this.canvas[1].style.display=this.canvas[2].style.display=a?"block":"none"},setData:function(a){this.data=a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<a.length;b++){if(a[b].properties.value<this.minValue)this.minValue=a[b].properties.value;if(a[b].properties.value>
this.maxValue)this.maxValue=a[b].properties.value}for(var c=new this.MarkPoint(void 0,this.location.name,0,this.location.lonLat[0],this.location.lonLat[1]),d=[],e=[],b=0;b<a.length;b++)d.push(new this.MarkPoint(b,a[b].properties.name,a[b].properties.value,a[b].geometry.coordinates[0],a[b].geometry.coordinates[1])),e.push(this.direction==="out"?new this.MarkLine(b,c,d[b]):new this.MarkLine(b,d[b],c));this.hoveredMarkLine=this.hoveredMarkPoint=null;this.markPoints=d;this.markLines=e}});
GeoGlobe.Visuals.Custom.Commute=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPoint:null,MarkLine:null,markPoints:[],markLines:{items:[],option:{}},initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._initContainer();this._initCanvas()},_initContainer:function(){this.div=document.createElement("div");this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute")},_init_RendererOptions:function(){this._rendererOptions=
...
this.cacheCanvasContext.push(this.cacheCanvas[1].getContext("2d"));this.canvas[0].style.position="absolute";this.canvas[1].style.position="absolute";this.div.appendChild(this.canvas[0]);this.div.appendChild(this.canvas[1]);this.setVisible(this.visibility)},_initTooltip:function(){if(this._rendererOptions.markPoint.hoverable&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this.div.appendChild(document.createElement("div")),this.tooltipDiv.style.position="relative",this.tooltipDiv.style.display=
...
this.cacheCanvas[1].width=this.width},destroy:function(){cancelAnimationFrame(this.frame);this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.hoveredMarkPoint=null;this.cacheCanvasContext[1].save();for(var c=0,d=this.markPoints.length;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[1],
a,b);this.cacheCanvasContext[1].restore();this.hoveredMarkPoint?(this.canvas[1].style.cursor="pointer",this.showTooltip(this.hoveredMarkPoint.name,a,b)):(this.canvas[1].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display=
"none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=this.canvas[1].style.display=a?"block":
...
(d[c].value-a.minValue)/(a.maxValue-a.minValue);if(isNaN(d[c].weight))d[c].weight=1;if(d[c].weight>1)d[c].weight=1;if(d[c].weight<0)d[c].weight=0;if(GeoGlobe.Util.getType(a._rendererOptions.markPoint.itemStyle.color[e])==="object")a.gradientImageData=GeoGlobe.Util.getGradientImageData(a._rendererOptions.markPoint.itemStyle.color[e]);d[c].color=GeoGlobe.Util.getType(g.color[e])==="object"?"rgba("+a.gradientImageData[~~(d[c].weight*255+0.5)*4]+","+a.gradientImageData[~~(d[c].weight*255+0.5)*4+1]+","+
a.gradientImageData[~~(d[c].weight*255+0.5)*4+2]+","+a.gradientImageData[3]/255+")":b[e]}};this.MarkPointsSet.prototype.updateXY=function(){for(var b=this.markPoints.length;b--;){var c=a._parent.map.project([this.markPoints[b].lon,this.markPoints[b].lat]);this.markPoints[b].x=c.x;this.markPoints[b].y=c.y}};this.MarkPointsSet.prototype.draw=function(a,b){if(d||c[b]!==0){var g=[],n=function(a){for(var b=0;b<g.length;b++)if(parseInt(g[b].x)===parseInt(a.x)&&parseInt(g[b].y)===parseInt(a.y))return g[b];
return null},o=function(){a.fillStyle=t.color;a.beginPath();switch(e){case "square":a.globalCompositeOperation="lighter";a.rect(t.x-f/2,t.y-f/2,f,f);break;case "square2":a.rect(t.x-f/2,t.y-f/2,f,f);break;case "round":a.globalCompositeOperation="lighter",a.arc(t.x,t.y,f/2,0,Math.PI*2,!1)}a.fill()},r=this.markPoints.length;for(this.markPoints=this.markPoints.sort(function(a,b){var c=a.value,d=b.value;return c>d?-1:c<d?1:0});r--;){var t;t=this.markPoints[r];if(e==="square2"){var m=n(t);if(m){if(t.value>
m.value)o(),m.value=t.value}else o(),g.push({x:t.x,y:t.y,value:t.value})}else o()}}}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0]);
this.setVisible(this.visibility)},render:function(){this._init_Legend();this._init_RendererOptions();this._initMarkPointsSet();this.setData(this.data);this.draw()},draw:function(){this.updateXY();this.drawCanvas();this.frame&&cancelAnimationFrame(this.frame)},lazydraw:function(){var a=this;(function c(){if(a.DRAWINDEX<a.legendLabels.length)requestAnimationFrame(c),a.drawLegend(a.DRAWINDEX),a.markPointsSets[a.DRAWINDEX].draw(a.cacheCanvasContext[0],a.DRAWINDEX),a.canvas[0].width=a.width,a.canvasContext[0].drawImage(a.cacheCanvas[0],
...
this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily,this.legendDiv.appendChild(this.legendCanvas),this._parent.container.parentNode.parentNode.parentNode.appendChild(this.legendDiv);for(var b=[],c=null,d=0,e=this.legendLabels.length;d<e;d++)for(var c=this._legend.itemSize+10+this.legendCanvasContext.measureText(this.legendLabels[d].toString()).width,f=this._legend.col,g=0;g<f;g++)d%this._legend.col===g&&
(!b[g]||b[g]<c)&&(b[g]=c);for(var h=10,c=10,d=0,e=b.length;d<e;d++)h+=b[d]+10;c+=((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var f=!1,g,j,s=0,a=a!==void 0?a+1:this.legendLabels.length;s<a;s++){j=0;for(var q=this._legend.col;j<
q;j++)if(s%this._legend.col===j){g=10+this._legend.itemSize/2;for(var u=0;u<j;u++)g+=b[u]+10}j=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+10)*~~(s/this._legend.col);u=q=!1;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "square2":this.legendCanvasContext.rect(g-
this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,j,this._legend.itemSize/2,0,Math.PI*2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=q=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+
" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(g+this._legend.itemSize/2+10,j-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this.legendLabels[s].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(f=q=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);u&&(this._legend.itemStatuses[s]=
this._legend.itemStatuses[s]===0?1:0,this.drawCanvas());var v=this._legend.itemStatuses[s]===0?"#808080":this._legend.itemColors[s]?this._legend.itemColors[s]:this._rendererOptions.markPoint.itemStyle.color,w=this._legend.itemStatuses[s]===0?"#808080":this._legend.textStyle.color,v=q||u?GeoGlobe.Util.getShadeColor(v,20):v,w=q||u?GeoGlobe.Util.getShadeColor(w,20):w;this.legendCanvasContext.beginPath();switch(this._rendererOptions.markPoint.symbol){case "square":this.legendCanvasContext.rect(g-this._legend.itemSize/
2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "square2":this.legendCanvasContext.rect(g-this._legend.itemSize/2,j-this._legend.itemSize/2,this._legend.itemSize,this._legend.itemSize);break;case "round":this.legendCanvasContext.arc(g,j,this._legend.itemSize/2,0,Math.PI*2,!1)}this.legendCanvasContext.fillStyle=v;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+
"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.textAlign="left";this.legendCanvasContext.textBaseline="middle";this.legendCanvasContext.fillStyle=w;this.legendCanvasContext.fillText(this.legendLabels[s],g+this._legend.itemSize/2+10,j)}this.legendCanvas.style.cursor=f?"pointer":"default"}.bind(this);this.legendCanvas.onmousedown=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;
j(void 0,a.type,b,c)};this.legendCanvas.onmousemove=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;j(void 0,a.type,b,c)};j(a)}},clearCanvas:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width},destroy:function(){cancelAnimationFrame(this.frame);this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=
[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none";this.legendDiv&&(this.legendDiv.style.display=
a?"block":"none")},setData:function(a){this.data=a;this.minValue=Number.MAX_VALUE;this.maxValue=Number.MIN_VALUE;for(var b=0;b<a.length;b++){if(a[b].properties.value<this.minValue)this.minValue=a[b].properties.value;if(a[b].properties.value>this.maxValue)this.maxValue=a[b].properties.value}a=new Blob(["function MarkPoint(lon, lat, value) {this.lon = lon;this.lat = lat;this.value = value;}function MarkPointsSet(legendLabel) {this.legendLabel = legendLabel;this.markPoints = [];}var legendLabels = [];var markPointsSets = [];onmessage = function (evt) {var features = evt.data.data;var feature = null;var legendLabel = null;for (var i = 0, len = features.length; i < len; i++) {feature = features[i];legendLabel = feature.properties.type;if (legendLabels.indexOf(legendLabel) === -1) {legendLabels.push(legendLabel);markPointsSets.push(new MarkPointsSet(legendLabel));}markPointsSets[legendLabels.indexOf(legendLabel)].markPoints.push(new MarkPoint(feature.geometry.coordinates[0], feature.geometry.coordinates[1],feature.properties.value));}postMessage({legendLabels: legendLabels,markPointsSets: markPointsSets})}"]);
...
0||this.measureValueSums[b]===0?0:this.measureValues[b][g]/this.measureValueSums[b]*Math.PI*2})}}};this.MarkPoint.prototype.updatePartXY=function(){var b=a._rendererOptions.markPoint.slope,c,e,f;switch(d){case "column":var l,n;l=this.parts.length%2===0?this.x-h*Math.cos(b)/2-(this.parts.length/2-1)*g-(this.parts.length/2-0.5)*j:this.x+(g-h*Math.cos(b))/2-(this.parts.length-1)/2*g-(this.parts.length-1)/2*j;n=this.y+h*Math.sin(b)/2;for(c=0;c<this.parts.length;c++)for(e=0;e<this.parts[c].cubes.length;e++){var q=
0;for(f=e;f>0;f--)q+=this.parts[c].cubes[f-1].height;this.parts[c].cubes[e].vertexs=[[l+c*(g+j),n-q],[l+c*(g+j)+h*Math.cos(b),n-h*Math.sin(b)-q],[l+c*(g+j)+h*Math.cos(b)-g,n-h*Math.sin(b)-q],[l+c*(g+j)-g,n-q]]}break;case "pie":var u,v,w,x,C,B=Math.PI*2/50;for(c=0;c<1;c++){f=this.parts[c].size/2;l=f>g?f-g:0;q=new this.Point(0,0,-h/2);u=new this.Point(0,0,h/2);v=[];w=[];x=[];C=[];for(n=0;n<=Math.PI*2;)v.push(new this.Point(f*Math.cos(n),f*Math.sin(n),-h/2)),w.push(new this.Point(f*Math.cos(n),f*Math.sin(n),
h/2)),l>0&&(x.push(new this.Point(l*Math.cos(n),l*Math.sin(n),-h/2)),C.push(new this.Point(l*Math.cos(n),l*Math.sin(n),h/2))),n+=B;v.push(new this.Point(f,0,-h/2));w.push(new this.Point(f,0,h/2));l>0&&(x.push(new this.Point(l,0,-h/2)),C.push(new this.Point(l,0,h/2)));e=Math.cos(b);var A=Math.sin(b),y;n=q.y*e-q.z*A;y=q.z*e+q.y*A;q.y=n;q.z=y;n=u.y*e-u.z*A;y=u.z*e+u.y*A;u.y=n;u.z=y;for(f=0;f<50;f++)if(n=v[f].y*e-v[f].z*A,y=v[f].z*e+v[f].y*A,v[f].y=n,v[f].z=y,n=w[f].y*e-w[f].z*A,y=w[f].z*e+w[f].y*A,w[f].y=
n,w[f].z=y,l>0)n=x[f].y*e-x[f].z*A,y=x[f].z*e+x[f].y*A,x[f].y=n,x[f].z=y,n=C[f].y*e-C[f].z*A,y=C[f].z*e+C[f].y*A,C[f].y=n,C[f].z=y;for(e=0;e<this.parts[c].sectors.length;e++){n=this.parts[c].sectors[e].angle;A=0;for(f=e;f>0;f--)A+=this.parts[c].sectors[f-1].angle;f=A+n;this.parts[c].sectors[e].startIndex=e===0?Math.round(A/B):this.parts[c].sectors[e-1].endIndex;this.parts[c].sectors[e].endIndex=Math.round(f/B)}this.parts[c].uCentrePoint=q;this.parts[c].tCentrePoint=u;this.parts[c].oUnderPoints=v;
this.parts[c].oTopPoints=w;if(l>0)this.parts[c].iUnderPoints=x,this.parts[c].iTopPoints=C}}};this.MarkPoint.prototype.update=function(){this.energy+=this.velocity;this.energy>1&&(this.energy=1);a.DRAWDONE=this.energy===1};this.MarkPoint.prototype.isPointInPath=function(c,e,f){var h,j,l;switch(d){case "column":for(h=0;h<this.parts.length;h++)for(j=0;j<this.parts[h].cubes.length;j++)if(this.parts[h].cubes[j].height>0&&(c.beginPath(),c.moveTo(this.parts[h].cubes[j].vertexs[0][0],this.parts[h].cubes[j].vertexs[0][1]),
...
0;h<1;h++){var q=this.parts[h].tCentrePoint,u=this.parts[h].oUnderPoints,v=this.parts[h].oTopPoints,w=this.parts[h].iUnderPoints,x=this.parts[h].iTopPoints,C=!1;this.parts[h].size/2>g&&(C=!0);var B=Math.round(25),A=[],y=[],z=[];l=[];for(j=0;j<this.parts[h].sectors.length;j++)A.push(this.parts[h].sectors[j].angle),y.push(this.parts[h].sectors[j].startIndex),z.push(Math.round(this.parts[h].sectors[j].endIndex*this.energy)),l.push(b[j]?b[j]:n.color);for(j=A.length-1;j>=0;j--)if(A[j]>0){c.beginPath();
if(y[j]>B){c.moveTo(v[z[j]].get2d().x,v[z[j]].get2d().y);for(l=z[j]-1;l>=y[j];l--)c.lineTo(v[l].get2d().x,v[l].get2d().y);if(C){c.lineTo(x[y[j]].get2d().x,x[y[j]].get2d().y);for(l=y[j];l<=z[j];l++)c.lineTo(w[l].get2d().x,w[l].get2d().y);c.lineTo(x[z[j]].get2d().x,x[z[j]].get2d().y)}else c.lineTo(q.get2d().x,q.get2d().y)}else if(z[j]<B){c.moveTo(u[z[j]].get2d().x,u[z[j]].get2d().y);for(l=z[j]-1;l>=y[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[y[j]].get2d().x,v[y[j]].get2d().y);if(C)for(l=
y[j];l<=z[j];l++)c.lineTo(x[l].get2d().x,x[l].get2d().y);else c.lineTo(q.get2d().x,q.get2d().y);c.lineTo(v[z[j]].get2d().x,v[z[j]].get2d().y)}else{c.moveTo(v[z[j]].get2d().x,v[z[j]].get2d().y);for(l=z[j]-1;l>=B;l--)c.lineTo(v[l].get2d().x,v[l].get2d().y);for(l=B;l>=y[j];l--)c.lineTo(u[l].get2d().x,u[l].get2d().y);c.lineTo(v[y[j]].get2d().x,v[y[j]].get2d().y);if(C){for(l=y[j];l<=B;l++)c.lineTo(x[l].get2d().x,x[l].get2d().y);for(l=B;l<=z[j];l++)c.lineTo(w[l].get2d().x,w[l].get2d().y)}else c.lineTo(q.get2d().x,
q.get2d().y)}if(c.isPointInPath(e,f)){a.hoveredMarkPoint=this;this.hActive=h;this.vActive=j;return}}}}};this.MarkPoint.prototype.draw=function(c){var e=a._rendererOptions.markPoint.slope;this.update();var f,m,p;p=!1;var s;switch(d){case "column":for(f=0;f<this.parts.length;f++)for(m=0;m<this.parts[f].cubes.length;m++)if(this.parts[f].cubes[m].height>0&&(p=!0,s=b[m]?b[m]:n.color,a.hoveredMarkPoint===this&&f===this.hActive&&m===this.vActive&&(s=GeoGlobe.Util.getShadeColor(s,20)),c.globalAlpha=l,c.globalCompositeOperation=
"source-over",c.shadowBlur=0,c.shadowOffsetX=0,c.shadowOffsetY=0,c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]),c.lineTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]),c.closePath(),
c.fillStyle=s,c.fill(),h!==0))c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-this.parts[f].cubes[m].height*this.energy),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(s,
-40),c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-this.parts[f].cubes[m].height*
this.energy),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(s,-20),c.fill(),c.shadowColor=n.shadowColor,c.shadowBlur=n.shadowBlur,c.shadowOffsetX=n.shadowOffsetX,c.shadowOffsetY=n.shadowOffsetY,c.globalCompositeOperation="destination-over",c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],
this.parts[f].cubes[m].vertexs[2][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]),c.closePath(),c.fillStyle=s,c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]-this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]-
this.parts[f].cubes[m].height*this.energy),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],this.parts[f].cubes[m].vertexs[3][1]),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(s,-40),c.fill(),c.beginPath(),c.moveTo(this.parts[f].cubes[m].vertexs[0][0],this.parts[f].cubes[m].vertexs[0][1]),c.lineTo(this.parts[f].cubes[m].vertexs[1][0],this.parts[f].cubes[m].vertexs[1][1]),c.lineTo(this.parts[f].cubes[m].vertexs[2][0],this.parts[f].cubes[m].vertexs[2][1]),c.lineTo(this.parts[f].cubes[m].vertexs[3][0],
this.parts[f].cubes[m].vertexs[3][1]),c.closePath(),c.fillStyle=GeoGlobe.Util.getShadeColor(s,-20),c.fill();if(p)c.lineWidth=0.3,c.globalAlpha=1,c.globalCompositeOperation="destination-over",c.shadowBlur=0,c.shadowOffsetX=0,c.shadowOffsetY=0,c.strokeStyle="#fff",c.beginPath(),c.moveTo(this.x-this.parts.length/2*g-(this.parts.length/2-0.5)*j-5,this.y),c.lineTo(this.x+this.parts.length/2*g+(this.parts.length/2-0.5)*j+5,this.y),c.closePath(),c.stroke(),h!==0&&(c.beginPath(),c.moveTo(this.x-(h/2+5)*Math.cos(e),
this.y+(h/2+5)*Math.sin(e)),c.lineTo(this.x+(h/2+5)*Math.cos(e),this.y-(h/2+5)*Math.sin(e)),c.closePath(),c.stroke());break;case "pie":c.globalAlpha=l;for(f=0;f<1;f++){s=this.parts[f].uCentrePoint;var q=this.parts[f].tCentrePoint,u=this.parts[f].oUnderPoints,v=this.parts[f].oTopPoints,w=this.parts[f].iUnderPoints,x=this.parts[f].iTopPoints,C=!1;this.parts[f].size/2>g&&(C=!0);var B=Math.round(25),A=[],y=[],z=[],E=[];for(m=0;m<this.parts[f].sectors.length;m++)A.push(this.parts[f].sectors[m].angle),
y.push(this.parts[f].sectors[m].startIndex),z.push(Math.round(this.parts[f].sectors[m].endIndex*this.energy)),E.push(b[m]?b[m]:n.color);for(m=A.length-1;m>=0;m--)A[m]>0&&a.hoveredMarkPoint===this&&f===this.hActive&&m===this.vActive&&(E[m]=GeoGlobe.Util.getShadeColor(E[m],10));for(m=A.length-1;m>=0;m--)if(A[m]>0){c.globalCompositeOperation="destination-over";c.beginPath();c.moveTo(u[z[m]].get2d().x,u[z[m]].get2d().y);for(p=z[m]-1;p>=y[m];p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);if(C)for(p=y[m];p<=
z[m];p++)c.lineTo(w[p].get2d().x,w[p].get2d().y);else c.lineTo(s.get2d().x,s.get2d().y);c.fillStyle=E[m];c.fill()}if(e!==0){for(m=A.length-1;m>=0;m--)if(A[m]>0)c.globalCompositeOperation="source-over",c.beginPath(),c.moveTo(u[z[m]].get2d().x,u[z[m]].get2d().y),C?(c.lineTo(w[z[m]].get2d().x,w[z[m]].get2d().y),c.lineTo(x[z[m]].get2d().x,x[z[m]].get2d().y)):(c.lineTo(s.get2d().x,s.get2d().y),c.lineTo(q.get2d().x,q.get2d().y)),c.lineTo(v[z[m]].get2d().x,v[z[m]].get2d().y),c.moveTo(u[y[m]].get2d().x,u[y[m]].get2d().y),
C?(c.lineTo(w[y[m]].get2d().x,w[y[m]].get2d().y),c.lineTo(x[y[m]].get2d().x,x[y[m]].get2d().y)):(c.lineTo(s.get2d().x,s.get2d().y),c.lineTo(q.get2d().x,q.get2d().y)),c.lineTo(v[y[m]].get2d().x,v[y[m]].get2d().y),c.fillStyle=GeoGlobe.Util.getShadeColor(E[m],-20),c.fill();if(C)for(m=A.length-1;m>=0;m--)if(A[m]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(w[z[m]].get2d().x,w[z[m]].get2d().y);if(y[m]<B&&z[m]>B){for(p=z[m]-1;p>=B;p--)c.lineTo(w[p].get2d().x,w[p].get2d().y);for(p=
B;p<=z[m];p++)c.lineTo(x[p].get2d().x,x[p].get2d().y);c.moveTo(w[y[m]].get2d().x,w[y[m]].get2d().y);for(p=y[m]+1;p<=B;p++)c.lineTo(w[p].get2d().x,w[p].get2d().y);for(p=B;p>=y[m];p--)c.lineTo(x[p].get2d().x,x[p].get2d().y)}else{for(p=z[m]-1;p>=y[m];p--)c.lineTo(w[p].get2d().x,w[p].get2d().y);for(p=y[m];p<=z[m];p++)c.lineTo(x[p].get2d().x,x[p].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(E[m],-20);c.fill()}for(m=A.length-1;m>=0;m--)if(A[m]>0){if(y[m]<B&&z[m]>B){c.globalCompositeOperation="destination-over";
c.beginPath();c.moveTo(u[z[m]].get2d().x,u[z[m]].get2d().y);for(p=z[m]-1;p>=B;p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=B;p<=z[m];p++)c.lineTo(v[p].get2d().x,v[p].get2d().y);c.fillStyle=GeoGlobe.Util.getShadeColor(E[m],-20);c.fill();c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(u[y[m]].get2d().x,u[y[m]].get2d().y);for(p=y[m]+1;p<=B;p++)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=B;p>=y[m];p--)c.lineTo(v[p].get2d().x,v[p].get2d().y)}else{c.globalCompositeOperation="source-over";
c.beginPath();c.moveTo(u[z[m]].get2d().x,u[z[m]].get2d().y);for(p=z[m]-1;p>=y[m];p--)c.lineTo(u[p].get2d().x,u[p].get2d().y);for(p=y[m];p<=z[m];p++)c.lineTo(v[p].get2d().x,v[p].get2d().y)}c.fillStyle=GeoGlobe.Util.getShadeColor(E[m],-20);c.fill()}for(m=A.length-1;m>=0;m--)if(A[m]>0){c.globalCompositeOperation="source-over";c.beginPath();c.moveTo(v[z[m]].get2d().x,v[z[m]].get2d().y);for(p=z[m]-1;p>=y[m];p--)c.lineTo(v[p].get2d().x,v[p].get2d().y);if(C)for(p=y[m];p<=z[m];p++)c.lineTo(x[p].get2d().x,
x[p].get2d().y);else c.lineTo(q.get2d().x,q.get2d().y);c.fillStyle=E[m];c.fill()}}}}}},_initCanvas:function(){this.canvas=[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0]);
...
this.updateXY();this.drawCanvas();this.drawLegend();this.frame&&cancelAnimationFrame(this.frame);var a=this;(function c(){a.frame=requestAnimationFrame(c);!a.DRAWDONE&&a.drawCanvas()})()},onMove:function(){this._rendererOptions.markPoint.slope=this._parent.map.getPitch()*Math.PI/180;this.updateXY();this.drawCanvas()},onMoveEnd:function(){this.redraw()},onClick:function(a){this._rendererOptions.markPoint.clickable&&this.hoveredMarkPoint&&this._parent.fire("overlayerclick",{layer:this,feature:this.hoveredMarkPoint,
event:a})},onMouseMove:function(a){this._rendererOptions.markPoint.hoverable&&this.visibility&&this.markPoints.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a}))},onResize:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.redraw()},
redraw:function(){this.clearCanvas();this.updateCountValueMinMaxSum();this.updateXY();this.drawCanvas();this.drawLegend()},updateXY:function(){for(var a=this.markPoints.length;a--;)this.SWITCH&&this.markPoints[a].init(),!this.SWITCH&&this.markPoints[a].updateXY(),this.markPoints[a].updateSize(),this.markPoints[a].updatePartXY();this.SWITCH=!1},drawCanvas:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markPoints.length;a--;)this.markPoints[a].draw(this.cacheCanvasContext[0]);this.canvas[0].width=
this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawLegend:function(){if(this._legend&&this._legend.show){if(!this.legendDiv)this.legendDiv=document.createElement("div"),this.legendDiv.style.display=this.visibility?"block":"none",this.legendDiv.style.zIndex=9999,this.legendDiv.style.position="absolute",this.legendDiv.style["background-color"]=this._legend.backgroundColor,this.legendDiv.style["border-color"]=this._legend.borderColor,this.legendDiv.style["border-width"]=this._legend.borderWidth+
...
this._parent.container.parentNode.parentNode.parentNode.appendChild(this.legendDiv);for(var a=[],b=null,c=0,d=this._legend.vLegendLabels.length;c<d;c++)for(var b=this._legend.itemWidth+10+this.legendCanvasContext.measureText(this._legend.vLegendLabels[c].toString()).width,e=this._legend.col,f=0;f<e;f++)c%this._legend.col===f&&(!a[f]||a[f]<b)&&(a[f]=b);for(var g=10,b=10,c=0,d=a.length;c<d;c++)g+=a[c]+10;b+=((this._legend.itemHeight<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemHeight)+
10)*(~~(this._legend.vLegendLabels.length/this._legend.col)+(this._legend.vLegendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=g;this.legendCanvas.height=b;var h=function(b,c,d){this.legendCanvas.width=g;for(var e=!1,f,h,m=0,p=this._legend.vLegendLabels.length;m<p;m++){h=0;for(var s=this._legend.col;h<s;h++)if(m%this._legend.col===h){f=10+this._legend.itemWidth/2;for(var q=0;q<h;q++)f+=a[q]+10}h=10+this._legend.itemHeight/2+((this._legend.itemHeight<this._legend.textStyle.fontSize?
this._legend.textStyle.fontSize:this._legend.itemHeight)+10)*~~(m/this._legend.col);q=s=!1;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);b==="mousemove"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=s=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(q=!0);this.legendCanvasContext.beginPath();this.legendCanvasContext.font=
this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(f+this._legend.itemWidth/2+10,h-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this._legend.vLegendLabels[m].toString()).width,this._legend.textStyle.fontSize);b==="mousemove"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,d)&&(e=s=!0);b==="mousedown"&&c!==void 0&&d!==void 0&&this.legendCanvasContext.isPointInPath(c,
d)&&(q=!0);if(q)this._legend.itemStatuses[m]=this._legend.itemStatuses[m]===0?1:0,this.SWITCH=!0,this.redraw();var u=this._legend.itemStatuses[m]===0?"#808080":this._legend.itemColors[m]?this._legend.itemColors[m]:this._rendererOptions.markPoint.itemStyle.color,v=this._legend.itemStatuses[m]===0?"#808080":this._legend.textStyle.color,u=s||q?GeoGlobe.Util.getShadeColor(u,20):u,v=s||q?GeoGlobe.Util.getShadeColor(v,20):v;this.legendCanvasContext.beginPath();this.legendCanvasContext.rect(f-this._legend.itemWidth/
2,h-this._legend.itemHeight/2,this._legend.itemWidth,this._legend.itemHeight);this.legendCanvasContext.fillStyle=u;this.legendCanvasContext.fill();this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.textAlign="left";this.legendCanvasContext.textBaseline="middle";this.legendCanvasContext.fillStyle=v;this.legendCanvasContext.fillText(this._legend.vLegendLabels[m],
f+this._legend.itemWidth/2+10,h)}this.legendCanvas.style.cursor=e?"pointer":"default"}.bind(this);this.legendCanvas.onmousedown=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;h(a.type,b,c)};this.legendCanvas.onmousemove=function(a){var b=a.offsetX||a.clientX-(a.target||a.srcElement).getBoundingClientRect().left,c=a.offsetY||a.clientY-(a.target||a.srcElement).getBoundingClientRect().top;
h(a.type,b,c)};h()}},updateCountValueMinMaxSum:function(){this.measureValueMinSum=Infinity;this.measureValueMaxSum=-Infinity;var a,b,c,d,e,f,g;a=0;for(d=this.markPoints.length;a<d;a++){this.markPoints[a].measureValueSums=[];b=0;for(e=this.markPoints[a].measureValues.length;b<e;b++){c=g=0;for(f=this.markPoints[a].measureValues[b].length;c<f;c++)this._legend.itemStatuses[c]!==0&&(g+=this.markPoints[a].measureValues[b][c]);this.markPoints[a].measureValueSums.push(g);g<this.measureValueMinSum&&(this.measureValueMinSum=
g);g>this.measureValueMaxSum&&(this.measureValueMaxSum=g)}}},clearCanvas:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width},destroy:function(){cancelAnimationFrame(this.frame);this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.lastHoveredMarkPoint=this.hoveredMarkPoint?GeoGlobe.Util.clone(this.hoveredMarkPoint):
null;this.hoveredMarkPoint=null;for(var c=0,d=this.markPoints.length;c<d;c++)!this.hoveredMarkPoint&&this.markPoints[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.drawCanvas();this.hoveredMarkPoint?(this.canvas[0].style.cursor="pointer",this.showTooltip(this.hoveredMarkPoint,a,b)):(this.canvas[0].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show){this.tooltipDiv.getElementsByTagName("span")[0].textContent=this._legend.hLegendLabels[a.hActive];
this.tooltipDiv.getElementsByTagName("span")[1].textContent=a.name;var d=this.tooltipDiv.getElementsByTagName("ul")[0];d.innerHTML="";for(var e=0;e<this._legend.vLegendLabels.length;e++)this._legend.itemStatuses[e]!==0&&(d.innerHTML+='<li style="line-height:20px;'+(e===a.vActive?"":"opacity:0.6;")+'"><div style="width: 12px;height: 12px;margin: 5px 5px 0 0;float: left;background-color: '+(this._legend.itemColors[e]?this._legend.itemColors[e]:this._rendererOptions.markPoint.itemStyle.color)+';"></div><span style="font-weight: 600;">'+
this._legend.vLegendLabels[e]+"\uff1a</span><span>"+this._rendererOptions.tooltip.formatter.replace("{0}",a.measureValues[a.hActive][e])+"</span></li>");this.tooltipDiv.style.top=c-15+"px";this.tooltipDiv.style.left=b+15+"px";this.tooltipDiv.style.display="block"}},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.cacheCanvas[0].width=
this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none";this.legendDiv&&(this.legendDiv.style.display=a?"block":"none")},setData:function(a){this.data=a;for(var b=[],c=0;c<a.length;c++){for(var d=[],e=0;e<this._legend.hLegendLabels.length;e++){d[e]=[];for(var f=0;f<this._legend.vLegendLabels.length;f++)d[e][f]=Number(a[c].properties[this._legend.hLegendLabels[e]][this._legend.vLegendLabels[f]]||
...
this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markFace.hoverable||this._rendererOptions.markFace.clickable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this.div.appendChild(document.createElement("div")),this.tooltipDiv.style.position="relative",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,
...
this.tooltipDiv.style["border-width"]=this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",this.tooltipDiv.style["white-space"]="nowrap",this.tooltipDiv.style["box-shadow"]="rgba(0, 0, 0, 0.2) 0px 10px 10px",this.tooltipDiv.style.transition="left 0.4s cubic-bezier(0.23, 1, 0.32, 1), top 0.4s cubic-bezier(0.23, 1, 0.32, 1)"},
render:function(){this._init_RendererOptions();this._initTooltip();this._initMarkFace();this._initBounds();this.setData(this.data);this.draw()},draw:function(){this.updateXY();this.drawCanvas();this.frame&&cancelAnimationFrame(this.frame)},onMove:function(){this.updateXY();this.drawCanvas()},onMoveEnd:function(){this.redraw()},onClick:function(a){this._rendererOptions.markFace.clickable&&this.hoveredMarkFace&&this._parent.fire("overlayerclick",{layer:this,feature:this.hoveredMarkFace,event:a})},onMouseMove:function(a){this._rendererOptions.markFace.hoverable&&
this.visibility&&this.markFaces.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkFace&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkFace,event:a}))},onResize:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.redraw()},redraw:function(){this.clearCanvas();this.updateXY();this.drawCanvas()},
updateXY:function(){for(var a=this.markFaces.length;a--;)this.markFaces[a].updateXY()},drawCanvas:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markFaces.length;a--;)this.markFaces[a].draw(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},clearCanvas:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width},destroy:function(){cancelAnimationFrame(this.frame);this._parent.container.removeChild(this.div);
this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.lastHoveredMarkFace=this.hoveredMarkFace?GeoGlobe.Util.clone(this.hoveredMarkFace):null;this.hoveredMarkFace=null;for(var c=0,d=this.markFaces.length;c<d;c++)!this.hoveredMarkFace&&this.markFaces[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.drawCanvas();this.hoveredMarkFace?(this.canvas[0].style.cursor="pointer",
this.showTooltip(this.hoveredMarkFace.name,a,b)):(this.canvas[0].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);
this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none"},getVoronoi:function(a){a=GeoGlobe.Util.clone(a);a.features.map(function(a){a.geometry.coordinates=GeoGlobe.Util.transferToMercator(a.geometry.coordinates)});a=turf.voronoi(a,{bbox:GeoGlobe.Util.transferToMercator([-180,-90]).concat(GeoGlobe.Util.transferToMercator([180,
90]))});a=GeoGlobe.Util.clone(a);a.features.map(function(a){a.geometry.coordinates[0].map(function(c,d){a.geometry.coordinates[0][d]=GeoGlobe.Util.transferToLonLat(c)})});return a},setData:function(a){this.data=a;var b=this,c=setInterval(function(){if(b.bounds){clearInterval(c);b.markFaces=[];b.hoveredMarkFace=null;for(var d=b.getVoronoi(a).features,e=b.bounds,f,g,h=0;h<d.length;h++){f=[];for(var j=0;j<e.length;j++)(g=turf.intersect(d[h],e[j]))&&f.push(g);b.markFaces.push(new b.MarkFace(h,a.features[h].properties.name,
Math.random(),a.features[h].geometry.coordinates[0],a.features[h].geometry.coordinates[1],f))}b.redraw()}},1)}});
...
this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markFace.hoverable||this._rendererOptions.markFace.clickable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this.div.appendChild(document.createElement("div")),this.tooltipDiv.style.position="relative",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=
999,this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=this._rendererOptions.tooltip.padding+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+" "+this._rendererOptions.tooltip.textStyle.fontWeight+" "+this._rendererOptions.tooltip.textStyle.fontSize+"px "+this._rendererOptions.tooltip.textStyle.fontFamily,this.tooltipDiv.style["background-color"]=document.createElement("canvas").getContext?this._rendererOptions.tooltip.backgroundColor:
...
"default",this.hideTooltip())},drawCanvas:function(){this.cacheCanvas[0].width=this.width;for(var a=this.markFaces.length;a--;)this.markFaces[a].draw(this.cacheCanvasContext[0]);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display=
"none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=a?"block":"none"},setData:function(a){this.data=a;var b=this,c=setInterval(function(){clearInterval(c);b.markFaces=[];b.hoveredMarkFace=
null;var d,e;e=turf.tin(a,"name");for(var f=0;f<e.features.length;f++)d=e.features[f],b.markFaces.push(new b.MarkFace(f,Math.random(),d.properties,d));b.redraw()},1)}});
...
this.div.appendChild(this.canvas[1]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markLine.hoverable||this._rendererOptions.markPoint.hoverable)&&this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this.div.appendChild(document.createElement("div")),this.tooltipDiv.style.position="relative",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=
this._rendererOptions.tooltip.padding+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+" "+this._rendererOptions.tooltip.textStyle.fontWeight+" "+this._rendererOptions.tooltip.textStyle.fontSize+"px "+this._rendererOptions.tooltip.textStyle.fontFamily,this.tooltipDiv.style["background-color"]=document.createElement("canvas").getContext?this._rendererOptions.tooltip.backgroundColor:GeoGlobe.Util.getRgbColor(this._rendererOptions.tooltip.backgroundColor),this.tooltipDiv.style["border-width"]=
this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",this.tooltipDiv.style["white-space"]="nowrap",this.tooltipDiv.style["box-shadow"]="rgba(0, 0, 0, 0.2) 0px 10px 10px",this.tooltipDiv.style.transition="left 0.4s cubic-bezier(0.23, 1, 0.32, 1), top 0.4s cubic-bezier(0.23, 1, 0.32, 1)"},render:function(){this._init_RendererOptions();
...
onMouseMove:function(a){if((this._rendererOptions.markLine.hoverable||this._rendererOptions.markPoint.hoverable)&&this.visibility&&this.markPoints.length>0&&!this._parent.map.moving)this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a})},onResize:function(){this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=
...
this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawCanvas2:function(){},clearCanvas:function(){this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width},destroy:function(){cancelAnimationFrame(this.frame);this._parent.container.removeChild(this.div);this.markPointImages=[];this.MarkPoint=null;this.markPoints=[];this.MarkLine=null;this.markLines=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=
[];this.cacheCanvasContext=[];this._rendererOptions={}},hover:function(a,b){this.hoveredMarkPoint=this.hoveredMarkLine=null;var c=this;this.markPoints.forEach(function(d){!c.hoveredMarkPoint&&d.isPointInPath(c.cacheCanvasContext[0],a,b)});this.markLines.forEach(function(d){!c.hoveredMarkLine&&d.isPointInStroke(c.cacheCanvasContext[0],a,b)});this.drawCanvas1();this.hoveredMarkLine||this.hoveredMarkPoint?(this.showTooltip(this.hoveredMarkLine?this.hoveredMarkLine.source.name+" > "+this.hoveredMarkLine.target.name:
this.hoveredMarkPoint.name,a,b),this.canvas[1].style.cursor="pointer"):(this.hideTooltip(),this.canvas[1].style.cursor="-webkit-grab")},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);
this._parent.container.appendChild(this.div);this.canvas[0].width=this.canvas[1].width=this.cacheCanvas[0].width=this.cacheCanvas[1].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.canvas[1].height=this.cacheCanvas[0].height=this.cacheCanvas[1].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=a;this.canvas[0].style.display=this.canvas[1].style.display=a?"block":"none"},getMarkPointById:function(a){for(var b,c=0,d=this.markPoints.length;c<
d;c++)if(this.markPoints[c].id===a){b=this.markPoints[c];break}return b},setData:function(a){this.hoveredMarkLine=this.hoveredMarkPoint=null;this.markPoints=[];this.markLines=[];var b=this,c,d,a=a||{};a.points=a.points||[];a.points.forEach(function(a,d){c=new b.MarkPoint(d,a.id,a.name,a.value,a.symbol,a.lon,a.lat,a);b.markPoints.push(c)});a.links=a.links||[];a.links.forEach(function(a,c){d=new b.MarkLine(c,b.getMarkPointById(a.source),b.getMarkPointById(a.target));b.markLines.push(d)});this.data=
a}});
GeoGlobe.Visuals.Custom.Fluorescence=GeoGlobe.Class4OL({_parent:null,canvas:[],cacheCanvas:[],canvasContext:[],cacheCanvasContext:[],MarkPointsSet:null,markPointsSets:[],legendLabels:[],initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this._initContainer();this._initCanvas()},_initContainer:function(){this.div=document.createElement("div");this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute")},_init_Legend:function(){this._legend=GeoGlobe.Util.deepExtend({},{show:!0,
left:null,right:null,top:null,bottom:null,col:1,itemSize:10,itemColors:[],itemStatuses:[],backgroundColor:"rgba(0,0,0,0.5)",borderColor:"#000",borderWidth:1,borderRadius:0,shadowColor:"#fff",shadowBlur:5,shadowOffsetX:0,shadowOffsetY:0,padding:10,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},this.legend)},_init_Legend_rightop:function(){this._legend_rightop=GeoGlobe.Util.deepExtend({},{show:!0,left:null,right:null,top:null,bottom:null,col:1,itemSize:10,
itemColors:[],itemStatuses:[],backgroundColor:"rgba(0,0,0,0.5)",borderColor:"#000",borderWidth:1,borderRadius:0,shadowColor:"#fff",shadowBlur:5,shadowOffsetX:0,shadowOffsetY:0,padding:10,textStyle:{color:"#fff",fontFamily:"serif",fontSize:12,fontStyle:"normal",fontWeight:"normal"}},this.legend_rightop)},_init_RendererOptions:function(){this._rendererOptions=GeoGlobe.Util.deepExtend({},{markPoint:{unactivatedDrawable:!0,itemSymbol:[],itemStyle:{color:"rgba(255,0,0,0.7)",shadowColor:"#000",shadowBlur:0,
shadowOffsetX:0,shadowOffsetY:0}}},this.rendererOptions)},_initMarkPointsSet:function(){var a=this,b=this._legend.itemColors,c=this._rendererOptions.markPoint.itemStyle,d=this._rendererOptions.markPoint.effect,e=this._rendererOptions.markPoint.itemSymbol;this.MarkPointsSet=function(f,g,h){this.legendLabel=f;this.markPoints=g;for(f=g.length;f--;){g[f].value<66?(g[f].symbolSize=1,g[f].symbol=e[0]):g[f].value<95?(g[f].symbolSize=3,g[f].symbol=e[1]):(g[f].symbolSize=4,g[f].symbol=e[2]);if(GeoGlobe.Util.getType(a._rendererOptions.markPoint.itemStyle.color[h])===
"object")a.gradientImageData=GeoGlobe.Util.getGradientImageData(a._rendererOptions.markPoint.itemStyle.color[h]);g[f].category=this.legendLabel;g[f].color=GeoGlobe.Util.getType(c.color[h])==="object"?"rgba("+a.gradientImageData[~~(g[f].weight*255+0.5)*4]+","+a.gradientImageData[~~(g[f].weight*255+0.5)*4+1]+","+a.gradientImageData[~~(g[f].weight*255+0.5)*4+2]+","+a.gradientImageData[3]/255+")":b[h];g[f].rgbColor=GeoGlobe.Util.getRgbColor(g[f].color);g[f].alpha=g[f].color.indexOf("a(")!==-1?+g[f].color.split(",")[3].split(")")[0]:
1;switch(g[f].symbol){case "circle":g[f].energy=[0,0.25,0.5,0.75];g[f].increment=Math.max(0.1*d.scaleSize/d.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001);break;case "ring":g[f].energy=[0,1/3*d.scaleSize,2/3*d.scaleSize],g[f].increment=Math.max(0.1*d.scaleSize/d.period+Math.random()*(Math.random()>0.5?1:-1)*0.002,0.001)}}};this.MarkPointsSet.prototype.update=function(){var a;for(a=this.markPoints.length;a--;)switch(this.markPoints[a].symbol){case "circle":for(var b=0;b<4;b++)this.markPoints[a].energy[b]+=
this.markPoints[a].increment,this.markPoints[a].energy[b]>1&&(this.markPoints[a].energy[b]=0);break;case "ring":for(b=0;b<3;b++)this.markPoints[a].energy[b]+=this.markPoints[a].increment,this.markPoints[a].energy[b]>d.scaleSize&&(this.markPoints[a].energy[b]=0)}};this.MarkPointsSet.prototype.isPointInPath=function(b,c,d){for(var e=0;e<this.markPoints.length;e++){var l=this.markPoints[e];b.beginPath();switch(l.symbol){case "circle":case "ring":b.arc(l.x,l.y,l.symbolSize,0,Math.PI*2,!0)}if(b.isPointInPath(c,
d))a.hoveredMarkPoint=l}};this.MarkPointsSet.prototype.updateXY=function(){for(var b=this.markPoints.length;b--;){var c=a._parent.map.project([this.markPoints[b].lon,this.markPoints[b].lat]);this.markPoints[b].x=c.x;this.markPoints[b].y=c.y}};this.MarkPointsSet.prototype.draw=function(a){for(var b=this.markPoints.length;b--;){var c;c=this.markPoints[b];var e;a.fillStyle=c.color;a.beginPath();switch(c.symbol){case "circle":a.beginPath();a.arc(c.x,c.y,c.symbolSize/2,0,Math.PI*2,!0);a.strokeStyle="rgba"+
c.rgbColor.slice(3).split(")")[0]+","+c.alpha+")";a.fill();for(e=0;e<4;)a.beginPath(),a.arc(c.x,c.y,c.symbolSize+c.symbolSize*(d.scaleSize-1)*c.energy[e],0,Math.PI*2,!0),a.strokeStyle="rgba"+c.rgbColor.slice(3).split(")")[0]+","+(1-c.energy[e])*c.alpha+")",a.stroke(),e++;break;case "ring":for(e=0;e<3;)a.beginPath(),a.arc(c.x,c.y,c.symbolSize*c.energy[e],0,Math.PI*2,!0),a.fillStyle="rgba"+c.rgbColor.slice(3).split(")")[0]+","+Math.max(1-c.energy[e]/d.scaleSize,0)*c.alpha+")",a.fill(),e++}}}},_initCanvas:function(){this.canvas=
[];this.canvasContext=[];this.canvas.push(document.createElement("canvas"));this.canvasContext.push(this.canvas[0].getContext("2d"));this.cacheCanvas=[];this.cacheCanvasContext=[];this.cacheCanvas.push(document.createElement("canvas"));this.cacheCanvasContext.push(this.cacheCanvas[0].getContext("2d"));this.canvas[0].style.position="absolute";this.div.appendChild(this.canvas[0]);this.setVisible(this.visibility)},_initTooltip:function(){if((this._rendererOptions.markPoint.hoverable||this._rendererOptions.markPoint.clickable)&&
this._rendererOptions.tooltip.show)this.tooltipDiv=this.tooltipDiv||this.div.appendChild(document.createElement("div")),this.tooltipDiv.style.position="relative",this.tooltipDiv.style.display="none",this.tooltipDiv.style.zIndex=999,this.tooltipDiv.style.color=this._rendererOptions.tooltip.textStyle.color,this.tooltipDiv.style.padding=this._rendererOptions.tooltip.padding+"px",this.tooltipDiv.style.font=this._rendererOptions.tooltip.textStyle.fontStyle+" "+this._rendererOptions.tooltip.textStyle.fontWeight+
" "+this._rendererOptions.tooltip.textStyle.fontSize+"px "+this._rendererOptions.tooltip.textStyle.fontFamily,this.tooltipDiv.style["background-color"]=document.createElement("canvas").getContext?this._rendererOptions.tooltip.backgroundColor:GeoGlobe.Util.getRgbColor(this._rendererOptions.tooltip.backgroundColor),this.tooltipDiv.style["border-width"]=this._rendererOptions.tooltip.borderWidth+"px",this.tooltipDiv.style["border-color"]=this._rendererOptions.tooltip.borderColor,this.tooltipDiv.style["border-radius"]=
this._rendererOptions.tooltip.borderRadius+"px",this.tooltipDiv.style["border-style"]="solid",this.tooltipDiv.style["white-space"]="pre-wrap",this.tooltipDiv.style["box-shadow"]="rgba(0, 0, 0, 0.2) 0px 10px 10px",this.tooltipDiv.style.transition="left 0.4s cubic-bezier(0.23, 1, 0.32, 1), top 0.4s cubic-bezier(0.23, 1, 0.32, 1)"},render:function(){this._init_Legend();this._init_Legend_rightop();this._init_RendererOptions();this._initTooltip();this._initMarkPointsSet();this.setData(this.data);this.draw()},
draw:function(){this.updateXY();this.drawCanvas();this.frame&&cancelAnimationFrame(this.frame)},lazydraw:function(){var a=this;(function c(){if(a.DRAWINDEX<a.legendLabels.length)requestAnimationFrame(c),a.drawLegend(a.DRAWINDEX),a.drawLegend2(a.DRAWINDEX),a.markPointsSets[a.DRAWINDEX].draw(a.cacheCanvasContext[0],a.DRAWINDEX),a.canvas[0].width=a.width,a.canvasContext[0].drawImage(a.cacheCanvas[0],0,0),a.DRAWINDEX++})()},onMove:function(){this.updateXY();this.drawCanvas()},onMoveEnd:function(){this.moving=
!1;this.redraw()},onClick:function(a){this._rendererOptions.markPoint.clickable&&this.hoveredMarkPoint&&this._parent.fire("overlayerclick",{layer:this,feature:this.hoveredMarkPoint,event:a})},onMouseMove:function(a){this._rendererOptions.markPoint.hoverable&&this.visibility&&this.markPointsSets.length>0&&!this._parent.map.moving&&(this.hover(a.point.x,a.point.y),this.hoveredMarkPoint&&this._parent.fire("overlayerhover",{layer:this,feature:this.hoveredMarkPoint,event:a}))},onMoveEnd:function(){this.redraw()},
onResize:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height;this.redraw()},redraw:function(){this.clearCanvas();this.updateXY();this.drawCanvas()},updateXY:function(){for(var a=this.markPointsSets.length;a--;)this.markPointsSets[a].updateXY()},drawCanvas:function(){this.cacheCanvas[0].width=this.width;for(var a=0,b=this.markPointsSets.length;a<b;a++)this.markPointsSets[a].draw(this.cacheCanvasContext[0],
a);this.canvas[0].width=this.width;this.canvasContext[0].drawImage(this.cacheCanvas[0],0,0)},drawLegend:function(a){if(this._legend&&this._legend.show&&!this.legendDiv){this.legendDiv=document.createElement("div");this.legendDiv.style.display=this.visibility?"block":"none";this.legendDiv.style.zIndex=9999;this.legendDiv.style.position="absolute";this.legendDiv.style["background-color"]=this._legend.backgroundColor;this.legendDiv.style["border-color"]=this._legend.borderColor;this.legendDiv.style["border-width"]=
this._legend.borderWidth+"px";this.legendDiv.style["border-radius"]=this._legend.borderRadius+"px";this.legendDiv.style["border-style"]="solid";this.legendDiv.style["box-shadow"]=this._legend.shadowOffsetX+"px "+this._legend.shadowOffsetY+"px "+this._legend.shadowBlur+"px "+this._legend.shadowColor;this.legendDiv.style.padding=this._legend.padding+"px";this.legendDiv.style.left=this._legend.left!==null?this._legend.left+"px":null;this.legendDiv.style.right=this._legend.right!==null?this._legend.right+
"px":null;this.legendDiv.style.top=this._legend.top!==null?this._legend.top+"px":null;this.legendDiv.style.bottom=this._legend.bottom!==null?this._legend.bottom+"px":null;this.legendCanvas=document.createElement("canvas");this.legendCanvasContext=this.legendCanvas.getContext("2d");this.legendCanvas.style.display="block";this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendDiv.appendChild(this.legendCanvas);
this._parent.container.parentNode.parentNode.parentNode.appendChild(this.legendDiv);for(var b=[],c=null,d=0,e=this.legendLabels.length;d<e;d++)for(var c=this._legend.itemSize+10+this.legendCanvasContext.measureText(this.legendLabels[d].toString()).width,f=this._legend.col,g=0;g<f;g++)d%this._legend.col===g&&(!b[g]||b[g]<c)&&(b[g]=c);for(var h=10,c=10,d=0,e=b.length;d<e;d++)h+=b[d]+10;c+=((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:this._legend.itemSize)+
10)*(~~(this.legendLabels.length/this._legend.col)+(this.legendLabels.length%this._legend.col===0?0:1));this.legendCanvas.width=h;this.legendCanvas.height=c;var j=function(a,c,d,e){this.legendCanvas.width=h;for(var a=!1,f,g,j=0,s=this.legendLabels.length;j<s;j++){g=0;for(var q=this._legend.col;g<q;g++)if(j%this._legend.col===g){f=10+this._legend.itemSize/2;for(var u=0;u<g;u++)f+=b[u]+10}g=10+this._legend.itemSize/2+((this._legend.itemSize<this._legend.textStyle.fontSize?this._legend.textStyle.fontSize:
this._legend.itemSize)+10)*~~(j/this._legend.col);u=q=!1;this.legendCanvasContext.beginPath();switch(this._legend.symbol){case "ring":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1);break;case "circle":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1)}c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(a=q=!0);c==="mousedown"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);this.legendCanvasContext.beginPath();
this.legendCanvasContext.font=this._legend.textStyle.fontStyle+" "+this._legend.textStyle.fontWeight+" "+this._legend.textStyle.fontSize+"px "+this._legend.textStyle.fontFamily;this.legendCanvasContext.rect(f+this._legend.itemSize/2+10,g-this._legend.textStyle.fontSize/2,this.legendCanvasContext.measureText(this.legendLabels[j].toString()).width,this._legend.textStyle.fontSize);c==="mousemove"&&d!==void 0&&e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(a=q=!0);c==="mousedown"&&d!==void 0&&
e!==void 0&&this.legendCanvasContext.isPointInPath(d,e)&&(u=!0);u&&(this._legend.itemStatuses[j]=this._legend.itemStatuses[j]===0?1:0,this.drawCanvas());var v=this._legend.itemColors[j],w=this._legend.textStyle.color,v=q||u?GeoGlobe.Util.getShadeColor(v,20):v,w=q||u?GeoGlobe.Util.getShadeColor(w,20):w;this.legendCanvasContext.beginPath();switch(this._legend.symbol){case "ring":this.legendCanvasContext.arc(f,g,this._legend.itemSize/2,0,Math.PI*2,!1);break;case "circle":this.legendCanvasContext.arc(f,
...
this._legend_rightop.show){if(!this.legendDiv2)this.legendDiv2=document.createElement("div"),this.legendDiv2.style.display=this.visibility?"block":"none",this.legendDiv2.style.zIndex=9999,this.legendDiv2.style.position="absolute",this.legendDiv2.style["background-color"]=this._legend.backgroundColor,this.legendDiv2.style["border-color"]=this._legend.borderColor,this.legendDiv2.style["border-width"]=this._legend.borderWidth+"px",this.legendDiv2.style["border-radius"]=this._legend.borderRadius+"px",
this.legendDiv2.style["border-style"]="solid",this.legendDiv2.style["box-shadow"]=this._legend.shadowOffsetX+"px "+this._legend.shadowOffsetY+"px "+this._legend.shadowBlur+"px "+this._legend.shadowColor,this.legendDiv2.style.padding=this._legend.padding+"px",this.legendDiv2.style.left=this._legend_rightop.left!==null?this._legend_rightop.left+"px":null,this.legendDiv2.style.right=this._legend_rightop.right!==null?this._legend_rightop.right+"px":null,this.legendDiv2.style.top=this._legend_rightop.top!==
null?this._legend_rightop.top+"px":null,this.legendDiv2.style.bottom=this._legend_rightop.bottom!==null?this._legend_rightop.bottom+"px":null,this.legendCanvas2=document.createElement("canvas"),this.legendCanvasContext2=this.legendCanvas2.getContext("2d"),this.legendCanvas2.style.display="block",this.legendCanvasContext2.font=this._legend_rightop.textStyle.fontStyle+" "+this._legend_rightop.textStyle.fontWeight+" "+this._legend_rightop.textStyle.fontSize+"px "+this._legend_rightop.textStyle.fontFamily,
this.legendDiv2.appendChild(this.legendCanvas2),this._parent.container.parentNode.parentNode.parentNode.appendChild(this.legendDiv2);for(var a=[],b=null,c=0,d=this._legend_rightop.vLegendLabels.length;c<d;c++)for(var b=this._legend_rightop.itemWidth+10+this.legendCanvasContext2.measureText(this._legend_rightop.vLegendLabels[c].toString()).width,e=this._legend_rightop.col,f=0;f<e;f++)c%this._legend_rightop.col===f&&(!a[f]||a[f]<b)&&(a[f]=b);b=10;c=0;for(d=a.length;c<d;c++)b+=a[c]+10;this.legendCanvas2.width=
b;this.legendCanvas2.height=this._legend_rightop.itemHeight;(function(){var b,d,e=0;for(d=this._legend_rightop.col;e<d;e++)if(c%this._legend_rightop.col===e){b=10+this._legend_rightop.itemSize/2;for(var f=0;f<e;f++)b+=a[f]+10}d=this._legend_rightop.itemSize/2+((this._legend_rightop.itemSize<this._legend_rightop.textStyle.fontSize?this._legend_rightop.textStyle.fontSize:this._legend_rightop.itemSize)+10)*~~(c/this._legend_rightop.col);var f=this._rendererOptions.markPoint.itemStyle.color,n=this._legend_rightop.textStyle.color;
this.legendCanvasContext2.beginPath();this.legendCanvasContext2.arc(b,d,this._legend_rightop.itemSize_circle[0]/2,0,Math.PI*2,!1);this.legendCanvasContext2.fillStyle=f;this.legendCanvasContext2.fill();for(e=0;e<4;)this.legendCanvasContext2.beginPath(),this.legendCanvasContext2.arc(b,d,this._legend_rightop.itemSize_circle[e]/2,0,Math.PI*2,!1),this.legendCanvasContext2.strokeStyle=f,this.legendCanvasContext2.stroke(),e++;this.legendCanvasContext2.font=this._legend_rightop.textStyle.fontStyle+" "+this._legend_rightop.textStyle.fontWeight+
" "+this._legend_rightop.textStyle.fontSize+"px "+this._legend_rightop.textStyle.fontFamily;this.legendCanvasContext2.textAlign="left";this.legendCanvasContext2.textBaseline="middle";this.legendCanvasContext2.fillStyle=n;this.legendCanvasContext2.fillText(this._legend_rightop.vLegendLabels[0],b+this._legend_rightop.itemWidth/2+10,d);this.legendCanvasContext2.beginPath();this.legendCanvasContext2.arc(b+(this._legend_rightop.itemWidth+10)*2,d,this._legend_rightop.itemSize_ringBig[0]/2,0,Math.PI*2,!1);
...
this.legendCanvasContext2.fillStyle=n;this.legendCanvasContext2.fillText(this._legend_rightop.vLegendLabels[2],b+(this._legend_rightop.itemWidth+10)*4+13,d)}).bind(this)()}},clearCanvas:function(){this.canvas[0].width=this.cacheCanvas[0].width=this.width},destroy:function(){cancelAnimationFrame(this.frame);this._parent.container.removeChild(this.div);this.MarkPoint=null;this.markPoints=[];this.canvas=[];this.data=[];this.cacheCanvas=[];this.canvasContext=[];this.cacheCanvasContext=[];this._rendererOptions=
{}},hover:function(a,b){this.hoveredMarkPoint=null;for(var c=0,d=this.markPointsSets.length;c<d;c++)!this.hoveredMarkPoint&&this.markPointsSets[c].isPointInPath(this.cacheCanvasContext[0],a,b);this.drawCanvas();this.hoveredMarkPoint?(this.canvas[0].style.cursor="pointer",this.showTooltip(this.hoveredMarkPoint.category,a,b)):(this.canvas[0].style.cursor="default",this.hideTooltip())},showTooltip:function(a,b,c){if(this._rendererOptions.tooltip.show)this.tooltipDiv.textContent=a,this.tooltipDiv.style.top=
c-15+"px",this.tooltipDiv.style.left=b+15+"px",this.tooltipDiv.style.display="block"},hideTooltip:function(){if(this._rendererOptions.tooltip.show)this.tooltipDiv.style.display="none"},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height},setVisible:function(a){this.visibility=
a;this.canvas[0].style.display=a?"block":"none";this.legendDiv&&(this.legendDiv.style.display=a?"block":"none")},setData:function(a){this.data=a;a=new Blob(["function MarkPoint(lon, lat, value) {this.lon = lon;this.lat = lat;this.value = value;}function MarkPointsSet(legendLabel) {this.legendLabel = legendLabel;this.markPoints = [];}var legendLabels = [];var markPointsSets = [];onmessage = function (evt) {var features = evt.data.data;var feature = null;var legendLabel = null;for (var i = 0, len = features.length; i < len; i++) {feature = features[i];legendLabel = feature.properties.type;if (legendLabels.indexOf(legendLabel) === -1) {legendLabels.push(legendLabel);markPointsSets.push(new MarkPointsSet(legendLabel));}markPointsSets[legendLabels.indexOf(legendLabel)].markPoints.push(new MarkPoint(feature.geometry.coordinates[0], feature.geometry.coordinates[1],feature.properties.value));}postMessage({legendLabels: legendLabels,markPointsSets: markPointsSets})}"]);
...
GeoGlobe.Visuals.Grid=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],initialize:function(){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);this.layers=[]},addTo:function(){GeoGlobe.Visuals.prototype.addTo.apply(this,arguments);this.container.className="geoglobe-Grid-container"},render:function(){for(var a=0;a<this.layers.length;a++)this.layers[a].render()},addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},
removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==this.layers[c].id&&b.push(this.layers[c]);this.layers=b},moveLayer:function(a,b){if(this.getLayer(a)){this._order=this.layers.map(function(a){return a.id});this._order.splice(this._order.indexOf(a),1);var c=b?this._order.indexOf(b):this._order.length;if(b&&c===-1)this.fire("error",{error:Error('Layer with id "'+b+'" does not exist on this map.')});else{this._order.splice(c,0,a);for(c=0;c<this._order.length;c++)for(var d=0;d<this.layers.length;d++)if(this._order[c]===
this.layers[d].id)this.layers[d].div.style.zIndex=c}}else this.fire("error",{error:Error("The layer '"+a+"' does not exist in the map's style and cannot be moved.")})},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]}});
...
"destination-out";this.first?(this.canvasContext[0].fillStyle=this.background,this.first=!1):this.canvasContext[0].fillStyle=this.backgroundAlpha;this.canvasContext[0].fillRect(0,0,this.canvas[0].width,this.canvas[0].height);this.canvasContext[0].globalCompositeOperation="source-over";this.canvasContext[0].lineWidth=1;this.canvasContext[0].strokeStyle="rgba(138,43,226,1)";for(var b=new this.Vector(0,0),c=0;c<a.length;c++){var d=this.particles[c];this.particles[c].updateXY(d.x,d.y,b);d.oldX!=-1&&(this.canvasContext[0].beginPath(),
this.canvasContext[0].moveTo(b.x,b.y),this.canvasContext[0].lineTo(d.oldX,d.oldY),this.canvasContext[0].stroke());d.oldX=b.x;d.oldY=b.y}},addTo:function(a){this._parent=a;this._parent.addLayer(this);this._parent.container.appendChild(this.div);this.canvas[0].width=this.cacheCanvas[0].width=this.width=this._parent.map.transform.width;this.canvas[0].height=this.cacheCanvas[0].height=this.height=this._parent.map.transform.height},setData:function(a){this.data=a;var b=this;this.inBounds=function(a,b){return a>=
this.field.x0&&a<this.field.x1&&b>=this.field.y0&&b<this.field.y1};this.bilinear=function(a,b,c){var d=Math.floor(b),e=Math.floor(c),f=Math.ceil(b),g=Math.ceil(c);b-=d;c-=e;return this.Data[d][e][a]*(1-b)*(1-c)+this.Data[f][e][a]*b*(1-c)+this.Data[d][g][a]*(1-b)*c+this.Data[f][g][a]*b*c};this.getValue=function(a,c){var d=(this.field.gridWidth-1-1.0E-6)*(a-this.field.x0)/(this.field.x1-this.field.x0),e=(this.field.gridHeight-1-1.0E-6)*(c-this.field.y0)/(this.field.y1-this.field.y0),f=this.bilinear("x",
d,e),d=this.bilinear("y",d,e);return new b.Vector(f,d)};this.Vector=function(a,b){this.x=a;this.y=b};this.Vector.prototype.length=function(){return Math.sqrt(this.x*this.x+this.y*this.y)};this.makeParticle=function(){var a=Math.random(),b=Math.random();return new this.Particle(a*this.field.x0+(1-a)*this.field.x1,b*this.field.y0+(1-b)*this.field.y1,1+40*Math.random())};for(var c=[],d=a.gridWidth,e=a.gridHeight,f=0,g=0;g<d;g++){c[g]=[];for(var h=0;h<e;h++){var j=a.field[f++],l=a.field[f++],j=new this.Vector(j,
l);c[g][h]=j}}this.field=a;this.numParticles=5E3;for(f=0;f<this.numParticles;f++)this.particles.push(this.makeParticle());this.Data=c}});
GeoGlobe.Visuals.MapV=GeoGlobe.Class4OL(GeoGlobe.Visuals,{map:null,container:null,layers:[],initialize:function(){GeoGlobe.Visuals.prototype.initialize.apply(this,arguments);this.layers=[];window.mapv||console.error("\u4f7f\u7528MapV\u53ef\u89c6\u5316\u56fe\u5c42\u524d\uff0c\u9700\u5f15\u5165mapv\u5e93\uff01")},addTo:function(){GeoGlobe.Visuals.prototype.addTo.apply(this,arguments);this.container.className="geoglobe-mapv-container"},render:function(){for(var a=0;a<this.layers.length;a++)this.layers[a].render()},
addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a===this.layers[c].id?this.layers[c].destroy&&this.layers[c].destroy():b.push(this.layers[c]);this.layers=b},moveLayer:function(a,b){if(this.getLayer(a)){this._order=this.layers.map(function(a){return a.id});this._order.splice(this._order.indexOf(a),1);var c=b?this._order.indexOf(b):this._order.length;
if(b&&c===-1)this.fire("error",{error:Error('Layer with id "'+b+'" does not exist on this map.')});else{this._order.splice(c,0,a);for(c=0;c<this._order.length;c++)for(var d=0;d<this.layers.length;d++)if(this._order[c]===this.layers[d].id)this.layers[d].div.style.zIndex=c}}else this.fire("error",{error:Error("The layer '"+a+"' does not exist in the map's style and cannot be moved.")})},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]}});
GeoGlobe.Visuals.MapV.Bubble=GeoGlobe.Class4OL({_parent:null,visibility:!0,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="bubble";c.dragdrawing=this.dragdrawing;this.RENDERED&&this._parent.container.removeChild(this.div);c.container=this._parent.container;
this.div=document.createElement("div");this._parent.container.appendChild(this.div);this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute");this.setVisible(this.visibility);this._layer=new mapv.mapboxGLMapLayer(a,b,c);this.div.appendChild(this._layer.canvasLayer.canvas);this.RENDERED=!0},destroy:function(){this._parent.container.removeChild(this.div);this.options=this._parent=null;this.dataSet=[]},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":
"none"},setData:function(a){this.data=a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Category=GeoGlobe.Class4OL({_parent:null,visibility:!0,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="category";c.dragdrawing=this.dragdrawing;this.RENDERED&&this._parent.container.removeChild(this.div);c.container=this._parent.container;
this.div=document.createElement("div");this._parent.container.appendChild(this.div);this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute");this.setVisible(this.visibility);this._layer=new mapv.mapboxGLMapLayer(a,b,c);this.div.appendChild(this._layer.canvasLayer.canvas);this.RENDERED=!0},destroy:function(){this._parent.container.removeChild(this.div);this.options=this._parent=null;this.dataSet=[]},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":
"none"},setData:function(a){this.data=a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Choropleth=GeoGlobe.Class4OL({_parent:null,visibility:!0,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="choropleth";c.dragdrawing=this.dragdrawing;this.RENDERED&&this._parent.container.removeChild(this.div);c.container=
this._parent.container;this.div=document.createElement("div");this._parent.container.appendChild(this.div);this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute");this.setVisible(this.visibility);this._layer=new mapv.mapboxGLMapLayer(a,b,c);this.div.appendChild(this._layer.canvasLayer.canvas);this.RENDERED=!0},destroy:function(){this._parent.container.removeChild(this.div);this.options=this._parent=null;this.dataSet=[]},setVisible:function(a){this.visibility=a;this.div.style.display=
a?"block":"none"},setData:function(a){this.data=a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Grid=GeoGlobe.Class4OL({_parent:null,visibility:!0,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="grid";c.dragdrawing=this.dragdrawing;this.RENDERED&&this._parent.container.removeChild(this.div);c.container=this._parent.container;
this.div=document.createElement("div");this._parent.container.appendChild(this.div);this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute");this.setVisible(this.visibility);this._layer=new mapv.mapboxGLMapLayer(a,b,c);this.div.appendChild(this._layer.canvasLayer.canvas);this.RENDERED=!0},destroy:function(){this._parent.container.removeChild(this.div);this.options=this._parent=null;this.dataSet=[]},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":
"none"},setData:function(a){this.data=a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.HeatMap=GeoGlobe.Class4OL({_parent:null,visibility:!0,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="heatmap";c.dragdrawing=this.dragdrawing;this.RENDERED&&this._parent.container.removeChild(this.div);c.container=this._parent.container;
this.div=document.createElement("div");this._parent.container.appendChild(this.div);this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute");this.setVisible(this.visibility);this._layer=new mapv.mapboxGLMapLayer(a,b,c);this.div.appendChild(this._layer.canvasLayer.canvas);this.RENDERED=!0},destroy:function(){this._parent.container.removeChild(this.div);this.options=this._parent=null;this.dataSet=[]},setVisible:function(a){this.visibility=a;this.div.style.display=a?"block":
"none"},setData:function(a){this.data=a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.HoneyComb=GeoGlobe.Class4OL({_parent:null,visibility:!0,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this._parent.map,b=new mapv.DataSet(this.data),c=this.rendererOptions;c.draw="honeycomb";c.dragdrawing=this.dragdrawing;this.RENDERED&&this._parent.container.removeChild(this.div);c.container=
this._parent.container;this.div=document.createElement("div");this._parent.container.appendChild(this.div);this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute");this.setVisible(this.visibility);this._layer=new mapv.mapboxGLMapLayer(a,b,c);this.div.appendChild(this._layer.canvasLayer.canvas);this.RENDERED=!0},destroy:function(){this._parent.container.removeChild(this.div);this.options=this._parent=null;this.dataSet=[]},setVisible:function(a){this.visibility=a;this.div.style.display=
a?"block":"none"},setData:function(a){this.data=a.map(function(a){return GeoGlobe.Util.extend(a.properties,{geometry:a.geometry})})}});
GeoGlobe.Visuals.MapV.Icon=GeoGlobe.Class4OL({_parent:null,visibility:!0,initialize:function(a){this.options=a;GeoGlobe.Util.extend(this,a);this.setData(this.data)},addTo:function(a){this._parent=a;this._parent.addLayer(this)},remove:function(){this._parent.removeLayer(this.id)},render:function(){var a=this,b=this._parent.map,c=new mapv.DataSet(this.data),d=this.rendererOptions,e=new Image;e.src=this.icon;e.onload=function(){d.icon=e;d.draw="icon";d.dragdrawing=a.dragdrawing;this.RENDERED&&this._parent.container.removeChild(this.div);
d.container=a._parent.container;this.div=document.createElement("div");this._parent.container.appendChild(this.div);this.div.setAttribute("id",this.id);this.div.setAttribute("style","position:absolute");this.setVisible(this.visibility);a._layer=new mapv.mapboxGLMapLayer(b,c,d);this.div.appendChild(this._layer.canvasLayer.canvas)};this.RENDERED=!0},destroy:function(){this._parent.container.removeChild(this.div);this.options=this._parent=null;this.dataSet=[]},setVisible:function(a){this.visibility=
...
this._deckgl.props.layers=a;this._deckgl.setProps()},addLayer:function(a){a.id?this.getLayer(a.id)||this.layers.push(a):console.error("\u56fe\u5c42id\u5c5e\u6027\u4e0d\u80fd\u4e3a\u7a7a\uff01")},removeLayer:function(a){for(var b=[],c=0;c<this.layers.length;c++)a!==this.layers[c].id&&b.push(this.layers[c]);this.layers=b},moveLayer:function(a,b){if(this.getLayer(a)){this._order=this.layers.map(function(a){return a.id});this._order.splice(this._order.indexOf(a),1);var c=b?this._order.indexOf(b):this._order.length;
b&&c===-1?this.fire("error",{error:Error('Layer with id "'+b+'" does not exist on this map.')}):this._order.splice(c,0,a)}else this.fire("error",{error:Error("The layer '"+a+"' does not exist in the map's style and cannot be moved.")})},getLayer:function(a){for(var b=0;b<this.layers.length;b++)if(a===this.layers[b].id)return this.layers[b]}});
